/* spd-match: far pct=26.98 flags=/Og /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_00417160 */
...
int __cdecl FUN_0041da40();
extern int DAT_0078a478;
void __fastcall FUN_00417160(int obj)

{
  int iVar1;

  iVar1 = FUN_0041da40(&DAT_0078a478);
  if (iVar1 != 0) {
    FUN_0041d8a0(&DAT_0078a478,"auto");
    FUN_00416fc0(obj);
    return;
  }
  *(undefined1 *)(obj + 0x58) = 1;
  FUN_00416fc0(obj);
  return;
}
