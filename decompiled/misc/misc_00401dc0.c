/* spd-match: far pct=12.50 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_00401DC0 */
...
void __fastcall FUN_00401dc0(byte * obj, int edi_obj)

{
  ...
  *(int *)(edi_obj + 8) = iVar4;
  pcVar5 = (char *)(edi_obj + 0x80);
  iVar4 = 0x3f;
  iVar7 = (int)obj - (int)pcVar5;
  do {
    cVar3 = pcVar5[iVar7];
    iVar4 = iVar4 + -1;
    *pcVar5 = cVar3;
