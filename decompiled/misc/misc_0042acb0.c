/* spd-match: far pct=16.36 flags=/Ob2 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_0042ACB0 */
...
void __fastcall FUN_0042acb0(undefined4 val, undefined4 param_1, undefined4 param_2, undefined4 * obj)

{
  ...
  FUN_0059d350(&local_20,param_2,val);
  *obj = local_20;
  obj[1] = local_1c;
  obj[2] = local_18;
  return;
