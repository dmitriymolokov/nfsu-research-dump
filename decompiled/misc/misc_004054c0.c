/* spd-match: far pct=21.62 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_004054C0 */
...
int __cdecl FUN_004053c0();

void __fastcall FUN_004054c0(int * obj)
