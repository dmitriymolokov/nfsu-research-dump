/* spd-match: far pct=5.00 flags=/Ob2 /c /nologo /TC method=m4_13_fc_wrapper_thiscall source=m4_13/4.1.3/va_0041A640 */
...
/* M4.1.3: FUN_0041a4b0 → __stdcall (callee_stdcall). */
...
int __stdcall FUN_0041a4b0(int arg);

void __fastcall FUN_0041a640(undefined4 head)
