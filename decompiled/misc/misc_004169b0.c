/* spd-match: far pct=9.30 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_004169B0 */
/* Pass A — minimal Ghidra → MSVC6 typedefs (not from speed.exe) */
/* M4.1.1: unaff_EBX → __fastcall typed arg (promote; sync only on uplift). */
...
int __cdecl FUN_004168f0();
int __cdecl FUN_00416950();
extern void LAB_004169f7(void);
void __fastcall FUN_004169b0(int obj)
