/* spd-match: far pct=26.03 flags=/O2 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_004131A0 */
...
void __fastcall FUN_004131a0(int * obj, int * esi)

{
  
  tagRECT local_10;
  
  GetClientRect(DAT_00736380,&local_10);
  if ((*esi <= local_10.right) &&
     (local_10.right = local_10.left, local_10.left <= *esi)) {
    if ((local_10.bottom < *obj) ||
       (local_10.bottom = local_10.top, *obj < local_10.top)) {
      *obj = local_10.bottom;
    }
    return;
  }
