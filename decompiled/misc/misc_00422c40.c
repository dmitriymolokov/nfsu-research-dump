/* spd-match: far pct=15.69 flags=/O2 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_00422C40 */
...
int __cdecl FUN_0047e270();
extern unsigned char *DAT_007361bc;

void __fastcall FUN_00422c40(int obj)

{
  ...
  if (*(int *)(obj + 0x30) == 0) {
    pvVar1 = _malloc(0x34);
    if (pvVar1 != (void *)0x0) {
      uVar2 = FUN_0047e270(*(undefined4 *)(DAT_007361bc + 4));
      *(undefined4 *)(obj + 0x30) = uVar2;
      return;
    }
