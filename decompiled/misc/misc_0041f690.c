/* spd-match: far pct=70.00 flags=/O1 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_0041F690 */
...
undefined4 __fastcall FUN_0041f690(int obj, int param_2)

{

  return *(undefined4 *)(obj + 0x28 + (*(int *)(obj + 0x24) + param_2) * 4);
}
