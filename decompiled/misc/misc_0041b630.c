/* spd-match: far pct=18.64 flags=/O1 /c /nologo /TC method=m4_11_r2_edi_stack source=m4_11/4.1.1.r2/va_0041B630 */
...
undefined4 __fastcall FUN_0041b630(int val, int param_2, int param_3, int param_4, int edi)

{

  
  if (((*(int *)(param_2 + 0x2c00 + val * 0xc) == edi) &&
      (*(int *)(param_2 + (val * 3 + 0xb01) * 4) == param_3)) &&
     (*(int *)(param_2 + val * 0xc + 0x2c08) == param_4)) {
    return 1;
  }
  return 0;
}
