/* spd-match: far pct=31.58 flags=/Ob2 /c /nologo /TC method=m4_13_callee_stdcall_v2 source=m4_13/4.1.3/va_00421AE0 */
...
/* M4.1.3-R3: FUN_00421bc0 → unified __stdcall (callee_stdcall_v2). */
...
int __stdcall FUN_00421bc0(undefined4 a1, undefined4 a2);
void __fastcall FUN_00421ae0(undefined4 * obj, undefined4 param_1)

{

  FUN_00421bc0(2,*obj);
  FUN_00421bc0(1,param_1);
  FUN_00421bc0(3,0);
  return;
}
