/* spd-match: far pct=7.32 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_004145C0 */
...
undefined4 __fastcall FUN_004145c0(int edi)
