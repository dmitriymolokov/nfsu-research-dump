/* spd-match: far pct=14.53 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_0043D4F0 */
...
/* M4.1.3: FUN_0041f0b0 → __stdcall (callee_stdcall). */
...
int __stdcall FUN_0041f0b0(int arg);
int __cdecl FUN_00421a30();
int __cdecl FUN_00421ac0();
int __cdecl FUN_004399a0();
int __cdecl FUN_0043a830();
int __cdecl FUN_0043b890();
extern int _DAT_006b798c;
extern int _DAT_006b7990;

void __fastcall FUN_0043d4f0(int param_1)

{
  ...
  iVar1 = FUN_00421a30();
  if (iVar1 != 0) {
    FUN_0041f0b0(param_1 + 0x90);
    fVar2 = (float10)FUN_0040ed00();
    FUN_0041f0b0(param_1 + 0x94);
    fVar3 = (float10)FUN_0040ed00();
    fVar2 = (float10)FUN_00405600((float)fVar2 - (float)fVar3);
    if (((((float10)_DAT_006b7990 * (float10)_DAT_006b798c < fVar2) &&
         (iVar1 = FUN_0043b890(), iVar1 != 0)) && (FUN_004399a0(2), iVar1 == *(int *)(param_1 + 4)))
       && (iVar1 = FUN_00421ac0(iVar1), 5 < iVar1)) {
      FUN_0043a830();
    }
  }
  FUN_00405560();
