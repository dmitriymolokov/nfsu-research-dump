/* spd-match: far pct=14.29 flags=/O1 /c /nologo /TC method=m39 source=m39/4.1.2/va_004216B0 */
...
/* M4.1.2 try: unaff_EDI → fastcall 1st (ECX); param_1 as 2nd (EDX). */
uint __fastcall FUN_004216b0(int obj, uint param_1)

{
  ...
  uVar1 = *(uint *)(obj + 0x2d0);
  uVar2 = uVar1 ^ 0x1d872b41;
  uVar3 = uVar2 >> 5 ^ uVar2;
  *(uint *)(obj + 0x2d0) = uVar3 << 0x1b ^ uVar3 ^ uVar2;
