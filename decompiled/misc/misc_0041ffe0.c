/* spd-match: far pct=35.71 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_0041FFE0 */
...
int __fastcall FUN_0041ffe0(int edi)

{
  ...
  if (0 < *(int *)(DAT_007361f8 + 0x18)) {
    ...
    do {
      if (*(short *)(*piVar2 + 10) == edi) {
        return *piVar2;
      }
      iVar1 = iVar1 + 1;
      piVar2 = piVar2 + 1;
    } while (iVar1 < *(int *)(DAT_007361f8 + 0x18));
  }
  return 0;
}
