/* spd-match: far pct=5.10 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
uint __fastcall FUN_004115f0(char param_1)

{
  ...
  uVar1 = 0;
  do {
    if (local_38[uVar1] == param_1) {
      return CONCAT31((int3)(uVar1 >> 8),1);
    }
    uVar1 = uVar1 + 1;
  } while ((int)uVar1 < 0x37);
