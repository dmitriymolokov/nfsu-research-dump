/* spd-match: far pct=0.00 flags=/O1 method=thiscall_tp source=m375_sync_decomp:m375_c2440_void_cdecl_uchar */
...
struct ThisCallBox {
  void FUN_00436230(int param_2);
};
void ThisCallBox::FUN_00436230(int param_2) {
  int *piVar1;
  char cVar2;
  int *piVar3;
  int iVar4;
