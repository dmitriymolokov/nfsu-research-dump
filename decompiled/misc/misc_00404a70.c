/* spd-match: far pct=6.25 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_00404A70 */
...
extern int DAT_0073652c;

void __fastcall FUN_00404a70(int * obj)
