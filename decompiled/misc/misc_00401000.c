/* spd-match: far pct=27.27 flags=/O1 /c /nologo /TC method=m4_13_fc_wrapper_thiscall source=m4_13/4.1.3/va_00401000 */
...
/* M4.1.3: FUN_00565b60 → __stdcall (callee_stdcall). */
...
int __stdcall FUN_00565b60(int a1, int a2, int a3);

void __fastcall FUN_00401000(undefined4 head)

{
  FUN_00565b60(head,0,0);
  return;
}
