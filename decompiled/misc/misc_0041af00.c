/* spd-match: far pct=18.75 flags=/Og /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_0041AF00 */
...
void __fastcall FUN_0041af00(int param_1, int esi)

{
  char cVar1;

  if (((&DAT_0071d890)[esi] != 0) && (cVar1 = FUN_0041bc20(param_1 + 0x2538), cVar1 != '\0'))
  {
    FUN_0041bb30(esi);
  }
  return;
