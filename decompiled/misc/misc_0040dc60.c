/* spd-match: far pct=12.68 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_0040DC60 */
...
undefined4 __fastcall FUN_0040dc60(int * obj, float * esi_obj)

{
  ...
  iVar2 = 0;
  pfVar1 = (float *)(*obj + 0xc4);
  do {
    if (*pfVar1 * esi_obj[1] + pfVar1[-1] * *esi_obj + pfVar1[1] * esi_obj[2] + pfVar1[2] <=
        DAT_006cc7a4) {
      return 0;
    }
    iVar2 = iVar2 + 1;
