/* spd-match: far pct=38.98 flags=/O2 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_00417060 */
...
void __fastcall FUN_00417060(int obj)

{
  int iVar1;

  iVar1 = FUN_0041d8a0(&DAT_0078a478,obj + 0x20c);
  if (iVar1 != 0) {
    FUN_0041d8a0(&DAT_0078a478,"auto");
    FUN_00416fc0(obj);
    return;
  }
  *(undefined1 *)(obj + 0x59) = 1;
  return;
}
