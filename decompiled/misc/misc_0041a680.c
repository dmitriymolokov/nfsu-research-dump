/* spd-match: far pct=14.58 flags=/O2 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_0041A680 */
...
void __fastcall FUN_0041a680(int param_1, int esi)

{
  char cVar1;

  if (((&DAT_0071d890)[esi] != 0) && (cVar1 = FUN_0041bc20(param_1 + 0x24e8), cVar1 != '\0'))
  {
    FUN_0041bb30(esi);
  }
  return;
