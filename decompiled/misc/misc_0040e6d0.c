/* spd-match: far pct=14.41 flags=/O2 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_0040E6D0 */
...
void __fastcall FUN_0040e6d0(int obj, int edi)

{
  ...
  if (DAT_0073640c != 0) {
    ...
    piStack_c = *(int **)(DAT_0073640c + 0x18);
    (**(code **)(*piStack_c + 0x108))();
    (**(code **)(DAT_0073640c + 0xdc))();
  }
  piStack_c = (int *)0x40e705;
  DAT_0073640c = obj;
  (**(code **)(obj + 0xd8))();
  piStack_c = *(int **)(obj + 4);
  (**(code **)(*DAT_0073636c + 0x15c))(DAT_0073636c);
  (**(code **)(**(int **)(obj + 0x18) + 0x100))(*(int **)(obj + 0x18),&piStack_c,0);
  if (edi != -1) {
    (**(code **)(**(int **)(obj + 0x18) + 0x104))(*(int **)(obj + 0x18));
  }
  return;
}
