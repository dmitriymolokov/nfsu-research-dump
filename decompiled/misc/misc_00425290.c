/* spd-match: far pct=24.14 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_00425290 */
...
void __fastcall FUN_00425290(undefined4 val, undefined4 * obj)

{
  ...
  FUN_00458a50(val);
  *obj = &PTR_FUN_006cab08;
  puVar1 = _malloc(0x1f0);
  if (puVar1 != (undefined4 *)0x0) {
    FUN_00424f60();
    *puVar1 = &PTR_FUN_006cab60;
    obj[2] = puVar1;
    return;
  }
  obj[2] = 0;
