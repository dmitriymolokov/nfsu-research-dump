/* spd-match: far pct=18.87 flags=/O1 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_004171A0 */
...
void __fastcall FUN_004171a0(undefined4 edi, int obj)
