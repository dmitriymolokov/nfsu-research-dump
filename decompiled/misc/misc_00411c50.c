/* spd-match: far pct=14.49 flags=/O1 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_00411C50 */
...
void __fastcall FUN_00411c50(int obj, int esi)

{
  ...
  *(int *)(esi + 8) = *(int *)(obj + 0x7c);
  *(int *)(*(int *)(obj + 0x7c) + 0xc) = esi;
  *(int *)(obj + 0x7c) = esi;
  FUN_0063f1a0(iVar1);
  return;
}
