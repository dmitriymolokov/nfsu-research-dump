/* spd-match: far pct=35.45 flags=/O2 /c /nologo /TC method=m4_11_r2_edi_stack source=m4_11/4.1.1.r2/va_00428170 */
/* Pass A — minimal Ghidra → MSVC6 typedefs (not from speed.exe) */
/* M4.1.1 R2: unaff_EDI → __fastcall last stack arg (EDI wall; sync only on uplift). */
...
extern void LAB_004281a1(void);

extern int DAT_006f08a0;
extern void LAB_004281a1(void);

void __fastcall FUN_00428170(int val, int param_1, int edi)

{
  ...
  if (*(int *)(param_1 + 0x85c) < DAT_006f08a0) {
    if (DAT_006f08a0 < *(int *)(param_1 + 0x860)) goto LAB_004281a1;
  }
  else if (*(int *)(param_1 + 0x85c) <= val) goto LAB_004281a1;
  *(int *)(param_1 + 0x85c) = val;
LAB_004281a1:
  if (*(int *)(param_1 + 0x860) < edi) {
    *(int *)(param_1 + 0x860) = edi;
  }
  *(int *)(param_1 + 0x860) =
       (((*(int *)(param_1 + 0x860) - *(int *)(param_1 + 0x85c)) + 0x51) / 0x52) * 0x52 +
       *(int *)(param_1 + 0x85c);
  return;
}
