/* spd-match: far pct=22.73 flags=/O1 /c /nologo /TC method=m39 source=m39/4.1.1/va_004318B0 */
...
void __fastcall FUN_004318b0(void *obj)

{
  _free(*(void **)((char *)obj + 0xc));
  _free(*(void **)((char *)obj + 0x10));
  return;
}
