/* spd-match: far pct=7.63 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
undefined4 __fastcall FUN_0041db70(undefined4 param_1,undefined4 param_2,undefined1 *param_3)

{
  ...
  *unaff_EDI = 0;
  *param_3 = 0;
  FUN_0041dc10(param_2,param_1,local_104);
  _File = (FILE *)FUN_00671541(local_104,&DAT_006cc430);
  if (_File != (FILE *)0x0) {
    _fread(&local_108,4,1,_File);
    if (local_108 == 0x13) {
      _fread(unaff_EDI,0x12,1,_File);
      _fread(param_3,0x19,1,_File);
      _fclose(_File);
      return 1;
    }
  }
