/* spd-match: far pct=37.14 flags=/Ob2 /c /nologo /TC method=m4_13_fc_wrapper_thiscall source=m4_13/4.1.3/va_0043AB70 */
...
/* M4.1.3: FUN_004390d0 → __stdcall (callee_stdcall). */
...
int __stdcall FUN_004390d0(int arg);
extern int DAT_00734fd0;

void __fastcall FUN_0043ab70(int *head)

{
  if ((*head == 0) || (DAT_00734fd0 == '\0')) {
    FUN_004390d0(1);
  }
  return;
}
