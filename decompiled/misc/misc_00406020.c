/* spd-match: far pct=2.44 flags=/O1 method=thiscall_tp source=m375_sync_decomp:m375_inventory */
...
extern int DAT_007041c8;
extern unsigned char *DAT_00704218;

struct ThisCallBox {
  uint FUN_00406020(int param_2, undefined4 *param_3);
};
uint ThisCallBox::FUN_00406020(int param_2, undefined4 *param_3) {
  uint uVar1;
  undefined4 *puVar2;
  int iVar3;
  uint uVar4;
  ...
  do {
    ...
    if (bVar8) {
      puVar2 = (undefined4 *)(&DAT_00704218 + uVar1 * 0x90);
      param_2 = param_2 - (int)param_3;
      iVar3 = 0x10;
      do {
        *(undefined4 *)(param_2 + (int)param_3) = puVar2[-0x10];
        *param_3 = *puVar2;
        puVar2 = puVar2 + 1;
        param_3 = param_3 + 1;
        iVar3 = iVar3 + -1;
