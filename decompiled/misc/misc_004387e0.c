/* spd-match: far pct=33.33 flags=/O1 /c /nologo /TC method=m4_13_fc_wrapper_thiscall source=m4_13/4.1.3/va_004387E0 */
...
float10 __fastcall FUN_004387e0(undefined4 head)

{
  int iVar1;
  
  iVar1 = FUN_00674898(head);
