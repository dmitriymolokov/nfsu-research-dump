/* spd-match: far pct=7.50 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
float10 FUN_00420110(int param_1)

{
  ...
  piVar9 = piVar5;
  if (*DAT_007345d0 == 0) {
    param_1 = DAT_00734568;
    if (((DAT_007345d0[1] != 0) && (DAT_007345d0[1] != 0)) &&
       (piVar1 = DAT_007345d0 + 0x19, FUN_00594120(DAT_00734568,8), piVar9 = DAT_007345d0,
       *(int *)(*piVar1 + 0x14) * 8 + -0x44 <= *(int *)(*piVar1 + 8))) {
      piVar5[1] = 0;
      piVar9 = DAT_007345d0;
    }
  }
  else if ((*DAT_007345d0 == 0) || (DAT_007345d0[2] != 0)) {
    param_1 = 0;
  }
  else {
    param_1 = FUN_00594220(8,1);
    if (*(int *)(piVar5[0x19] + 0x28) != 0) {
      piVar5[2] = 1;
    }
  }
  fVar2 = (float)param_1 * _DAT_006cc7e4;
  if (((*piVar9 != 0) && (piVar9[5] == 0)) && (piVar9[4] == 0)) {
    fVar3 = (fVar2 - DAT_0073ad38) + *(float *)(iVar7 + 0x2dc);
    fVar4 = DAT_006cc7a4;
    if ((DAT_006cc7a4 < fVar3) && (fVar4 = fVar3, _DAT_006ccc58 < fVar3)) {
      fVar4 = _DAT_006ccc58;
    }
    *(float *)(iVar7 + 0x2dc) = fVar4;
    if (DAT_006cc7a4 < fVar4) {
      ...
      } while ((float)(1 << ((byte)uVar6 & 0x1f)) * (float)param_1 * _DAT_007301d0 * _DAT_006cc8bc <
               fVar4);
    }
  }
  if (DAT_006cc7a4 < *(float *)(iVar7 + 0x2e4)) {
    fVar3 = *(float *)(iVar7 + 0x2e4) - fVar2;
    *(float *)(iVar7 + 0x2e4) = fVar3;
    if (fVar3 < DAT_006cc7a4 != (fVar3 == DAT_006cc7a4)) {
      *(undefined4 *)(iVar7 + 0x2e4) = 0;
      *(undefined4 *)(iVar7 + 0x2e0) = 0x3f800000;
      if (*(code **)(iVar7 + 0x2e8) != (code *)0x0) {
        (**(code **)(iVar7 + 0x2e8))(*(undefined4 *)(iVar7 + 0x2ec));
        *(undefined4 *)(iVar7 + 0x2e8) = 0;
        *(undefined4 *)(iVar7 + 0x2ec) = 0;
      }
    }
  }
  return (float10)fVar2 * (float10)*(float *)(iVar7 + 0x2e0);
}
