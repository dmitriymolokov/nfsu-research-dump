/* spd-match: far pct=16.67 flags=/Og /Gr /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_0042C640 */
...
void __fastcall FUN_0042c640(int obj)

{
  
  if (*(undefined4 **)(obj + 0x5c4) != (undefined4 *)0x0) {
    (**(code **)**(undefined4 **)(obj + 0x5c4))(1);
  }
  *(undefined4 *)(obj + 0x5c4) = 0;
  *(undefined4 *)(obj + 0x5c8) = 0xffffffff;
  *(undefined4 *)(obj + 0x5cc) = 0xffffffff;
  return;
}
