/* spd-match: far pct=12.50 flags=/O1 /c /nologo /TP method=m4_14_thin_callee_fastcall source=m4_14/4.1.4/va_00435C50 */
...
/* M4.1.4: FUN_004350d0 → __fastcall(this) (thin_callee_fastcall). */
...
int __fastcall FUN_004350d0(undefined4 *param_1);

struct ThisCallBox {
  void FUN_00435c50(int param_2, int param_3, undefined4 param_4, undefined4 param_5);
};
void ThisCallBox::FUN_00435c50(int param_2, int param_3, undefined4 param_4, undefined4 param_5) {
  int iVar1;
  int *piVar2;
  
  iVar1 = 0;
  if (0 < *(int *)(((int)this) + 0x24)) {
    piVar2 = (int *)(((int)this) + 0x520);
    while (*(int *)(param_2 + 0x1c) != *piVar2) {
      iVar1 = iVar1 + 1;
      piVar2 = piVar2 + 1;
      if (*(int *)(((int)this) + 0x24) <= iVar1) {
        return;
      }
    }
    if (param_3 == 0) {
      param_3 = (int)*(char *)(*(int *)(param_2 + 0x1c) + 10);
    }
    FUN_004350d0((undefined4 *)this);
  }
  return;
}
