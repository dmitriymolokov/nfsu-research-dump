/* spd-match: matched pct=100.00 flags=/O2 /c /nologo /TC method=m36_pass_b source=m36_pass_b/va_0065B470 */
...
void FUN_0065b470(undefined4 *param_1)

{
  *param_1 = (undefined4 *)0x0065b3f0;
  param_1[1] = 0;
  return;
}
