/* spd-match: far pct=9.52 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_0066B150 */
...
int __fastcall FUN_0066b150(int obj, int edi_obj)

{
  ...
  iVar3 = *(int *)(obj + 4) + 1;
  iVar1 = FUN_00662e80(*(undefined4 *)(edi_obj + 0x6c),obj + 8,iVar3,0,edi_obj + 0x70,0x10);
  if (iVar1 != iVar3) {
    return -1;
  }
  DVar2 = GetTickCount();
  *(DWORD *)(edi_obj + 0xb4) = DVar2;
  *(int *)(edi_obj + 0x60) = *(int *)(edi_obj + 0x60) + 1;
  *(int *)(edi_obj + 0x58) = *(int *)(edi_obj + 0x58) + iVar3;
  return iVar3;
}
