/* spd-match: far pct=1.96 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
extern int _DAT_006aab7c;

void FUN_00660080(int param_1,int param_2,int param_3,float *param_4)

{
  ...
  if (param_4 < param_4 + param_2) {
    pfVar5 = (float *)(*(int *)(param_1 + 0x1c) + *(int *)(param_1 + 0x24) * 4);
    pfVar6 = (float *)(param_3 + 8);
    pfVar7 = param_4;
    do {
      pfVar8 = pfVar7 + 4;
      fVar1 = *(float *)(param_1 + 0x2c) * *pfVar5 + pfVar6[-2] + _DAT_006aab7c;
      fVar2 = *(float *)(param_1 + 0x2c) * pfVar5[1] + pfVar6[-1] + _DAT_006aab7c;
      fVar3 = *(float *)(param_1 + 0x2c) * pfVar5[2] + *pfVar6 + _DAT_006aab7c;
      fVar4 = pfVar5[3] * *(float *)(param_1 + 0x2c) + pfVar6[1] + _DAT_006aab7c;
      *pfVar7 = fVar1 * *(float *)(param_1 + 0x30) + *pfVar5;
      pfVar7[1] = fVar2 * *(float *)(param_1 + 0x30) + pfVar5[1];
      *(float *)((int)param_4 + (-0x10 - param_3) + (int)(pfVar6 + 4)) =
           fVar3 * *(float *)(param_1 + 0x30) + pfVar5[2];
      pfVar7[3] = fVar4 * *(float *)(param_1 + 0x30) + pfVar5[3];
      pfVar5[2] = fVar3;
      *pfVar5 = fVar1;
      pfVar5[3] = fVar4;
      pfVar5[1] = fVar2;
