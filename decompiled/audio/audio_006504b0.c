/* spd-match: matched pct=100.00 flags=/O2 /c /nologo /TC method=pass_b_typed_abs source=reports/m3_needs_data_typed_pass_b */
...
int __cdecl FUN_006503a0();
undefined4 FUN_006504b0(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  undefined4 uVar1;
  
  if (*(char *)0x00713ee4 == '\0') {
    return 0xfffffff6;
  }
  uVar1 = FUN_006503a0(param_1,param_2,param_3,param_4,0);
  return uVar1;
}
