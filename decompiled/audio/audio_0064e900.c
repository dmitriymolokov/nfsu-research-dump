/* spd-match: matched pct=100.00 flags=/O2 /c /nologo /TC method=pass_b_abs_dat source=reports/m3_needs_data_close_pass_b */
...
undefined4 FUN_0064e900(int param_1,undefined4 param_2,undefined4 param_3)

{
  if (param_1 != 0) {
    return 0xfffffffb;
  }
  *(int *)0x00713cc0 = param_2;
  *(int *)0x00713cb0 = param_3;
  return 0;
}
