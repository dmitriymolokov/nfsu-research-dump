/* spd-match: far pct=13.58 flags=/O2 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_00669960 */
...
void __fastcall FUN_00669960(HLINEAPP edi, DWORD esi, LPHLINE param_1,DWORD_PTR param_2,DWORD param_3,DWORD param_4)

{
  LONG LVar1;

  DWORD local_14;
  lineextensionid_tag local_10;
  
  local_14 = 0;
  LVar1 = lineNegotiateAPIVersion(edi,esi,0x10004,0x20002,&local_14,&local_10);
  if (LVar1 == 0) {
    lineOpen(edi,esi,param_1,local_14,0,param_2,param_3,param_4,(LPLINECALLPARAMS)0x0);
  }
  return;
}
