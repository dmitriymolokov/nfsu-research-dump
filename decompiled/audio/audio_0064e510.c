/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m3_unknown_rescue_pass_a_thunkfix */
...
int __cdecl FUN_00652d90();

void FUN_0064e510(void)
