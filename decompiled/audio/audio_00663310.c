/* spd-match: far pct=51.61 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
void FUN_00663310(int param_1)

{
  LONG LVar1;
  
  LVar1 = InterlockedExchange((LONG *)(param_1 + 0x54),1);
  if (LVar1 != 0) {
