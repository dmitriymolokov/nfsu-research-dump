/* spd-match: far pct=27.27 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_0066F5E0 */
...
int __fastcall FUN_0066f5e0(byte *param_1,int param_2, int esi)

{
  ...
  if (0 < param_2) {
    do {
      esi = CONCAT22((short)((uint)esi >> 0x10),(ushort)*param_1);
      iVar1 = iVar1 * 0xd + esi;
      param_1 = param_1 + 1;
      param_2 = param_2 + -1;
    } while (param_2 != 0);
