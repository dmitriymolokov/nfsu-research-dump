/* spd-match: close pct=81.54 flags=/O2 /c /nologo /TC method=pass_a_tc source=reports/m3_bad_signature_other */
...
int __cdecl FUN_00650020();
int __cdecl FUN_00658cf0();
extern int DAT_00713ee4;

undefined4 FUN_00652df0(undefined4 param_1,undefined4 param_2)

{
  ...
  *(short *)(iVar1 + 0x11e) = (short)param_2;
  FUN_00658cf0(*(undefined4 *)(iVar1 + 4),param_2);
  return 0;
}
