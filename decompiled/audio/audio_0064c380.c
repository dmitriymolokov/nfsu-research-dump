/* Decompiled from Speed.exe @ 0064c380 */
/* Module: Audio */
/* Ghidra DecompileVAs */


undefined4 FUN_0064c380(int *param_1,undefined4 *param_2,undefined4 param_3,int param_4,int param_5)
...
LAB_0064c424:
                ...
                if (bVar1 != pbVar9[1]) goto LAB_0064c424;
                pbVar5 = pbVar5 + 2;
                pbVar9 = pbVar9 + 2;
              } while (bVar1 != 0);
              iVar6 = 0;
LAB_0064c429:
              if (iVar6 == 0) {
                iVar2 = iVar2 + iVar8 * 0xc;
                *param_1 = iVar2;
                param_1[1] = *(int *)(iVar2 + 8);
                return 0;
              }
            }
            iVar8 = iVar8 + 1;
