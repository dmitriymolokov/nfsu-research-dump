/* spd-match: far pct=32.26 flags=/O2 /c /nologo /TC method=m39 source=m39/4.1.5q/va_00659F60 */
...
extern float _DAT_006cc8f0;

void __cdecl FUN_00659f60(int param_1,int *param_2)

{
  float fVar1;
  float scale;
  
  fVar1 = ((float)param_2[0] + (float)param_2[0]) / (float)param_2[1];
  *(float *)(param_1 + 0x24) = fVar1;
  *(float *)(param_1 + 0x20) = _DAT_006cc7bc - fVar1;
  scale = (float)param_2[2] * _DAT_006cc8f0;
  *(float *)(param_1 + 0x24) = scale * *(float *)(param_1 + 0x24);
  *(float *)(param_1 + 0x20) = scale * *(float *)(param_1 + 0x20);
  return;
}
