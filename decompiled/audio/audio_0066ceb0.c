/* spd-match: far pct=37.14 flags=/O2 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_0066CEB0 */
...
extern int DAT_00717960;

void __fastcall FUN_0066ceb0(int obj)

{
  
  if (DAT_00717960 == 0) {
    FUN_00668cc0(&DAT_0071793c);
    DAT_00717938 = 0;
  }
  FUN_00668d60(&DAT_0071793c);
  *(int *)(obj + 0x68) = DAT_00717960;
  DAT_00717960 = obj;
