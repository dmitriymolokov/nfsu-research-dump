/* spd-match: matched pct=100.00 flags=/O2 /c /nologo /TC method=m36_pass_b source=m36_pass_b/va_0065FDB0 */
...
void FUN_0065fdb0(undefined4 *param_1,undefined4 param_2)

{
  *param_1 = (undefined4 *)0x0065fd80;
  param_1[1] = 0;
  param_1[7] = param_2;
  return;
}
