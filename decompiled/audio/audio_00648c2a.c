/* spd-match: far pct=0.00 flags=/O1 method=thiscall_tp source=m375_sync_decomp:m375_c2143 */
...
void * FUN_00648c2a(unsigned char *_this)

{
  *(undefined4 *)(_this + 0xc) = 2;
  *(undefined4 *)_this = 0;
  *(undefined4 *)(_this + 4) = 0;
  *(undefined4 *)(_this + 8) = 0;
  return _this;
}
