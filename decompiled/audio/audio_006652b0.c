/* spd-match: far pct=38.10 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_006652B0 */
...
int __cdecl FUN_00665060();
int __cdecl FUN_00668bc0();

void __fastcall FUN_006652b0(int obj)

{
  
  FUN_00668bc0(*(undefined4 *)(obj + 4),*(undefined4 *)(obj + 0x56c));
  FUN_00665060();
  return;
}
