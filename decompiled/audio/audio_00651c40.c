/* spd-match: far pct=76.19 flags=/O2 /c /nologo /TC method=m39 source=m39/4.1.6-control100/va_00651C40 */
...
int __cdecl FUN_00651a50();
int __cdecl FUN_00651a50(int); int __cdecl FUN_00651c40(void) { int res = FUN_00651a50(0); int mask = (res >= 0) - 1; return res & mask; }
