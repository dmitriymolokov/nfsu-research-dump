/* spd-match: matched pct=100.00 flags=/Ob2 /c /nologo /TP method=m4_14_thin_callee_fastcall source=m4_14/4.1.4/va_006488F0 */
...
/* M4.1.4: FUN_006488d0 → __fastcall(this) (thin_callee_fastcall). */
...
int __fastcall FUN_006488d0(undefined4 *param_1);

struct ThisCallBox {
  void * FUN_006488f0(uint param_2);
};
void * ThisCallBox::FUN_006488f0(uint param_2) {
  FUN_006488d0((undefined4 *)this);
  if ((param_2 & 1) != 0) {
    _free(((void *)this));
  }
  return ((void *)this);
