/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TP method=thiscall_tp source=reports/m3_undefined_types_thiscall */
...
struct ThisCallBox {
  void FUN_0065f910(undefined4 *param_2);
};
void ThisCallBox::FUN_0065f910(undefined4 *param_2) {
  *(undefined4 *)(((int)this) + 0x98) = *param_2;
  *(undefined4 *)(((int)this) + 0x9c) = param_2[1];
  return;
}
