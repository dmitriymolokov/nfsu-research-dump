/* spd-match: far pct=37.50 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
undefined4 FUN_0066a300(int param_1)

{
  int iVar1;
  
  if ((*(int *)(param_1 + 0x80) == 5) || (*(int *)(param_1 + 0x80) == 8)) {
    FUN_0066a300(*(undefined4 *)(param_1 + 0x68));
  }
  iVar1 = *(int *)(param_1 + 0x80);
  if (((iVar1 == 3) || (iVar1 == 5)) || (iVar1 == 8)) {
    lineClose(*(HLINE *)(param_1 + 0x78));
  }
  return 0;
}
