/* Decompiled from Speed.exe @ 00668130 */
/* Module: Audio */
/* Ghidra DecompileAll */


int FUN_00668130(byte *param_1,byte *param_2,int param_3,byte *param_4)

{
  ...
  if (param_1 != (byte *)0x0) {
    ...
    if (param_2 == (byte *)0x0) {
      ...
      if (*param_1 != bVar4) {
        while (0x1f < *param_1) {
          if (((*param_1 == 0x25) && (0x1f < param_1[1])) && (0x1f < param_1[2])) {
            param_1 = param_1 + 2;
          }
          pbVar5 = param_1 + 1;
          iVar3 = iVar3 + 1;
      ...
      if (1 < param_3) {
        do {
          bVar1 = *param_1;
          if ((bVar1 == bVar4) || (bVar1 < 0x20)) break;
          if (bVar1 == 0x25) {
            bVar2 = param_1[1];
            if (bVar2 == 0x25) {
              *param_2 = 0x25;
              ...
              if ((bVar2 < 0x20) || (param_1[2] < 0x20)) goto LAB_00668258;
