/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=m36_pass_b source=m36_pass_b/va_00660610 */
...
int __cdecl FUN_006605c0();

undefined4 FUN_00660610(undefined4 *param_1)
