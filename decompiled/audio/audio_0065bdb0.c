/* spd-match: matched pct=100.00 flags=/O2 /c /nologo /TC method=m36_pass_b source=m36_pass_b/va_0065BDB0 */
...
int __cdecl FUN_0065bd60();
int __cdecl FUN_006611f0();

undefined4 FUN_0065bdb0(undefined4 *param_1)

{
  ...
  *(undefined1 *)((int)param_1 + 0x1b) = 0;
  param_1[1] = 0;
  *param_1 = (undefined4 *)0x0065bd60;
  FUN_006611f0(param_1 + 7);
  return 0;
}
