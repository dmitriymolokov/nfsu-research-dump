/* spd-match: far pct=27.45 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_00668C00 */
...
int __cdecl FUN_00663390();
int __cdecl FUN_00663390();

undefined4 __cdecl FUN_00668c00(undefined4 param_1)

{
  ...
  uVar3 = 0;
  iVar1 = FUN_00663390(param_1);
  if (iVar1 != 0) {
    iVar2 = (**(code **)(iVar1 + 8))(iVar1);
    while (iVar2 == 0) {
      Sleep(10);
      iVar2 = (**(code **)(iVar1 + 8))(iVar1);
    }
