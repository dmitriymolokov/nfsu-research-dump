/* spd-match: far pct=10.53 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
int __cdecl FUN_006527a0();
extern int _DAT_006cc83c;
extern int _DAT_006cc8a8;

void FUN_0065ba20(int param_1,int param_2,float *param_3)

{
  ...
  iVar2 = -(param_2 >> 6 & 0x3ffU);
  iVar1 = FUN_006527a0(iVar2 + 0x400);
  iVar2 = FUN_006527a0(iVar2 + 0x500);
  iVar3 = FUN_006527a0(param_1 >> 6);
  iVar4 = FUN_006527a0((param_1 >> 6) + 0x100);
  *param_3 = (float)iVar3 * (float)iVar2 * _DAT_006cc83c;
  param_3[1] = (float)iVar1 * _DAT_006cc8a8;
  param_3[2] = (float)iVar4 * (float)iVar2 * _DAT_006cc83c;
  return;
}
