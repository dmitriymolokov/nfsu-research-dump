/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=m36_pass_b source=m36_pass_b/va_00662A90 */
...
int __cdecl FUN_006634a0();
undefined4 FUN_00662a90(int param_1)

{
  undefined4 uVar1;
  
  if (param_1 == 0x6f70656e) {
    return *(undefined4 *)0x007177a8;
  }
  if (param_1 == 0x6f6e6c6e) {
    return *(undefined4 *)0x007177b0;
  }
  if (param_1 == 0x636f6e6e) {
    return *(undefined4 *)0x007177ac;
  }
