/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m3_needs_data_abs_pilot */
...
undefined4 FUN_0064b500(undefined4 param_1)

{
  *(int *)0x00713c54 = param_1;
  return 0;
}
