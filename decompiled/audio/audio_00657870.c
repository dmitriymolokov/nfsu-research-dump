/* spd-match: matched pct=100.00 flags=/O2 /c /nologo /TC method=pass_a_tc source=reports/m3_bad_signature_other */
...
undefined4 FUN_00657870(int param_1,int param_2,int param_3,int param_4)

{
  if (param_3 == 1) {
    ...
    else if ((param_4 == 2) && (*(int *)(param_2 + 0xc) == 0)) {
      *(int *)(param_1 + 0x10) = param_2;
