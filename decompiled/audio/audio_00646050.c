/* spd-match: matched pct=100.00 flags=/Ob2 /c /nologo /TP method=m4_14_thin_callee_fastcall source=m4_14/4.1.4/va_00646050 */
...
/* M4.1.4: FUN_00645fc0 → __fastcall(this) (thin_callee_fastcall). */
...
int __fastcall FUN_00645fc0(undefined4 *param_1);

struct ThisCallBox {
  void FUN_00646050(undefined4 param_2);
};
void ThisCallBox::FUN_00646050(undefined4 param_2) {
  FUN_00645fc0((undefined4 *)this);
