/* spd-match: far pct=16.44 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_0066EF70 */
...
void __fastcall FUN_0066ef70(int obj, int esi_obj)

{
  ...
  puVar3 = (undefined4 *)FUN_00549460(obj + 0x18);
  if (puVar3 != (undefined4 *)0x0) {
    *puVar3 = 0;
    puVar3[2] = CONCAT31(CONCAT21(CONCAT11(*(undefined1 *)(esi_obj + 0xc),
                                           *(undefined1 *)(esi_obj + 0xd)),
                                  *(undefined1 *)(esi_obj + 0xe)),*(undefined1 *)(esi_obj + 0xf)
                        );
    puVar3[3] = 0;
    uVar1 = *(undefined1 *)(esi_obj + 0x1a);
    uVar2 = *(undefined1 *)(esi_obj + 0x1b);
    puVar3[4] = 0;
