/* spd-match: matched pct=100.00 flags=/O2 /c /nologo /TC method=pass_a_tc source=reports/m3_undefined_types_pass_a */
...
void FUN_00666f60(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
