/* spd-match: far pct=13.79 flags=/O2 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_0066DB20 */
...
undefined4 __fastcall FUN_0066db20(byte *param_2, int param_3)
