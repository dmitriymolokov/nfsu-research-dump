/* spd-match: far pct=12.50 flags=/O1 /c /nologo /TP method=m39 source=m39/4.1.4/va_00648BD1 */
...
struct ThisCallBox {
  void FUN_00648bd1(undefined4 param_2);
};
void ThisCallBox::FUN_00648bd1(undefined4 param_2) {
  undefined4 *puVar1;
  int iVar2;
  
  puVar1 = (undefined4 *)FUN_00648cd0(param_2);
  iVar2 = FUN_00648cd0(*puVar1);
  (**(code **)(iVar2 + 8))();
  return;
}
