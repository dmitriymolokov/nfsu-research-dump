/* spd-match: far pct=25.00 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_00663D90 */
...
int __cdecl FUN_00663ae0();

undefined4 __fastcall FUN_00663d90(int obj)

{
  ...
  *(undefined4 *)(obj + 0x1c4) = 1;
  uVar1 = FUN_00663ae0();
  *(undefined4 *)(obj + 0x1c4) = 0;
  return uVar1;
}
