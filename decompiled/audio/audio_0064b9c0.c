...
int __cdecl FUN_0064c490(...);

struct ThisCallBox {
  void FUN_0064b9c0(undefined4 param_2);
};
void ThisCallBox::FUN_0064b9c0(undefined4 param_2) {
  FUN_0064c490(((undefined4)this),param_2,0,0x1c,0xe);
  return;
}
