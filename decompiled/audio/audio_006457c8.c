/* spd-match: far pct=25.21 flags=/Ob2 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_006457C8 */
...
int __cdecl FUN_0064595f();
int __cdecl FUN_00648a8e();
...
int __cdecl FUN_006457c8(int param_1)

{
  ...
  fVar6 = (float10)FUN_00648a8e();
  *(float *)(param_1 + 0x48) =
       (float)(fVar6 * (float10)_DAT_006cc8bc * (float10)(uint)(iVar3 + iVar4));
  fVar2 = (float)*(uint *)(param_1 + 0x44) + _DAT_006cc7bc;
  fVar1 = *(float *)(param_1 + 0x48);
  uVar5 = (uint3)(CONCAT22((short)((uint)param_1 >> 0x10),
