/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=m36_pass_b source=m36_pass_b/va_00660220 */
...
undefined4 FUN_00660220(undefined4 *param_1)

{
  ...
  *(undefined1 *)((int)param_1 + 0x1b) = 0;
  param_1[1] = (undefined4)0x006601f0;
  *param_1 = (undefined4)0x00660160;
  param_1[8] = 0;
  param_1[7] = 0;
  return 0;
}
