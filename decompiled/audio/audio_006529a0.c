...
extern unsigned char *DAT_00713f4c;

size_t FUN_006529a0(void *param_1,int param_2)

{
  ...
  _Size = FUN_00652a00(param_2);
  if ((int)_Size < 0) {
    return _Size;
  }
  _memmove(param_1,*(void **)(DAT_00713f4c + param_2 * 8),_Size);
  *(void **)(DAT_00713f4c + param_2 * 8) = param_1;
  return 0;
}
