/* spd-match: far pct=24.18 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall_v2 source=m4_13/4.1.3/va_0066B1E0 */
...
/* M4.1.3-R3: FUN_0066b1a0 → unified __stdcall (callee_stdcall_v2). */
...
int __stdcall FUN_0066b1a0(undefined4 a1);
void __fastcall FUN_0066b1e0(int obj)

{

  DWORD DVar1;
  
  if ((CONCAT31(CONCAT21(CONCAT11(*(undefined1 *)(obj + 0x74),*(undefined1 *)(obj + 0x75)),
                         *(undefined1 *)(obj + 0x76)),*(undefined1 *)(obj + 0x77)) != 0) &&
     (CONCAT11(*(undefined1 *)(obj + 0x72),*(undefined1 *)(obj + 0x73)) != 0)) {
    DVar1 = GetTickCount();
    if (999 < DVar1 - *(int *)(obj + 0xb4)) {
      if (*(int *)(obj + 0x80) == 1) {
        FUN_0066b1a0(0x10);
        return;
      }
