/* spd-match: far pct=14.29 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
int __cdecl FUN_006562c0();
extern int DAT_00716465;
extern int DAT_00716534;
extern int DAT_00716544;
extern int DAT_00716574;
extern int DAT_0071666c;

void FUN_00656510(void)

{
  ...
  FUN_0064e520();
  if (DAT_00716574 != 0) {
    FUN_006510d0(DAT_00716574);
    DAT_00716574 = 0;
  }
  if (DAT_0071666c != 0) {
    FUN_006510d0(DAT_0071666c);
    DAT_0071666c = 0;
  }
  piVar1 = &DAT_00716534;
  do {
    ...
    piVar1 = piVar1 + 1;
  } while ((int)piVar1 < 0x71653c);
  iVar2 = 0;
  if (DAT_00716465 != 0) {
    do {
      if ((&DAT_00716544)[iVar2] != 0) {
        FUN_006510d0((&DAT_00716544)[iVar2]);
        (&DAT_00716544)[iVar2] = 0;
      }
      iVar2 = iVar2 + 1;
    } while (iVar2 < (int)(uint)DAT_00716465);
  }
  FUN_006562c0(0x40000000);
  FUN_0064e540();
  return;
}
