/* spd-match: far pct=17.31 flags=/O2 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_00589FC0 */
...
int __cdecl FUN_005894a0();
extern unsigned char *DAT_00734514;

void __fastcall FUN_00589fc0(int * obj)
