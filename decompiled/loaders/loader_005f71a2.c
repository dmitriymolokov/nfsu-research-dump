...
struct ThisCallBox {
  int FUN_005f71a2(int param_2);
};
int ThisCallBox::FUN_005f71a2(int param_2) {
  undefined4 *puVar1;
  uint uVar2;
  int iVar3;
  undefined4 *puVar4;
  ...
  local_8 = *(int *)(((int)this) + 0x1c);
  if (*(int *)(((int)this) + 4) == local_8) {
    if (local_8 == 0) {
      local_8 = 0x10;
    }
    else {
    ...
    puVar4 = puVar1 + *(int *)(((int)this) + 4);
    for (uVar2 = local_8 - *(int *)(((int)this) + 4) & 0x3fffffff; uVar2 != 0; uVar2 = uVar2 - 1) {
      *puVar4 = 0;
      puVar4 = puVar4 + 1;
    }
    for (iVar3 = 0; iVar3 != 0; iVar3 = iVar3 + -1) {
    ...
    *(int *)(((int)this) + 0x1c) = local_8;
    *(undefined4 **)(((int)this) + 0x10) = puVar1;
  }
  *(int *)(*(int *)(((int)this) + 0x10) + *(int *)(((int)this) + 4) * 4) = param_2;
