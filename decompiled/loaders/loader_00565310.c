/* spd-match: far pct=18.95 flags=/O2 /Gr /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_00565310 */
...
void __fastcall FUN_00565310(int edi, undefined4 * obj, undefined4 param_1,undefined4 param_2)

{
  ...
  *puVar1 = puVar1;
  ...
  obj[0xc] = 0;
  obj[0xd] = 0;
  FUN_0063f150(obj + 0xf);
  *(undefined1 *)(obj + 0xe) = 1;
  *(undefined1 *)((int)obj + 0x39) = 1;
  *obj = param_2;
  obj[9] = obj[9] + edi;
  FUN_00565410(obj,edi);
  return;
}
