/* spd-match: far pct=5.45 flags=/O1 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_005AA970 */
...
void __fastcall FUN_005aa970(int * obj, int esi)

{
  ...
  iVar1 = DAT_00736158;
  local_4 = -1;
  if ((*(char *)(esi + 0x3c) != '\0') && (*obj != 0)) {
    local_4 = (*obj - DAT_00736158) / 0x170;
  }
  FUN_00571c20(esi,&local_4,4,4,0);
  if (*(char *)(esi + 0x3d) != '\0') {
    if ((-1 < local_4) && (local_4 < DAT_0073615c)) {
      *obj = local_4 * 0x170 + iVar1;
      return;
    }
    *obj = 0;
  }
