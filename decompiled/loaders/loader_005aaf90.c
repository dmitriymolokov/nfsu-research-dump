/* spd-match: far pct=13.16 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_005AAF90 */
/* Pass A — minimal Ghidra → MSVC6 typedefs (not from speed.exe) */
/* M4.1.2: unaff_EBX → __fastcall 2nd arg (unaff_2nd; sync only on uplift). */
...
extern int DAT_00736164;

int __cdecl FUN_00571c20();
extern int DAT_00736160;
extern int DAT_00736164;

void __fastcall FUN_005aaf90(int obj, int * ebx_obj)

{
  ...
  piVar2 = (int *)*ebx_obj;
  local_4 = -1;
  if ((*(char *)(obj + 0x3c) != '\0') && (piVar2 != (int *)0x0)) {
    local_4 = *piVar2;
  }
  FUN_00571c20(obj,&local_4,4,4,0);
  if (*(char *)(obj + 0x3d) == '\0') {
    *ebx_obj = (int)piVar2;
    return;
  }
  if ((local_4 != -1) && (iVar1 = 0, piVar2 = DAT_00736160, 0 < DAT_00736164)) {
    do {
      if (*piVar2 == local_4) {
        *ebx_obj = (int)piVar2;
        return;
