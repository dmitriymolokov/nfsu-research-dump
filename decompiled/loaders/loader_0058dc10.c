/* spd-match: far pct=11.63 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_0058DC10 */
...
int __cdecl FUN_0058d620();
int __cdecl FUN_0058db20();
void __cdecl FUN_0058dc10(int obj)

{
  ...
  pbVar1 = (byte *)(obj + 0x14);
  iVar2 = 0x20;
  do {
    *(short *)(obj + 0x34) = *(short *)(obj + 0x34) - (ushort)*pbVar1;
    *pbVar1 = 0;
    pbVar1 = pbVar1 + 1;
    iVar2 = iVar2 + -1;
  } while (iVar2 != 0);
  *(undefined2 *)(obj + 0x34) = 0;
  FUN_0058d620();
  FUN_0058db20();
  return;
}
