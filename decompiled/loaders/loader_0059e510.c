/* spd-match: far pct=2.48 flags=/O2 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.5/va_0059E510 */
...
extern void LAB_0059e545(void);
uint __fastcall FUN_0059e510(int val, int param_1)

{
  ...
  if (0 < DAT_0073616c) {
    do {
      if (*(short *)(iVar3 + 0x6c) == val) goto LAB_0059e545;
      iVar1 = iVar1 + 1;
      iVar3 = iVar3 + 0xfc;
...
LAB_0059e545:
  ...
  if (*(uint *)(param_1 + 0x10) != 0) {
    piVar4 = (int *)(*(int *)(param_1 + 0xc) + 0x24);
    do {
      if ((piVar4[-1] == 4) && (*piVar4 == iVar3)) {
        return CONCAT31((int3)(uVar2 * 0x34 >> 8),
                        *(undefined1 *)(uVar2 * 0x34 + 0x30 + *(int *)(param_1 + 0xc)));
      }
      uVar2 = uVar2 + 1;
      piVar4 = piVar4 + 0xd;
