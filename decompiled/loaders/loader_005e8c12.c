/* spd-match: far pct=13.68 flags=/O1 /c /nologo /TC method=m39 source=m39/4.1.5/va_005E8C12 */
...
undefined4
FUN_005e8c12(float *param_2,int param_3,uint param_4,undefined4 param_5)

{
  ...
  if (*(int *)(uVar3 + 4) == 1) {
    ...
    if (local_8 == (float *)0x0) {
      ...
      pfVar5 = local_8;
      for (iVar2 = ((uint)param_2 & 0xfffffff) << 2; iVar2 != 0; iVar2 = iVar2 + -1) {
        *pfVar5 = 0.0;
        pfVar5 = pfVar5 + 1;
      }
      ...
      uVar4 = FUN_0061319b(local_8,_Size,6,param_5);
    }
  }
  _free(local_8);
  return uVar4;
