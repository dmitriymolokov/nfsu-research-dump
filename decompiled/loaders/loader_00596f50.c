/* spd-match: far pct=10.21 flags=/O1 method=thiscall_tp source=m375_sync_decomp:m375_inventory */
...
int __cdecl FUN_004688e0(...);
int __cdecl FUN_00468ec0(...);
int __cdecl FUN_00571c20(...);
int __cdecl FUN_00571ea0(...);
int __cdecl FUN_00584960(...);
extern int DAT_00734470;

struct ThisCallBox {
  void FUN_00596f50(int param_2);
};
void ThisCallBox::FUN_00596f50(int param_2) {
  int iVar1;
  int iVar2;
  char cVar3;
  
  iVar1 = param_2;
  FUN_00571ea0(((int)this),"Smokeable");
  FUN_004688e0(iVar1);
  FUN_00571c20(iVar1,((int)this) + 0x4c2,1,1,1);
  FUN_00571c20(iVar1,((int)this) + 0x4c3,1,1,1);
  if ((*(char *)(iVar1 + 0x3e) != '\0') || (*(char *)(iVar1 + 0x3f) != '\0')) {
    FUN_00571c20(iVar1,*(int *)(((int)this) + 0x158) + 0x80,4,4,0);
  }
  FUN_00571c20(iVar1,((int)this) + 0x15c,4,0xffffffff,0);
  FUN_00571c20(iVar1,((int)this) + 0x160,4,0xffffffff,0);
  FUN_00571c20(iVar1,((int)this) + 0x168,4,0xffffffff,0);
  FUN_00571c20(iVar1,((int)this) + 0x164,4,0xffffffff,0);
  FUN_00571c20(iVar1,((int)this) + 0x16c,4,0xffffffff,0);
  FUN_00571c20(iVar1,((int)this) + 0x174,4,0xffffffff,0);
  if (*(char *)(iVar1 + 0x3d) == '\0') {
    if (*(int *)(((int)this) + 0x170) == 0) {
      param_2 = -1;
    }
    else {
      param_2 = (*(int *)(((int)this) + 0x170) - DAT_00734470) / 0x70;
    }
    FUN_00571c20(iVar1,&param_2,2,2,1);
  }
  else {
    FUN_00571c20(iVar1,&param_2,2,2,1);
    if ((short)param_2 < 0) {
      ...
      *(int *)(((int)this) + 0x170) = (short)param_2 * 0x70 + DAT_00734470;
    }
  }
  FUN_00584960();
  if (*(char *)(iVar1 + 0x3c) != '\0' || *(char *)(iVar1 + 0x3d) != '\0') {
    FUN_00468ec0();
  }
  if ((*(char *)(iVar1 + 0x3e) != '\0') || (*(char *)(iVar1 + 0x3f) != '\0')) {
    FUN_00571c20(iVar1,((int)this) + 0x24,8,0xffffffff,0);
  }
  if ((*(char *)(iVar1 + 0x3e) != '\0') || (*(char *)(iVar1 + 0x3f) != '\0')) {
    FUN_00571c20(iVar1,((int)this) + 0x2c,8,0xffffffff,0);
  }
  iVar2 = *(char *)(iVar1 + 0x40) * 0x10;
  *(int *)(iVar2 + iVar1 + 0x58) = *(int *)(iVar1 + 0x150) - *(int *)(iVar2 + 0x58 + iVar1);
  cVar3 = *(char *)(iVar1 + 0x40) + -1;
  *(char *)(iVar1 + 0x40) = cVar3;
  if ((int)cVar3 < *(int *)(iVar1 + 0x44)) {
