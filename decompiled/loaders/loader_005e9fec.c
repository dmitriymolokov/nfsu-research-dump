/* spd-match: far pct=3.77 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m375_8r/buckets/r_07/attempt6_c2520 */
#include "ghidra_compat.h"

int __cdecl FUN_005abac4();
int __cdecl FUN_005e9c6c();

undefined8 *
FUN_005e9fec(undefined8 *param_1,int param_2,undefined8 *param_3,int param_4,undefined4 param_5,
            uint param_6)

{
  ...
  for (; iVar3 != 0; iVar3 = iVar3 + -1) {
    FUN_005abac4(puVar5,param_3,param_5);
