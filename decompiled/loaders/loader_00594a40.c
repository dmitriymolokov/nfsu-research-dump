/* spd-match: far pct=5.21 flags=/O2 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_00594A40 */
...
extern unsigned char *DAT_00734490;
extern int DAT_00734494;
extern int _DAT_00734498;

int __fastcall FUN_00594a40(char *param_2)

{
  ...
  pbVar10 = local_80;
  while (local_80[0] != 0) {
    uVar9 = uVar9 * 0x21 + (uint)local_80[0];
    pbVar1 = pbVar10 + 1;
    pbVar10 = pbVar10 + 1;
    local_80[0] = *pbVar1;
  }
  ...
  if (-1 < DAT_00734494) {
    while( true ) {
      iVar6 = iVar5 + iVar8 >> 1;
      uVar3 = *(uint *)(DAT_00734490 + iVar6 * 0x18);
      if ((uVar3 == uVar9) &&
         ((iVar6 == 0 || (*(uint *)(DAT_00734490 + iVar6 * 0x18 + -0x18) != uVar9)))) break;
      if (uVar3 < uVar9) {
        iVar5 = iVar6 + 1;
      }
      else {
    ...
    if (-1 < iVar6) {
      puVar11 = (uint *)(DAT_00734490 + iVar6 * 0x18);
      iVar5 = 0x7fffffff;
      uVar3 = *(uint *)(DAT_00734490 + iVar6 * 0x18);
      iVar8 = iVar6;
      while (uVar3 == uVar9) {
        iVar7 = puVar11[3] - _DAT_00734498;
        if (iVar7 < 0) {
          iVar7 = -iVar7;
        }
        if (iVar7 < iVar5) {
      ...
      return DAT_00734490 + iVar8 * 0x18;
    }
  }
  return 0;
}
