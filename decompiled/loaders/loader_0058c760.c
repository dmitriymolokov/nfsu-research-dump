/* spd-match: far pct=43.53 flags=/Og /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_0058C760 */
...
extern int DAT_00734500;

void __fastcall FUN_0058c760(int obj)

{
  ...
  iVar5 = DAT_00734500;
  piVar1 = *(int **)(obj + 0x4c);
  while (piVar4 = piVar1, piVar4 != (int *)(obj + 0x4c)) {
    piVar1 = (int *)*piVar4;
    if ((((piVar4[2] == 0) && (piVar4[4] == 0)) && (piVar4[5] == 0)) && (piVar4[6] == 0)) {
      piVar2 = (int *)piVar4[1];
      *piVar2 = (int)piVar1;
      piVar1[1] = (int)piVar2;
