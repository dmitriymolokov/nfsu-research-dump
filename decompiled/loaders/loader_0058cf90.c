/* spd-match: far pct=6.25 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_0058CF90 */
...
extern int DAT_007344fc;

void __fastcall FUN_0058cf90(int * obj)
