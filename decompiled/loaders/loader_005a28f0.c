/* spd-match: far pct=27.78 flags=/O2 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_005A28F0 */
...
undefined4 __fastcall FUN_005a28f0(int obj, int edi)

{
  ...
  if (0 < *(int *)(obj + 0xb08)) {
    ...
    do {
      if (*piVar2 == edi) {
        return *(undefined4 *)(iVar1 * 0x15c + obj + 0x28);
      }
      iVar1 = iVar1 + 1;
      piVar2 = piVar2 + 0x57;
    } while (iVar1 < *(int *)(obj + 0xb08));
  }
  return uRam00000000;
}
