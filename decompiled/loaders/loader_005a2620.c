/* spd-match: far pct=28.24 flags=/O2 /c /nologo /TC method=m39 source=m39/4.1.2/va_005A2620 */
...
undefined8 __cdecl FUN_005a03d0(void);
int __cdecl FUN_005a34d0();
extern int DAT_00733f78;

void __fastcall FUN_005a2620(int obj)

{
  ...
  if ((uint)uVar3 < 0x20) {
    iVar1 = (&DAT_00733f78)[(uint)uVar3];
  }
  else {
    iVar1 = 0;
  }
  kind = *(unsigned char *)(obj + 0x11);
  if (kind == 1) {
    iVar1 = *(int *)(iVar1 + 4);
  }
  else if (kind == 2) {
  ...
  *(int *)(iVar2 + 0x1374) -= iVar1;
  *(int *)(iVar2 + 0x137c) += iVar1;
  FUN_005a34d0(iVar2 + 0x44c);
  return;
}
