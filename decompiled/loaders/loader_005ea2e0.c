/* spd-match: far pct=3.31 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m375_8r/buckets/r_07/attempt6_c2520 */
#include "ghidra_compat.h"

int __cdecl FUN_005abb0c();
int __cdecl FUN_005e9c6c();

undefined8 *
FUN_005ea2e0(undefined8 *param_1,int param_2,undefined8 *param_3,int param_4,undefined4 param_5,
            uint param_6)

{
  ...
  uVar4 = -(uint)(0xc < param_6) & param_6 & 0xfffffffc;
  iVar3 = param_6 - uVar4;
  uVar4 = uVar4 >> 2;
  puVar5 = param_1;
  if (uVar4 != 0) {
  ...
  for (; iVar3 != 0; iVar3 = iVar3 + -1) {
    FUN_005abb0c(puVar5,param_3,param_5);
