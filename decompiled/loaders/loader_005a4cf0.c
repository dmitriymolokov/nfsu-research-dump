/* spd-match: far pct=9.38 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
int __cdecl FUN_00520ae0();
int __cdecl FUN_00674898();
extern int DAT_007356a8;

undefined4 FUN_005a4cf0(int *param_1)
