/* spd-match: far pct=20.00 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_0058B490 */
...
int __cdecl FUN_0058ad80();
int __cdecl FUN_0058c270();
void __fastcall FUN_0058b490(int obj)

{
  ...
  if (piVar2 == (int *)0x0) {
    ...
    if (iVar3 == 0) {
      ...
      piVar2 = (int *)FUN_0058ad80();
    }
    puVar1 = *(undefined4 **)(obj + 0x28);
    *puVar1 = piVar2;
    *(int **)(obj + 0x28) = piVar2;
    piVar2[1] = (int)puVar1;
    *piVar2 = obj + 0x24;
  }
  *(short *)(piVar2 + 0x14) = (short)piVar2[0x14] + 1;
  return;
}
