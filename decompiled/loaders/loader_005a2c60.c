/* spd-match: far pct=56.76 flags=/O1 /c /nologo /TC method=m4_13_fc_wrapper_thiscall source=m4_13/4.1.3/va_005A2C60 */
...
/* M4.1.3: FUN_005a2f10 → __stdcall (callee_stdcall). */
...
int __stdcall FUN_005a2f10(void);

void __fastcall FUN_005a2c60(int head)

{
  char cVar1;
  
  cVar1 = FUN_005a2f10(head,0);
  if (cVar1 != '\0') {
    *(undefined1 *)(head + 0x59ec) = 1;
    *(undefined4 *)(*(int *)(head + 0x5864) + 0x14) = 2;
    return;
  }
  *(undefined4 *)(*(int *)(head + 0x5864) + 0x14) = 2;
  return;
