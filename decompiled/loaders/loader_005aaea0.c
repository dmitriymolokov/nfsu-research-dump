/* spd-match: far pct=5.10 flags=/O2 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_005AAEA0 */
...
void __fastcall FUN_005aaea0(int obj, float esi)

{
  ...
  fVar1 = _DAT_006cc794;
  *(undefined1 *)((int)esi + 6 + obj) = 0xff;
  iVar3 = 0;
  pfVar2 = (float *)(obj + 0x1c);
  do {
    if (((*(char *)(pfVar2 + -3) != '\0') && (pfVar2[-2] == esi)) && (*pfVar2 < fVar1)) {
      *(char *)((int)esi + 6 + obj) = (char)iVar3 + '2';
      fVar1 = *pfVar2;
    }
    if (((*(char *)(pfVar2 + 1) != '\0') && (pfVar2[2] == esi)) && (pfVar2[4] < fVar1)) {
      *(char *)((int)esi + 6 + obj) = (char)iVar3 + '3';
      fVar1 = pfVar2[4];
    }
    iVar3 = iVar3 + 2;
    pfVar2 = pfVar2 + 8;
