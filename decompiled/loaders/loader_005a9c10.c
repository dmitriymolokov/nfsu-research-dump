/* spd-match: far pct=5.21 flags=/O2 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.5/va_005A9C10 */
/* M3.9.26.5: Ghidra EAX local → __fastcall typed arg (build strip; % may drop). */
#include "ghidra_compat.h"

int __cdecl FUN_00567de0();
int __cdecl FUN_0057cc30();
extern int DAT_006b7e14;
extern int DAT_006b7e1c;
extern int DAT_00734588;
int __fastcall FUN_005a9c10(int * obj, int param_1)
