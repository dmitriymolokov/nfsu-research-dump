/* spd-match: far pct=13.46 flags=/O2 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_00594F40 */
...
int __cdecl FUN_00594310();
extern unsigned char *DAT_00734484;

void __fastcall FUN_00594f40(int * obj)
