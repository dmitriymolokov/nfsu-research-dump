/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TP method=m36_pass_b source=m36_pass_b/va_005A1810 */
...
struct ThisCallBox {
  uint * FUN_005a1810(int param_2);
};
uint * ThisCallBox::FUN_005a1810(int param_2) {
  uint *puVar1;
  
  if (((0x100 <= ((uint)this)) || (puVar1 = (uint *)(((uint *)0x00733ff8)[((uint)this)]), puVar1 == (uint *)0x0)) &&
