/* spd-match: far pct=9.51 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
int __cdecl FUN_0046abd0();
int __cdecl FUN_00597ea0();
extern int _DAT_006b5a80;

void __fastcall FUN_00597fa0(int param_1)

{
  ...
  *(int *)(param_1 + 900) = iVar3;
  if (iVar3 == 0) {
    *(undefined4 *)(*(int *)(param_1 + -0xd4) + 0x140) = 1;
  ...
  if (iVar3 != 1) {
    if (iVar3 == 2) {
      ...
      *(undefined4 *)(*(int *)(param_1 + -0xd4) + 0x140) = 0;
  ...
  iVar3 = *(int *)(param_1 + -0xd4);
  fVar1 = _DAT_006b5a80 * *(float *)(iVar3 + 0x70);
  fVar2 = *(float *)(iVar3 + 0x74) * _DAT_006b5a80;
  *(float *)(iVar3 + 0x78) = *(float *)(iVar3 + 0x78) * _DAT_006b5a80;
  *(float *)(iVar3 + 0x70) = fVar1;
  *(float *)(iVar3 + 0x74) = fVar2;
  iVar3 = *(int *)(param_1 + -0xd4);
  fVar1 = _DAT_006b5a80 * *(float *)(iVar3 + 0x80);
  fVar2 = *(float *)(iVar3 + 0x84) * _DAT_006b5a80;
  *(float *)(iVar3 + 0x88) = *(float *)(iVar3 + 0x88) * _DAT_006b5a80;
  *(float *)(iVar3 + 0x80) = fVar1;
  *(float *)(iVar3 + 0x84) = fVar2;
  *(undefined4 *)(*(int *)(param_1 + -0xd4) + 0x140) = 1;
  *(undefined1 *)(param_1 + -0x123) = 1;
  FUN_0046abd0();
  return;
