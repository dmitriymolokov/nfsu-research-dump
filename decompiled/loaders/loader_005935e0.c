/* spd-match: far pct=14.04 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_005935E0 */
...
extern void LAB_00593609(void);

void __fastcall FUN_005935e0(undefined4 param_1,int param_2, int esi)
...
LAB_00593609:
      if (esi == *(int *)(param_2 + 0x18)) {
        *(undefined4 *)(param_2 + 0x18) = 0;
        *(undefined4 *)(param_2 + 0x10) = *(undefined4 *)(param_2 + 8);
      }
      return;
    }
    if ((*(char *)(puVar1 + 3) == '\0') && (puVar1[2] == esi)) {
