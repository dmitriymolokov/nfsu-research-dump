/* spd-match: far pct=10.09 flags=/O1 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_0058D560 */
...
int __cdecl FUN_0058d620();
void __fastcall FUN_0058d560(int obj, int esi)

{
  int iVar1;
  char cVar2;

  FUN_00571ea0(0,"BodyDamage");
  FUN_00571c20(esi,obj + 8,0x20,0x20,0);
  FUN_00571c20(esi,obj + 0x28,2,2,0);
  if (*(char *)(esi + 0x3d) != '\0') {
    FUN_0058d620();
  }
  iVar1 = *(char *)(esi + 0x40) * 0x10 + 0x4c + esi;
  *(int *)(iVar1 + 0xc) = *(int *)(esi + 0x150) - *(int *)(iVar1 + 0xc);
  cVar2 = *(char *)(esi + 0x40) + -1;
  *(char *)(esi + 0x40) = cVar2;
  if ((int)cVar2 < *(int *)(esi + 0x44)) {
    *(undefined4 *)(esi + 0x44) = 0xffffffff;
  }
  return;
}
