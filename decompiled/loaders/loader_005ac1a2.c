/* spd-match: far pct=5.29 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
void FUN_005ac1a2(float *param_1,float *param_2,float *param_3,float *param_4,float *param_5,
                 float param_6)

{
  ...
  fVar2 = param_6 * fVar1;
  fVar3 = ((fVar2 + fVar2) - _DAT_006cc7ac * fVar1) + _DAT_006cc7bc;
  param_6 = (fVar2 - (fVar1 + fVar1)) + param_6;
  fVar4 = _DAT_006cc7ac * fVar1 - (fVar2 + fVar2);
  fVar2 = fVar2 - fVar1;
