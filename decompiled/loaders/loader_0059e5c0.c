/* spd-match: far pct=0.00 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
uint __fastcall FUN_0059e5c0(int param_1)

{
  ...
  if (*(uint *)(param_1 + 0x10) != 0) {
    ...
    do {
      if ((piVar2[-1] == 1) && (*piVar2 == unaff_EBX)) {
        return CONCAT31((int3)(uVar1 * 0x34 >> 8),
                        *(undefined1 *)(uVar1 * 0x34 + 0x30 + *(int *)(param_1 + 0xc)));
      }
      uVar1 = uVar1 + 1;
      piVar2 = piVar2 + 0xd;
