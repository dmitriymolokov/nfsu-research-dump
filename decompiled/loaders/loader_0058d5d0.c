/* spd-match: far pct=2.94 flags=/O1 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_0058D5D0 */
...
void __fastcall FUN_0058d5d0(int obj, int esi)

{
  ...
  sVar1 = FUN_00674898();
  *(short *)(esi + 0x28) =
       *(short *)(esi + 0x28) + (sVar1 - (ushort)*(byte *)(obj + 8 + esi));
  *(char *)(obj + 8 + esi) = (char)sVar1;
  return;
}
