/* spd-match: far pct=20.83 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_005F7658 */
...
/* M4.1.3: FUN_005f716a → __stdcall (callee_stdcall). */
...
int __stdcall FUN_005f716a(int arg);
int __cdecl FUN_005f7186();
extern unsigned char *PTR_FUN_006a3e10;

void __fastcall FUN_005f7658(undefined4 *param_1)

{
  uint uVar1;
  
  *param_1 = &PTR_FUN_006a3e10;
  if (param_1[4] != 0) {
    uVar1 = 0;
    if (param_1[1] != 0) {
      do {
        if (*(int *)(param_1[4] + uVar1 * 4) != 0) {
          FUN_005f716a(1);
        }
        uVar1 = uVar1 + 1;
