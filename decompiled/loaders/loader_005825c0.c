/* spd-match: far pct=12.90 flags=/Ob2 /c /nologo /TC method=m4_11_unaff source=m4_11/4.1.1/va_005825C0 */
...
void __fastcall FUN_005825c0(int obj)

{
  
  if (*(void **)(obj + 0x10) != (void *)0x0) {
    _free(*(void **)(obj + 0x10));
  }
  if (*(void **)(obj + 0x2c) != (void *)0x0) {
    _free(*(void **)(obj + 0x2c));
  }
  return;
}
