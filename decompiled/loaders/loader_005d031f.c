/* spd-match: far pct=25.51 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_005D031F */
...
int __cdecl FUN_005cd1d4();
int __cdecl FUN_005d019e();
...
void __cdecl FUN_005d031f(int param_1)

{
  ...
  while (iVar1 != 0) {
    _Memory = *(void **)(param_1 + 0x34);
    *(undefined4 *)(param_1 + 0x34) = *(undefined4 *)((int)_Memory + 0x34);
    *(undefined4 *)((int)_Memory + 0x34) = 0;
    FUN_005d031f(param_1);
    _free(_Memory);
    iVar1 = *(int *)(param_1 + 0x34);
  }
