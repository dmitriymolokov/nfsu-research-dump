/* spd-match: close pct=83.33 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m375_inventory/batches/20260724T083405Z_w0_tc0 */
...

{
  ...
  pvVar1 = __nh_malloc(_Size,DAT_00717d74);
  return pvVar1;
}
