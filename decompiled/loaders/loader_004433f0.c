/* spd-match: far pct=16.25 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_004433F0 */
...
void __fastcall FUN_004433f0(int obj)

{
  ...
  if (0 < *(int *)(obj + 8)) {
    do {
      iVar1 = *(int *)(obj + 0xc);
      _Memory = *(void **)(iVar1 + 0x24 + iVar2);
      if (_Memory != (void *)0x0) {
        if (*(char *)((int)_Memory + 0x19) != '\0') {
          _free(*(void **)((int)_Memory + 0x20));
        }
        _free(_Memory);
        *(undefined4 *)(iVar1 + iVar2 + 0x24) = 0;
      }
      local_4 = local_4 + 1;
      iVar2 = iVar2 + 0x28;
    } while (local_4 < *(int *)(obj + 8));
  }
  return;
}
