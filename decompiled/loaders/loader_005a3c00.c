/* spd-match: far pct=2.42 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
extern int DAT_006c3434;
extern int DAT_006c343c;
extern int DAT_006c3444;
extern int DAT_006c344c;
extern int DAT_006c3454;
extern int DAT_00734588;

uint FUN_005a3c00(int param_1)

{
  ...
  while( true ) {
    ...
    if (param_1 == iVar8) {
      return CONCAT31(uVar4,2);
    }
    if (param_1 == iVar11) break;
    if (param_1 == iVar10) {
      return CONCAT31(uVar4,4);
    }
    if (param_1 == iVar3) {
      return CONCAT31(uVar4,5);
    }
    local_4 = local_4 + 1;
    local_8 = local_8 + 0xc90;
    if (0x22 < (int)local_4) {
      return local_4 & 0xffffff00;
    }
  }
  return CONCAT31(uVar4,3);
}
