/* spd-match: far pct=6.25 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_0058ACB0 */
...
extern int DAT_00734508;

void __fastcall FUN_0058acb0(int * obj)
