/* spd-match: far pct=40.00 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
void FUN_005ab8eb(float *param_1,float *param_2,float *param_3,float *param_4,float *param_5,
                 float param_6)

{
  ...
  fVar2 = param_6 * fVar1;
  fVar4 = ((fVar2 + fVar2) - fVar1 * _DAT_006cc7ac) + _DAT_006cc7bc;
  param_6 = (fVar2 - (fVar1 + fVar1)) + param_6;
  fVar3 = fVar1 * _DAT_006cc7ac - (fVar2 + fVar2);
