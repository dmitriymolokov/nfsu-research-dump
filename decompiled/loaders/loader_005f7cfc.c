/* spd-match: bit_match pct=100.00 flags=/O1 /c /nologo /TP method=thiscall_tp source=m3_bad_signature_thiscall */
...
struct ThisCallBox {
  undefined4 FUN_005f7cfc(int param_2);
};
undefined4 ThisCallBox::FUN_005f7cfc(int param_2) {
  undefined4 uVar1;
  ...
  if (param_2 == 0) {
    ...
    *(undefined4 *)(((int)this) + 0x44) = *(undefined4 *)(param_2 + 0x44);
    *(undefined4 *)(((int)this) + 0x48) = *(undefined4 *)(param_2 + 0x48);
    *(undefined4 *)(((int)this) + 0x4c) = *(undefined4 *)(param_2 + 0x4c);
    *(undefined4 *)(((int)this) + 0x50) = *(undefined4 *)(param_2 + 0x50);
    *(undefined4 *)(((int)this) + 0x54) = *(undefined4 *)(param_2 + 0x54);
    *(undefined4 *)(((int)this) + 0x58) = *(undefined4 *)(param_2 + 0x58);
    uVar1 = 0;
  }
  return uVar1;
}
