/* spd-match: far pct=19.44 flags=/O1 /c /nologo /TP method=m39 source=m39/4.1.4/va_005D02D7 */
...
struct ThisCallBox {
  ...
  void FUN_005d02d7(int param_2);
};
void ThisCallBox::FUN_005d02d7(int param_2) {
  int *piVar1;
  int iVar2;
  int *piVar3;
  
  iVar2 = this->FUN_005cf304((undefined4 *)param_2);
  if ((-1 < iVar2) &&
     (piVar1 = *(int **)(*(int *)(*(int *)(((int)this) + 0x8c) + *(int *)(param_2 + 4) * 4) + 0x38),
     piVar1 != (int *)0x0)) {
    for (piVar3 = (int *)piVar1[4]; piVar3 != piVar1; piVar3 = (int *)piVar3[4]) {
      if ((*piVar3 != 0) &&
          (iVar2 = ((ThisCallBox *)*piVar3)->FUN_005cf304((undefined4 *)piVar3[1]), iVar2 < 0)) {
        return;
      }
    }
  }
