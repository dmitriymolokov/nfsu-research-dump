/* spd-match: far pct=5.73 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
int __cdecl FUN_005ab736();
extern int _DAT_00699488;
extern int _DAT_006cc7bc;

void FUN_005ae733(float *param_1,float *param_2)

{
  ...
  iVar3 = FUN_005ab736(fVar2,0x3f800000);
  if (iVar3 == 0) {
    if (fVar2 <= _DAT_00699488) {
      *param_1 = 0.0;
      param_1[1] = 0.0;
      param_1[2] = 0.0;
      return;
    }
    fVar2 = _DAT_006cc7bc / SQRT(fVar2);
