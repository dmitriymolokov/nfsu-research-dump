/* spd-match: far pct=12.79 flags=/Ob2 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_005A4420 */
...
int __cdecl FUN_005a41e0();
extern int DAT_00733ff8;
int __cdecl FUN_005a03d0();
int __cdecl FUN_005a41e0();
extern int DAT_00733ff8;
int __cdecl FUN_005a4420(uint * obj)

{
  ...
  if (cVar1 != '\0') {
    ...
    if (0 < *(int *)(iVar3 + 0x74)) {
      ...
      do {
        if ((*piVar4 == 0) && (piVar4[1] == iVar2)) {
          return piVar4[2];
        }
        iVar5 = iVar5 + 1;
        piVar4 = piVar4 + 3;
      } while (iVar5 < *(int *)(iVar3 + 0x74));
    }
  }
  return -1;
}
