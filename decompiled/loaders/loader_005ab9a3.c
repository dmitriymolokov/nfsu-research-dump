/* spd-match: far pct=12.00 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
void FUN_005ab9a3(float *param_1,float *param_2,float *param_3,float *param_4,float *param_5,
                 float param_6)
