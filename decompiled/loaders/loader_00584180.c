/* spd-match: far pct=12.66 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_00584180 */
...
void __fastcall FUN_00584180(undefined4 * obj, int param_1)

{
  ...
  *(undefined1 *)((int)obj + 6) = 0;
  *(undefined1 *)((int)obj + 7) = 0;
  obj[2] = 0;
  obj[3] = 0;
  *(undefined1 *)(obj + 1) = 4;
  *(char *)((int)obj + 5) = (char)param_1;
  *obj = &PTR_FUN_006b9694;
  obj[4] = obj + 5;
  if (5 < param_1) {
    pvVar1 = _malloc(param_1 * 4);
    obj[4] = pvVar1;
  }
  puVar2 = (undefined4 *)obj[4];
