/* Decompiled from Speed.exe @ 005f0a3f */
/* Module: Loader */
/* Ghidra DecompileAll */


void FUN_005f0a3f(ulonglong *param_1,undefined8 *param_2,undefined8 *param_3,ulonglong *param_4,
...

{
  ...
  if (param_4 == (ulonglong *)0x0) {
    ...
    *param_1 = uVar32 & 0xffffffff;
    ...
    uVar13 = PackedFloatingSUBR(uVar6,CONCAT44(DAT_006a078c,DAT_006a0788));
    uVar12 = PackedFloatingSUBR(uVar31,CONCAT44(DAT_006a078c,DAT_006a0788));
    ...
    uVar32 = uVar18 >> 0x20;
    lVar4 = (ulonglong)DAT_006a0788 << 0x20;
    ...
    if (param_2 == (undefined8 *)0x0) {
      ...
      *param_1 = uVar15;
      ...
      lVar23 = (ulonglong)DAT_006a0788 << 0x20;
  ...
  if (param_6 != (undefined8 *)0x0) {
    ...
    uVar6 = PackedFloatingAccumulate(uVar12,uVar12);
    uVar26 = CONCAT44((int)((ulonglong)uVar22 >> 0x20),(int)uVar26);
    uVar15 = PackedFloatingSUBR(uVar6,CONCAT44(DAT_006a078c,DAT_006a0788));
    uVar12 = PackedFloatingSUBR(uVar31,CONCAT44(DAT_006a078c,DAT_006a0788));
    uVar15 = uVar15 & 0xffffffff;
    uVar6 = PackedFloatingADD(uVar3,uVar26);
