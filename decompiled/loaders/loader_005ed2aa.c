...
extern int _DAT_006df220;
extern unsigned int uRam006df224;
extern unsigned int uRam006df228;
extern unsigned int uRam006df22c;

void FUN_005ed2aa(uint *param_1,undefined8 *param_2,undefined8 *param_3,undefined8 *param_4)
