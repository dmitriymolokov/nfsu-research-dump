/* spd-match: far pct=4.37 flags=/O1 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.5/va_0053FBC0 */
...
extern void LAB_0053fc74(void);
void __fastcall FUN_0053fbc0(int obj, int param_1, int param_2)

{
  ...
  iVar8 = *(int *)(obj + 0x84);
  if ((((iVar8 != 0) && (param_1 != 0)) && (0 < param_2)) &&
     (local_3c = (int)*(short *)(iVar8 + 10), 0 < local_3c)) {
    puVar5 = *(uint **)(iVar8 + 4);
    do {
      uVar1 = puVar5[1];
      uVar2 = *puVar5;
      ...
      if (-1 < iVar8) {
        do {
          iVar6 = iVar9;
          if (iVar9 != -1) goto LAB_0053fc74;
          iVar6 = (iVar8 + iVar10) / 2;
          uVar3 = **(uint **)(param_1 + iVar6 * 4);
          if (uVar2 < uVar3) {
            iVar8 = iVar6 + -1;
            iVar6 = iVar9;
          }
...
LAB_0053fc74:
          if (0 < iVar6) {
            puVar7 = (undefined4 *)(param_1 + -4 + iVar6 * 4);
            do {
              if (*(uint *)*puVar7 != uVar2) break;
              iVar6 = iVar6 + -1;
              puVar7 = puVar7 + -1;
            } while (0 < iVar6);
          }
          while ((iVar6 < param_2 && (puVar4 = *(uint **)(param_1 + iVar6 * 4), *puVar4 == uVar2)))
          {
            if ((uVar1 & 1 << ((byte)puVar4[1] & 0x1f)) != 0) {
              FUN_00567370();
            }
            iVar6 = iVar6 + 1;
          }
