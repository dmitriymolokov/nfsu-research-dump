/* spd-match: far pct=12.68 flags=/Og /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_0058AB00 */
...
undefined4 * __fastcall FUN_0058ab00(int edi)
