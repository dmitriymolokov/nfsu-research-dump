/* Decompiled from Speed.exe @ 005d553b */
/* Module: Loader */
/* Ghidra DecompileAll */


undefined4 FUN_005d553b(int param_1,undefined4 param_2,float *param_3,uint param_4)
      ...
      if (iVar3 != 0) {
        ...
        if ((((piVar4[4] != 0) && (*(int *)(iVar3 + 0x18) == -1)) && (param_4 <= (uint)piVar4[4]))
          ...
          if (iVar2 == 1) {
            ...
            do {
              *param_3 = (float)(*(int *)((int)param_3 + iVar5) != 0);
              param_3 = param_3 + 1;
              param_4 = param_4 - 1;
            } while (param_4 != 0);
            return 0;
          ...
          if (iVar2 == 2) {
            ...
            iVar5 = iVar5 - (int)param_3;
            do {
              *param_3 = (float)*(int *)((int)param_3 + iVar5);
              param_3 = param_3 + 1;
              param_4 = param_4 - 1;
            } while (param_4 != 0);
            return 0;
          ...
          if (iVar2 == 3) {
            ...
            iVar5 = iVar5 - (int)param_3;
            do {
              *param_3 = *(float *)(iVar5 + (int)param_3);
              param_3 = param_3 + 1;
              param_4 = param_4 - 1;
            } while (param_4 != 0);
            return 0;
