/* spd-match: far pct=2.36 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_c2520 */
#include "ghidra_compat.h"

void FUN_005ebce3(float *param_1,undefined8 *param_2,float *param_3)

{
  ...
  if (((uint)param_3 & 0xf) == 0) {
    ...
    fVar11 = (float)(__int64)*(undefined8 *)(param_3 + 8) * fVar7 + (float)(__int64)*(undefined8 *)(param_3 + 0xc);
    fVar12 = (float)(__int64)((ulonglong)*(undefined8 *)(param_3 + 8) >> 0x20) * fVar7 +
             (float)(__int64)((ulonglong)*(undefined8 *)(param_3 + 0xc) >> 0x20);
    fVar13 = (float)(__int64)*(undefined8 *)(param_3 + 10) * fVar7 + (float)(__int64)*(undefined8 *)(param_3 + 0xe);
