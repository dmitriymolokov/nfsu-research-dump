/* spd-match: far pct=17.50 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_005A0F60 */
...
void __fastcall FUN_005a0f60(uint param_1, int obj)

{
  ...
  if (((param_1 < 0x100) && ((&DAT_00733ff8)[param_1] != 0)) ||
     ((*(int *)(obj + 0x88b0) != 0 &&
      ((puVar1 = (uint *)(*(int *)(obj + 0x88b0) + 0x58a0), puVar1 != (uint *)0x0 &&
       (param_1 == *puVar1)))))) {
    puVar2 = (undefined1 *)(param_1 + 0x34c + obj);
  }
  else {
    puVar2 = (undefined1 *)0x0;
  }
  *puVar2 = 5;
  if (*(undefined4 **)(obj + 0x88b0) != (undefined4 *)0x0) {
    (**(code **)**(undefined4 **)(obj + 0x88b0))(1);
  }
  *(undefined4 *)(obj + 0x88b0) = 0;
  return;
}
