/* spd-match: far pct=18.97 flags=/O1 /c /nologo /TP method=m39 source=m39/4.1.4/va_005E9207 */
...
unsigned __int64 __aulldiv(void);
unsigned __int64 __alldiv(void);
...
struct ThisCallBox {
  void FUN_005e9207(uint param_2, double *param_4);
};
void ThisCallBox::FUN_005e9207(uint param_2, double *param_4) {
  uint uVar1 = 0;
  float local_10[3];
  ...
  if (param_2 != 0) {
    do {
      if (uVar1 > 2) break;
      local_10[uVar1] = (float)*(((double**)this)[uVar1]);
      uVar1++;
    } while (uVar1 < param_2);
  }
  
  for (uint i = uVar1; i < 3; ++i) {
    local_10[i] = 0.0f;
  }
  
  *param_4 = (double)FUN_005ae18b();
}
