/* spd-match: far pct=8.93 flags=/O1 method=thiscall_tp source=m375_sync_decomp:m375_inventory */
...
int __cdecl FUN_00432e00(...);
int __cdecl FUN_004420e0(...);

struct ThisCallBox {
  uint FUN_00599c40(undefined4 param_2, undefined4 param_3, char param_4);
};
uint ThisCallBox::FUN_00599c40(undefined4 param_2, undefined4 param_3, char param_4) {
  int iVar1;
  int iVar2;
  uint uVar3;
  
  iVar1 = FUN_004420e0(((undefined4)this));
  if (param_4 == '\0') {
    uVar3 = (uint)(9 < iVar1);
  }
  else {
    iVar2 = FUN_00432e00();
    uVar3 = CONCAT31((int3)((uint)(iVar2 + -10) >> 8),iVar1 < iVar2 + -10);
  }
  return uVar3;
}
