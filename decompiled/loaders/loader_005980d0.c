/* spd-match: far pct=26.60 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_005980D0 */
...
int __cdecl FUN_00468820();
undefined4 __cdecl FUN_005980d0(int obj)

{
  ...
  if (0 < cVar1) {
    do {
      iVar3 = FUN_00468820(iVar6);
      iVar2 = *(int *)(*(int *)(iVar3 + 100) + 600);
      iVar5 = 0;
      iVar4 = 0;
      if (*(char *)(iVar2 + 0x15) == '\0') {
        iVar4 = *(int *)(iVar2 + 0x140);
      }
      iVar2 = *(int *)(*(int *)(iVar3 + 100) + 0x25c);
      if (*(char *)(iVar2 + 0x15) == '\0') {
