...
extern void LAB_005ce7f6(...);
extern void LAB_005ce8c4(...);

struct ThisCallBox {
  int FUN_005ce64f(int *param_2, int param_3, int *param_4);
};
int ThisCallBox::FUN_005ce64f(int *param_2, int param_3, int *param_4) {
  int *piVar1;
  int *piVar2;
  uint uVar3;
  undefined4 uVar4;
...
LAB_005ce7f6:
    *(undefined4 *)(iVar6 + 0xc) = 1;
    ...
    iVar5 = (**(code **)(iVar5 + 0x1a8))(local_c[2],uVar4);
    if (-1 < iVar5) {
      FUN_005e8fb1(0);
      goto LAB_005ce7f6;
    }
