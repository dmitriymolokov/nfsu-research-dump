...
struct ThisCallBox {
  undefined4 FUN_005c5691(undefined4 *param_2, undefined4 *param_3);
};
undefined4 ThisCallBox::FUN_005c5691(undefined4 *param_2, undefined4 *param_3) {
  if (param_2 != (undefined4 *)0x0) {
    *param_2 = *(undefined4 *)(*(int *)(((int)this) + 0x54) + 0x18);
  }
  if (param_3 != (undefined4 *)0x0) {
    *param_3 = *(undefined4 *)(*(int *)(((int)this) + 0x54) + 0x1c);
  }
  return 0;
}
