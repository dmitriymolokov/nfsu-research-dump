/* spd-match: matched pct=100.00 flags=/O2 /c /nologo /TP method=m39 source=m39/4.1.4/va_005830B0 */
...
void __stdcall FUN_005830d0(void *);

struct ThisCallBox {
  void * FUN_005830b0(byte param_2);
};
void * ThisCallBox::FUN_005830b0(byte param_2) {
  FUN_005830d0((void *)this);
  if ((param_2 & 1) != 0) {
    _free((void *)this);
  }
  return (void *)this;
