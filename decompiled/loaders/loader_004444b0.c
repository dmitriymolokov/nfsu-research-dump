/* spd-match: far pct=17.72 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_004444B0 */
...
extern unsigned char *DAT_007301d8;
extern int DAT_00730250;
extern int DAT_00736144;
...
void __cdecl FUN_004444b0(int param_1, undefined4 val)

{
  undefined4 uVar1;

  *(undefined4 *)(param_1 + 0x584) = val;
  uVar1 = FUN_00565b60();
  *(undefined4 *)(param_1 + 0x580) = uVar1;
  DAT_007301d8 = &DAT_00730250;
  FUN_00565310(uVar1, "Track Streaming");
  DAT_007301d8[0x38] = 0;
  if (DAT_00736144 != 0) {
    _DAT_00736134 = 1;
  }
