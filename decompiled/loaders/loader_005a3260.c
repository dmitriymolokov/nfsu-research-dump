/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=m4_13_fc_wrapper_thiscall source=m4_13/4.1.3/va_005A3260 */
...
void __fastcall FUN_005a3260(int head)

{
  char cVar1;
  
  cVar1 = FUN_005a2f10(head,1);
  if (cVar1 != '\0') {
