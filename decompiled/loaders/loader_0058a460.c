/* spd-match: far pct=14.81 flags=/O1 /Gr /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_0058A460 */
...
void __fastcall FUN_0058a460(int obj, undefined4 param_2)

{
  code *pcVar1;

  pcVar1 = *(code **)(obj + 0x54);
  if (pcVar1 != (code *)0x0) {
    if (*(int *)(obj + 0x60) != 0) {
      (*pcVar1)(*(undefined4 *)(obj + 0x58),param_2,*(undefined4 *)(obj + 0x5c));
      return;
    }
    (*pcVar1)(*(undefined4 *)(obj + 0x58),param_2);
  }
  return;
}
