/* spd-match: far pct=18.11 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
void FUN_005ac29d(float *param_1,float *param_2,float *param_3,float *param_4,float *param_5,
                 float param_6)
