/* spd-match: far pct=23.17 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
int __cdecl FUN_005aae80();
extern int _DAT_006b5918;
int unaff_ESI;

uint __fastcall FUN_005aaca0(undefined4 param_1,uint param_2)

{
  ...
  case 1:
    break;
  default:
switchD_005aaca8_caseD_2:
    return uVar1 & 0xffffff00;
  }
  uVar1 = unaff_ESI[3];
  if (uVar1 != param_2) {
    if (uVar1 == (param_2 == 0)) goto switchD_005aaca8_caseD_2;
    if (param_2 != 0) {
      fVar2 = (float10)FUN_005aae80();
      if ((float10)_DAT_006b5918 <= fVar2) {
        return 1;
      }
      return 0;
    }
