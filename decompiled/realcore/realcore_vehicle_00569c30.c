/* spd-match: far pct=55.56 flags=/O1 /c /nologo /TP method=m4_14_thin_callee_fastcall source=m4_14/4.1.4/va_00569C30 */
...
/* M4.1.4: FUN_0056c310 → __fastcall(this) (thin_callee_fastcall). */
...
int __fastcall FUN_0056c310(undefined4 *param_1);

struct ThisCallBox {
  void FUN_00569c30(undefined1 param_2);
};
void ThisCallBox::FUN_00569c30(undefined1 param_2) {
  *(undefined1 *)(*(int *)(((int)this) + 0x10) + 7) = param_2;
  FUN_0056c310((undefined4 *)this);
  return;
}
