/* spd-match: far pct=25.00 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_00571AB0 */
...
int __fastcall FUN_00571ab0(undefined4 param_1,int param_2, int esi)

{
  ...
  if (0 < param_2) {
    do {
      iVar1 = iVar1 * 0x21 + (uint)*(byte *)(iVar2 + esi);
      iVar2 = iVar2 + 1;
    } while (iVar2 < param_2);
  }
  return iVar1;
