/* spd-match: far pct=5.88 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_00525410 */
...
int __cdecl FUN_005328b0();
extern int DAT_006cc7a4;
float10 __cdecl FUN_00525410(int obj)

{
  ...
  fVar3 = (float10)*(float *)(iVar2 + 0x70) - (float10)*(float *)(iVar1 + 0x70);
  fVar4 = (float10)*(float *)(iVar2 + 0x74) - (float10)*(float *)(iVar1 + 0x74);
  return SQRT(fVar4 * fVar4 + fVar3 * fVar3);
}
