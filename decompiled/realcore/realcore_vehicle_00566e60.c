/* spd-match: far pct=8.42 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_00566E60 */
/* Pass A — minimal Ghidra → MSVC6 typedefs (not from speed.exe) */
/* M4.1.2: unaff_ESI → __fastcall 2nd arg (unaff_2nd; sync only on uplift). */
...
void __fastcall FUN_00566e60(int obj, int esi_obj)

{
  ...
  iVar2 = FUN_00566dc0(*(undefined4 *)(esi_obj + 0x28),*(undefined4 *)(esi_obj + 0xc),
                       *(undefined4 *)(esi_obj + 0x20));
  *(undefined4 *)(iVar2 + 0x14) = *(undefined4 *)(esi_obj + 0x14);
  iVar3 = *(int *)(esi_obj + 8);
  iVar1 = esi_obj;
  while (iVar3 != 0) {
    iVar1 = *(int *)(iVar1 + 8);
  ...
  *(int *)(iVar1 + 8) = iVar2;
  iVar3 = (obj + -1) * *(int *)(esi_obj + 0x28);
  *(undefined4 *)(iVar2 + 0x30 + ((int)(iVar3 + (iVar3 >> 0x1f & 3U)) >> 2) * 4) =
       *(undefined4 *)(esi_obj + 0x10);
  *(undefined4 *)(esi_obj + 0x10) = *(undefined4 *)(iVar2 + 0x10);
  *(undefined4 *)(iVar2 + 0x10) = 0;
  *(int *)(esi_obj + 0x2c) = *(int *)(esi_obj + 0x2c) + obj;
  return;
}
