/* spd-match: far pct=11.25 flags=/O2 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.5/va_00509D70 */
...
uint __fastcall FUN_00509d70(undefined4 val)

{
  ...
  uVar2 = CONCAT31((int3)((uint)val >> 8),DAT_00735ec1);
  if ((DAT_00735ec1 == '\0') && ((DAT_00745e40 != 2 || (uVar2 = DAT_007677ac, DAT_007677ac == 0))))
  {
    uVar2 = FUN_0059e5f0();
    if ((char)uVar2 == '\0') {
      uVar3 = FUN_005a0350();
      cVar1 = FUN_005a1550(&DAT_0075eef8,uVar3);
      return (uint)(cVar1 == '\0');
    }
  }
