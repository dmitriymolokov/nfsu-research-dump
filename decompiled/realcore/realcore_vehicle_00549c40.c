/* spd-match: far pct=15.05 flags=/O1 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_00549C40 */
/* Pass A — minimal Ghidra → MSVC6 typedefs (not from speed.exe) */
/* M4.1.2: unaff_EDI+EBX → __fastcall dual (multi_dual; sync only on uplift). */
...
extern int DAT_0073d8d4;
extern void LAB_00549c81(void);

int __fastcall FUN_00549c40(int obj, char * ebx)

{
  ...
  do {
    if (*(int *)(obj + 0x68) == 0) {
      ...
      iVar1 = FUN_0064c660(*(undefined4 *)(obj + 0x6c));
    }
    if (iVar1 <= iVar4) {
      return iVar3;
    }
...
LAB_00549c81:
      ...
      iVar1 = FUN_00666f30(DAT_0073d8d4,iVar4);
      if (iVar1 == 0) goto LAB_00549c81;
      pcVar2 = (char *)(iVar1 + 0x1c);
    }
    if ((*ebx == *pcVar2) && (ebx[1] == pcVar2[1])) {
      iVar3 = iVar3 + 1;
    }
    iVar4 = iVar4 + 1;
  } while( true );
