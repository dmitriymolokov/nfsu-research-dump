/* spd-match: far pct=24.62 flags=/O2 /c /nologo /TP method=m4_14_phantom_drop source=m4_14/4.1.4/va_0053AA10 */
...
/* M4.1.4: drop phantom param_4 (phantom_drop; sync only on uplift). */
...
struct ThisCallBox {
  void FUN_0053aa10(undefined4 param_2, undefined4 param_3, undefined4 param_5, undefined4 param_6, undefined4 param_7, undefined4 param_8);
};
void ThisCallBox::FUN_0053aa10(undefined4 param_2, undefined4 param_3, undefined4 param_5, undefined4 param_6, undefined4 param_7, undefined4 param_8)

{
  ...
  *(int *)(((int)this) + 0x30) = ((int)this) + 0x548;
  *(int *)(((int)this) + 0x5f0) = ((int)this) + 0x548;
  *(int *)(((int)this) + 0x310) = ((int)this) + 0x268;
  *(int *)(((int)this) + 0x2c) = ((int)this) + 0x268;
  *(undefined4 *)(((int)this) + 0x318) = 0x437a0000;
  *(undefined4 *)(((int)this) + 0x5f8) = 0x437a0000;
  ...
  *(int **)(((int)this) + 0x34) = (int *)(((int)this) + 0x50);
  *(undefined4 *)(((int)this) + 0x314) = 1;
  *(undefined4 *)(((int)this) + 0x5f4) = 1;
  *(int **)(((int)this) + 0x38) = (int *)(((int)this) + 0x330);
  *(undefined4 *)(((int)this) + 0x2c8) = 0x437a0000;
  *(undefined4 *)(*(int *)(((int)this) + 0x30) + 0x60) = 0x437a0000;
  *(undefined4 *)(*(int *)(((int)this) + 0x2c) + 100) = 0x437a0000;
  *(undefined4 *)(*(int *)(((int)this) + 0x30) + 100) = 0x437a0000;
  (**(code **)(*(int *)(((int)this) + 0x50) + 0x2c))(param_2,param_3,3,param_5,param_6,param_7,param_8);
  (**(code **)(*(int *)(((int)this) + 0x330) + 0x2c))
            (param_7,param_8,3,unaff_ESI,unaff_EBP,unaff_EBX,unaff_retaddr);
  *(undefined4 *)(*(int *)(((int)this) + 0x2c) + 0x38) = 1;
  *(undefined4 *)(*(int *)(((int)this) + 0x2c) + 0x24) = *(undefined4 *)(((int)this) + 8);
  *(undefined4 *)(*(int *)(((int)this) + 0x30) + 0x38) = 1;
  *(undefined4 *)(*(int *)(((int)this) + 0x30) + 0x24) = *(undefined4 *)(((int)this) + 8);
  piVar1 = *(int **)(((int)this) + 0x34);
  *(undefined4 *)(((int)this) + 0x40) = 0;
  *(undefined4 *)(((int)this) + 800) = 0;
  iVar2 = DAT_007356a8;
  piVar1[0x2f] = (int)&DAT_006f4960;
  piVar1[0x81] = *(int *)(*(int *)(iVar2 + 0xa0) + 4);
  (**(code **)(*piVar1 + 0x24))();
  iVar2 = DAT_007356a8;
