/* spd-match: far pct=21.67 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_00570C20 */
...
undefined4 __fastcall FUN_00570c20(int obj, int param_1, int esi_obj)

{

  int iVar1;

  if ((*(int *)(obj + 0x280) != param_1) && (*(char *)(param_1 + 0x4d0) != '\0')) {
    iVar1 = FUN_00570b90();
    if ((iVar1 == 0) &&
       ((*(uint *)(param_1 + 0x534) & 1 << ((byte)*(undefined4 *)(esi_obj + 4) & 0x1f)) != 0)) {
      return 1;
    }
  }
  return 0;
