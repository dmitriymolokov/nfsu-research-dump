/* spd-match: far pct=22.32 flags=/O2 /c /nologo /TC method=m39 source=m39/m39/va_00538F80 */
...
int __cdecl FUN_00539560();
typedef unsigned char byte; extern int __cdecl FUN_00539560(void); int __fastcall FUN_00538f80(void *esi) { int ecx; int idx; int *ptr_d; int *base = (int*)esi; if (*(int*)(*(int*)((byte*)esi + 4) + 0x10) == 0) return 1; ecx = *(int*)((byte*)esi + 0x1c); *(int*)((byte*)esi + 0x20) = ecx; ptr_d = *(int**)((byte*)esi + ecx * 4 + 0x2c); *((byte*)esi + ecx + 0x24) = 1; if (*(int*)((byte*)ptr_d + 0x14) == 1) *((byte*)esi + ecx + 0x24) = (byte)FUN_00539560(); idx = (*(int*)((byte*)esi + 0x20) - 1) & 1; *(int*)((byte*)esi + 0x20) = idx; ptr_d = *(int**)((byte*)esi + idx * 4 + 0x2c); *((byte*)esi + idx + 0x24) = 1; if (*(int*)((byte*)ptr_d + 0x14) == 1) *((byte*)esi + idx + 0x24) = (byte)FUN_00539560(); return (*((byte*)esi + 0x24) != 0 && *((byte*)esi + 0x25) != 0); }
