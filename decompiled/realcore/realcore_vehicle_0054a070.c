/* spd-match: matched pct=100.00 flags=/O2 /c /nologo /TC method=m36_pass_b source=m36_pass_b/va_0054A070 */
...
long __fastcall FUN_0054a070(int param_1,int param_2,char param_3)

{
  long lVar1;
  
  lVar1 = -1;
  if ((*(int *)(param_2 + 0x68) != 0) && (param_1 != 0)) {
    if (param_3 == '\0') {
      lVar1 = FUN_00668b40(*(int *)0x0073DAF4,*(undefined4 *)(param_1 + 0x30),0,0);
      return lVar1;
    }
    lVar1 = _atol((char *)(param_1 + 0x28));
  }
  return lVar1;
}
