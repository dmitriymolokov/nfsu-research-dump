/* spd-match: matched pct=100.00 flags=/O2 /c /nologo /TC method=pass_a_tc source=reports/m3_needs_data_abs_pilot */
...
int __cdecl FUN_00664a40();
void FUN_0054d590(void)

{
  undefined1 *puVar1;
  
  if ((*(int *)0x00734f80) != 0) {
    FUN_00664a40((*(int *)0x00734f80));
    *(int *)0x00734f80 = 0;
  }
  *(int *)0x00734f84 = 0;
  *(int *)0x00734f88 = 0;
  ...
  *(int *)0x00734fc8 = 0;
  *(int *)0x00734fcc = 0;
  puVar1 = ((int *)0x00734f90);
  do {
    *puVar1 = 0;
    puVar1 = puVar1 + 0xd;
  } while ((int)puVar1 < 0x734fc4);
  return;
}
