/* spd-match: far pct=14.58 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_0052FB00 */
...
extern int DAT_00735630;

int __cdecl FUN_004a9900();
extern int DAT_00735630;

void __fastcall FUN_0052fb00(undefined4 val, int obj)

{
  ...
  iVar2 = DAT_00735630;
  iVar3 = 0;
  for (puVar1 = *(undefined4 **)(obj + 4);
      (puVar1 != (undefined4 *)(obj + 4) && (iVar3 = iVar3 + 1, puVar1 != (undefined4 *)0x0));
