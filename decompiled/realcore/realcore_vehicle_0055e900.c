/* spd-match: far pct=13.68 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_0055E900 */
...
int __cdecl FUN_0055ea40();
extern int DAT_0073578c;
void __cdecl FUN_0055e900(int * ctx, int val)

{
  ...
  *esi = edi;
  esi[1] = val;
  uVar1 = FUN_004fd230();
  if (((edi == 0) || (iVar2 = FUN_004f65d0(), iVar2 == 0)) ||
  ...
  esi[5] = iVar2;
  esi[4] = -1;
  esi[2] = *(unsigned int *)(iVar2 + 0x5c) / 3;
  esi[3] = (unsigned int)(*(int *)(iVar2 + 0x5c) << 1) / 3;
  FUN_0055ea40(esi);
  return;
}
