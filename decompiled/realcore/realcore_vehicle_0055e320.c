/* spd-match: far pct=6.90 flags=/O1 /c /nologo /TC method=m39 source=m39/4.1.G.45-s0/va_0055E320 */
...
int __cdecl FUN_004ab510(void); void __fastcall FUN_0055e320(int obj) { int *p1 = *(int **)(obj + 0x70); int *p2 = *(int **)((char *)p1 + 0xc); int *res = (int *)FUN_004ab510(); res[2] = (short)*(short *)((char *)p2 + 0x6c); res[3] = p1[6]; }
