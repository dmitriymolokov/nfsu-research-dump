/* spd-match: far pct=15.79 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_00549FC0 */
...
int __cdecl FUN_00549e50();
int __cdecl FUN_0054b700();
undefined4 __fastcall FUN_00549fc0(undefined4 val, undefined4 esi)

{
  ...
  iVar1 = FUN_0054b700(esi,val);
  if (iVar1 != 0) {
    iVar1 = FUN_00549e50(esi);
    if (iVar1 != 0) {
      uVar2 = FUN_004c2a50();
      return uVar2;
    }
