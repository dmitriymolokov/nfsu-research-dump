/* spd-match: far pct=14.29 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_00562920 */
...
void __fastcall FUN_00562920(undefined4 * obj)

{
  ...
  *obj = &PTR_LAB_006bc72c;
  FUN_004f84d0();
  _Memory = (int *)obj[0x10];
  while (_Memory != obj + 0x10) {
    iVar1 = *_Memory;
