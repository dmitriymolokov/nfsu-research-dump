/* spd-match: matched pct=100.00 flags=/O2 /c /nologo /TP method=m36_pass_b source=m36_pass_b/va_0057D120 */
...
struct ThisCallBox {
  int FUN_0057d120(int param_2);
};
int ThisCallBox::FUN_0057d120(int param_2) {
  if (*(int *)(((int)this) + 0xc54) == 1) {
    return ((*(int *)0x006ee6f0) != 0) + 1;
  }
  return (int)*(char *)(param_2 % (int)*(char *)(((int)this) + 0xd9) + 0xc80 + ((int)this));
}
