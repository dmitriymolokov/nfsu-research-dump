/* spd-match: far pct=15.87 flags=/O2 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.5/va_005257F0 */
...
int unaff_EDI;
int unaff_ESI;
void __fastcall FUN_005257f0(int val, int param_1, int param_2, int param_3, int param_4)

{
  ...
  *(int *)(unaff_ESI + 0x18) = param_4;
  iVar2 = FUN_0064c1a0(&DAT_0073d804,piVar1);
  if (iVar2 < 0) {
    FUN_0064c000(&PTR_s_FX_SHIFTING_01_006f2240);
    FUN_0064c1a0(&DAT_0073d804,piVar1);
  }
  return;
}
