/* spd-match: far pct=6.45 flags=/Ob2 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_0052EBE0 */
...
undefined4 __cdecl FUN_0052ebe0(int *param_1)

{
  ...
  uVar2 = 0;
  if (param_1[0x2f] != 0) {
    fVar3 = (**(float10 (**)())(*param_1 + 0x20))();
    fVar1 = (float10)((int)DAT_006cc7a4);
    uVar2 = CONCAT22(extraout_var,
                     (ushort)(fVar3 < fVar1) << 8 | (ushort)(NAN(fVar3) || NAN(fVar1)) << 10 |
                     (ushort)(fVar3 == fVar1) << 0xe);
    if (fVar3 >= fVar1) {
      fVar3 = (**(float10 (**)())(*param_1 + 0x20))();
      fVar1 = (float10)*(float *)(unsigned int)(param_1[0x2f] + 0x58);
      uVar2 = CONCAT22((short)((uint)param_1[0x2f] >> 0x10),
                       (ushort)(fVar3 < fVar1) << 8 | (ushort)(NAN(fVar3) || NAN(fVar1)) << 10 |
                       (ushort)(fVar3 == fVar1) << 0xe);
      if (fVar3 < fVar1) {
