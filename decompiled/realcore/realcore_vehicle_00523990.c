/* spd-match: far pct=13.12 flags=/O2 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_00523990 */
...
/* M4.1.3: FUN_00532640 → __stdcall (callee_stdcall). */
...
int __cdecl FUN_00529100();
int __stdcall FUN_00532640(void);
int __cdecl FUN_00532670();
int __cdecl FUN_00584310();

void __fastcall FUN_00523990(int param_1)

{
  ...
  *(undefined4 *)(param_1 + 0x1d0c) = *(undefined4 *)(param_1 + 0x1f1c);
  FUN_00529100(param_1 + 0x1d24,1,0,0x1000,*(undefined4 *)(param_1 + 0x6c));
  return;
}
