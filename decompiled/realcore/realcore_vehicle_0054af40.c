/* spd-match: far pct=33.93 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_0054AF40 */
...
int __cdecl FUN_00664c70();

void __fastcall FUN_0054af40(int obj)

{
  
  if (*(int *)(obj + 0x68) != 0) {
    if (*(int *)(obj + 0x40) != 0) {
      FUN_00664c70(*(int *)(obj + 0x68),6,*(int *)(obj + 0x40));
      *(undefined4 *)(obj + 0x40) = 0;
    }
    *(undefined4 *)(obj + 0x54) = 0xffffffff;
    *(undefined1 *)(obj + 0x58) = 0;
