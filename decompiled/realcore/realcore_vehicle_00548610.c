/* spd-match: far pct=19.35 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
extern int DAT_007354e4;

void FUN_00548610(void)

{
  FUN_005488d0(1);
  DAT_007354e4 = 0;
  FUN_0043ba60(DAT_006f3d9c,1);
  FUN_00547ae0();
  return;
}
