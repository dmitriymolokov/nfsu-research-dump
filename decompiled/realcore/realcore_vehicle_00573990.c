/* spd-match: far pct=16.67 flags=/O1 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_00573990 */
...
void __fastcall FUN_00573990(uint edi, int * obj, char param_1)

{
  ...
  iVar2 = 0;
  if (0 < *obj) {
    pcVar1 = (char *)((int)obj + 7);
    do {
      if (((byte)pcVar1[-1] == edi) && (*pcVar1 == param_1)) {
        pcVar1[-0xffffffff00000003] = '\0';
        pcVar1[-0xffffffff00000002] = '\0';
      }
      iVar2 = iVar2 + 1;
      pcVar1 = pcVar1 + 0xc;
    } while (iVar2 < *obj);
