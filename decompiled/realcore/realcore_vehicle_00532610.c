/* spd-match: far pct=24.39 flags=/O2 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_00532610 */
...
void __fastcall FUN_00532610(int obj, undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  
  FUN_00532640();
  FUN_00532670(param_1,param_2,param_3,0);
  *(undefined4 *)(obj + 0x74) = param_1;
  return;
}
