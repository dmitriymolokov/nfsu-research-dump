/* spd-match: far pct=38.27 flags=/O2 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_00532CB0 */
...
int __cdecl FUN_0064e6e0();
int __cdecl FUN_0064e7f0();
extern int DAT_006f1dd8;

void __fastcall FUN_00532cb0(undefined4 esi)
