/* spd-match: far pct=22.45 flags=/Ob2 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_00579310 */
...
int __cdecl FUN_00565060();
int __cdecl FUN_00579190();
int __cdecl FUN_005791c0();
void __fastcall FUN_00579310(int obj, undefined4 param_1)

{
  ...
  if (*(int *)(obj + 0xe0) == 0) {
    ...
    if (*(int *)(*(int *)(obj + 0xe0) + 0xe4) != 0) {
      FUN_005791c0();
    }
    FUN_00565060();
    FUN_00579310(obj + 0x50,param_1,local_50);
  }
  if (*(int *)(obj + 0xe4) == 0) {
    FUN_00579190();
  }
