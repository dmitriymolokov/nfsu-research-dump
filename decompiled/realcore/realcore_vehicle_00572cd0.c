/* spd-match: far pct=35.82 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_00572CD0 */
...
int __cdecl FUN_00572d90();
extern int DAT_006f08a4;
int __cdecl FUN_00572b50();
int __cdecl FUN_00572d90();
extern int DAT_006f08a4;
undefined4 __fastcall FUN_00572cd0(undefined4 val, int obj)

{

  int iVar1;

  iVar1 = FUN_00572b50(val,0);
  if (iVar1 != 0) {
    *(undefined4 *)(iVar1 + 0x150) = 0;
    *(undefined1 *)(iVar1 + 0x3d) = 1;
    FUN_00572d90(obj);
    *(undefined1 *)(iVar1 + 0x3d) = 0;
    *(undefined4 *)(obj + 0xa4) = DAT_006f08a4;
    *(undefined4 *)(obj + 8) = 0;
    return 1;
  }
  return 0;
