/* spd-match: far pct=8.82 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_0052FB30 */
...
undefined4 __fastcall FUN_0052fb30(undefined4 * obj, int edi)
