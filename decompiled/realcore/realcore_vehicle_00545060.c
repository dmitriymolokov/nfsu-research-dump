/* spd-match: far pct=18.92 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_00545060 */
...
int __cdecl FUN_00540c20();

void __fastcall FUN_00545060(int * obj)
