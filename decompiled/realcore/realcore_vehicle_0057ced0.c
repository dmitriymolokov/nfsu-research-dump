/* spd-match: far pct=21.05 flags=/O1 /c /nologo /TP method=m39 source=m39/4.1.4/va_0057CED0 */
...
uint __fastcall FUN_0057ce10(undefined4 *obj, int param_1, int param_2, int param_3, uint param_4, uint param_5);
extern int DAT_00734588;

struct ThisCallBox {
  undefined4 FUN_0057ced0(undefined4 param_2, undefined4 param_3, undefined4 param_4, undefined4 param_5, undefined4 param_6);
};
undefined4 ThisCallBox::FUN_0057ced0(undefined4 param_2, undefined4 param_3, undefined4 param_4, undefined4 param_5, undefined4 param_6) {
  undefined4 uVar1;
  int ecx_val;

  uVar1 = 0;
  if (((int)this) != 0x23) {
    ecx_val = ((int)this) * 0xc90 + DAT_00734588;
    if (ecx_val == 0) {
      return 0;
    }
    uVar1 = FUN_00567c70(ecx_val, (byte *)(ecx_val + 0x20));
  }
  uVar1 = FUN_0057ce10((undefined4 *)uVar1, (int)param_3, (int)param_4, (int)param_5, (uint)param_6, 0xffffffff);
  return uVar1;
}
