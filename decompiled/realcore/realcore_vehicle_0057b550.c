/* spd-match: far pct=19.23 flags=/O1 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_0057B550 */
...
int __fastcall FUN_0057b550(int edi, int obj)

{
  ...
  if (0 < *(int *)(obj + 4)) {
    piVar2 = (int *)(obj + 0x3c);
    do {
      if (*(int *)(*piVar2 + 0x1d4) == edi) {
        if (iVar1 == -1) {
          return 0;
        }
        return iVar1 * 0x38 + 8 + obj;
      }
      iVar1 = iVar1 + 1;
      piVar2 = piVar2 + 0xe;
    } while (iVar1 < *(int *)(obj + 4));
  }
  return 0;
}
