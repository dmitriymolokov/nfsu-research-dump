/* spd-match: far pct=18.92 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_005462A0 */
...
int __cdecl FUN_00545cc0();

void __fastcall FUN_005462a0(int * obj)
