/* spd-match: far pct=10.71 flags=/O1 /c /nologo /TC method=m4_11_r2_edi_stack source=m4_11/4.1.1.r2/va_0057CCB0 */
...
int __fastcall FUN_0057ccb0(undefined4 * obj, int param_1, int param_2, int edi)

{
  ...
  do {
    ...
    for (; uVar3 < uVar4; uVar3 = uVar3 + 0x30) {
      iVar5 = iVar5 + 1;
      if ((((edi == 0) || (*(int *)(uVar3 + 4) == edi)) &&
          ((param_1 == -1 || (*(char *)(uVar3 + 0x10) == param_1)))) &&
         ((param_2 == 0 || (*(int *)(uVar3 + 8) == param_2)))) {
        return iVar5;
      }
    }
