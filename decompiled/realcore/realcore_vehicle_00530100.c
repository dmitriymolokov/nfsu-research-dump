/* spd-match: far pct=18.09 flags=/O2 /Gr /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_00530100 */
...
int __cdecl FUN_0052f520();
int __cdecl FUN_0052f570();
int __cdecl FUN_0052f6f0();
int __cdecl FUN_00532370();
extern int DAT_006f1dd8;
extern int DAT_006f47a0;
extern int DAT_006f4810;
extern unsigned char *DAT_00735618;
extern int DAT_0073561c;
extern unsigned char *DAT_007356a8;
extern void LAB_00530189(void);
extern void LAB_005301e5(void);
extern void LAB_005301ec(void);

void __fastcall FUN_00530100(int param_2, int param_3)

{
  ...
  if (iVar3 == 0) {
LAB_00530189:
    pvVar4 = _malloc(0x360);
    if (pvVar4 == (void *)0x0) {
LAB_005301e5:
      piVar5 = (int *)0x0;
    }
    else {
      piVar5 = (int *)FUN_0052f570();
    }
  }
  else {
    if (iVar3 != 1) {
      if (iVar3 == 2) {
        pvVar4 = _malloc(0x370);
        if (pvVar4 == (void *)0x0) {
          piVar5 = (int *)0x0;
          puVar7 = &DAT_006f4810;
        }
        else {
          piVar5 = (int *)FUN_00532370();
          puVar7 = &DAT_006f4810;
        }
        goto LAB_005301ec;
      }
    ...
    pvVar4 = _malloc(0x370);
    if (pvVar4 == (void *)0x0) goto LAB_005301e5;
    piVar5 = (int *)FUN_0052f520();
  }
  puVar7 = &DAT_006f47a0;
LAB_005301ec:
  (**(code **)(*piVar5 + 0x10))(puVar7);
  (**(code **)(*piVar5 + 0x24))();
  piVar5[0x87] = param_3;
  ...
  *(int **)(param_2 + 0x28) = piVar1;
  piVar5[0x85] = (int)piVar2;
  iVar3 = DAT_0073561c;
  *piVar1 = param_2 + 0x24;
  DAT_00735618 = DAT_00735618 + 1;
  if (iVar3 < DAT_00735618) {
    DAT_0073561c = DAT_00735618;
  }
  return;
}
