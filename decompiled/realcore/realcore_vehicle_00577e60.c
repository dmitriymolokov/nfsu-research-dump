/* spd-match: far pct=26.76 flags=/O2 /c /nologo /TP method=m39 source=m39/4.1.6-control100/va_00577E60 */
...
extern void LAB_00577e96(...);

struct ThisCallBox {
  undefined4 * FUN_00577e60(undefined4 *param_2);
};
typedef struct Node { struct Node* next; int padding[10]; struct Node* child; } Node; extern Node* __stdcall FUN_00577e60(Node* pNode, Node* pBase); Node* __stdcall FUN_00577e60(Node* pNode, Node* pBase) { Node* esi = pNode ? pNode : (Node*)((char*)pBase + 0x20); Node* edi = (Node*)((char*)pBase + 0x20); while (esi != edi) { Node* ecx = esi->child; if (ecx == (Node*)&esi->child) { if (FUN_00577e60(0, esi)) return (Node*)((char*)esi->child - 4); } else if (ecx) { return (Node*)((char*)ecx - 4); } esi = esi->next; } return 0; }
