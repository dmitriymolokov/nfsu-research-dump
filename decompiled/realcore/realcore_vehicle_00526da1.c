/* spd-match: far pct=13.33 flags=/Ob2 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_00526DA1 */
...
int __cdecl FUN_00536ee8();

void __fastcall FUN_00526da1(undefined4 param_2)

{
  FUN_00536ee8(param_2);
  return;
}
