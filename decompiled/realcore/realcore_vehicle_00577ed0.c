/* spd-match: far pct=15.38 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_00577ED0 */
...
int __fastcall FUN_00577ed0(undefined4 val, int esi)

{
  ...
  uVar3 = FUN_00577e60(val);
  iVar2 = (int)((ulonglong)uVar3 >> 0x20);
  iVar1 = (int)uVar3;
  if (iVar1 == 0) {
    while (iVar2 != esi) {
      uVar3 = FUN_00577e60(iVar2);
      iVar2 = (int)((ulonglong)uVar3 >> 0x20);
      if ((int)uVar3 != 0) {
        return (int)uVar3;
      }
