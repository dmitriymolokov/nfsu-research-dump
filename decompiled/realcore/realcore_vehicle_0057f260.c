/* spd-match: far pct=18.31 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_0057F260 */
...
extern int _DAT_006f0d58;
extern int _DAT_006f0d5c;
float10 __cdecl FUN_0057f260(int obj, char param_1)

{
  ...
  if (param_1 != '\0') {
    return (((float10)*(float *)(obj + 0x428) - (float10)_DAT_006f0d58) * (float10)_DAT_006cca94)
           / ((float10)_DAT_006f0d5c - (float10)_DAT_006f0d58);
  }
  return (float10)*(float *)(obj + 0x428);
}
