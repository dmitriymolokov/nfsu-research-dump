/* spd-match: far pct=16.06 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall_v2 source=m4_13/4.1.3/va_00528B60 */
...
/* M4.1.3-R3: FUN_00528830 → unified __stdcall (callee_stdcall_v2). */
...
int __cdecl FUN_00528470();
int __cdecl FUN_00528610();
int __cdecl FUN_00528650();
int __stdcall FUN_00528830(undefined4 a1);
extern int _DAT_006cc960;
extern int _DAT_006f80ec;
int __cdecl FUN_00528470();
int __cdecl FUN_00528610();
int __cdecl FUN_00528650();
int __stdcall FUN_00528830(undefined4 a1);
...
void __fastcall FUN_00528b60(int *param_1)

{
  ...
  if (((param_1[0x49d] != 0) && (cVar2 = (**(code **)(*param_1 + 0x60))(1), cVar2 != '\0')) &&
     (*(char *)(param_1[0x49d] + 0xc) != '\0')) {
    FUN_00528650(unaff_retaddr);
    FUN_00528830(unaff_retaddr);
    iVar1 = param_1[0x4a9];
    if (iVar1 == 0) {
      if (_DAT_006f80ec < (float)param_1[0x7e3]) {
        param_1[0x4a9] = 1;
      }
    }
    else if (iVar1 == 1) {
      if (_DAT_006cc960 < (float)param_1[0x4a2]) {
        param_1[0x4a9] = 2;
        FUN_00528470(param_1[0x49d],0,0,0xfff,param_1[0x1b],param_1[0xab]);
        *(undefined4 *)(param_1[0x49d] + 0x2c0) = 0;
        FUN_00528830(unaff_retaddr);
        return;
      }
    }
    else if ((iVar1 == 2) && (cVar2 = FUN_00528610(), cVar2 != '\0')) {
      param_1[0x4a9] = 0;
      return;
    }
  }
