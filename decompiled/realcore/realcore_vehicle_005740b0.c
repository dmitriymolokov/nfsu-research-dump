/* spd-match: far pct=12.12 flags=/O2 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_005740B0 */
...
int __cdecl FUN_00573990();
extern unsigned char *DAT_007345cc;
extern unsigned char *DAT_0073b260;
int __cdecl FUN_0040a880();
int __cdecl FUN_00573990();
extern unsigned char *DAT_007345cc;
extern unsigned char *DAT_0073b260;
void __cdecl FUN_005740b0(int val, int param_1)

{
  ...
  FUN_00573990(param_1);
  piVar4 = *(int **)(&DAT_0073b260 + val * 0x18c);
  ...
  if (piVar4 != piVar3) {
    ...
    *(int **)(iVar1 + 4) = piVar3;
    iVar2 = DAT_007345cc;
    iVar1 = *(int *)(DAT_007345cc + 0x18);
    *piVar4 = *(int *)(DAT_007345cc + 0x10);
