/* spd-match: far pct=20.75 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_0057A8A0 */
...
undefined1 __fastcall FUN_0057a8a0(int obj)

{
  ...
  iVar2 = FUN_00647b70();
  if ((iVar2 == 6) && (*(int *)(*(int *)(obj + 0x1d4) + 0x90) != 0)) {
    uVar1 = FUN_004280a0();
    return uVar1;
  }
  piVar3 = (int *)FUN_00438ac0();
