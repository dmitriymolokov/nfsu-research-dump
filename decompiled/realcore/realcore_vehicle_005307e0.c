/* spd-match: far pct=16.67 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_005307E0 */
...
int __cdecl FUN_00532640();
int __cdecl FUN_00532670();
void __cdecl FUN_005307e0(int obj)

{

  if (*(char *)(obj + 0x351) == '\0') {
    *(undefined1 *)(obj + 0x351) = 1;
    *(undefined4 *)(obj + 0x21c) = 0;
    if (*(char *)(obj + 0x350) != '\0') {
      *(undefined1 *)(obj + 0x2f4) = 1;
      FUN_00532640();
      FUN_00532670(0x3f800000,0,0x85,0);
      *(undefined4 *)(obj + 0x2c4) = 0x3f800000;
    }
  }
  return;
}
