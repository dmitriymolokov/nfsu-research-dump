/* spd-match: far pct=18.92 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_0057B590 */
...
int __cdecl FUN_0057a4f0();

void __fastcall FUN_0057b590(int * obj)
