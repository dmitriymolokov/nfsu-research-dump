/* spd-match: far pct=21.62 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_00577F00 */
...
int __cdecl FUN_00577810();

void __fastcall FUN_00577f00(int * obj)
