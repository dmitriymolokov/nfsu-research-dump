/* spd-match: close pct=80.77 flags=/O1 /c /nologo /TC method=m4_13_fc_wrapper_thiscall source=m4_13/4.1.3/va_005234A0 */
...
/* M4.1.3: FUN_00526880 → __stdcall (callee_stdcall). */
...
int __stdcall FUN_00526880(void);

void __fastcall FUN_005234a0(int head)

{
  FUN_00526880();
  if (*(undefined4 **)(head + 0x1fa0) != (undefined4 *)0x0) {
    (**(code **)**(undefined4 **)(head + 0x1fa0))(1);
  }
  return;
}
