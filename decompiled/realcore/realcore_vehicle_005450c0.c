/* spd-match: far pct=18.92 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_005450C0 */
...
int __cdecl FUN_004ad8a0();

void __fastcall FUN_005450c0(int * obj)
