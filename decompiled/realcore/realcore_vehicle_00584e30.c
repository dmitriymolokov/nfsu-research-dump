/* spd-match: far pct=7.62 flags=/O1 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.5/va_00584E30 */
/* M3.9.26.5: Ghidra EAX local → __fastcall typed arg (build strip; % may drop). */
#include "ghidra_compat.h"

extern int _DAT_006b5b4c;
extern int _DAT_006b5b50;
void __fastcall FUN_00584e30(float * obj, int param_1, float *param_2)

{
  ...
  local_20 = *obj;
  local_18 = obj[2];
  fVar1 = SQRT(local_20 * local_20 + local_18 * local_18 + local_1c * local_1c);
  ...
  *(float *)(param_1 + 0x80) = fVar1 + *(float *)(param_1 + 0x80);
  *(float *)(param_1 + 0x84) = fVar3 + *(float *)(param_1 + 0x84);
  *(float *)(param_1 + 0x88) = local_18 + *(float *)(param_1 + 0x88);
  return;
}
