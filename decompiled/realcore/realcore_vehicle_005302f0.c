/* spd-match: far pct=16.18 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_005302F0 */
...
int __cdecl FUN_005307e0();
extern int DAT_006f1dd8;

void __fastcall FUN_005302f0(undefined4 param_1,int param_2, int esi)

{
  ...
  if (DAT_006f1dd8 != 0) {
    ...
    while( true ) {
      ...
      if (*(int *)(iVar1 + 0x21c) == esi) {
        FUN_005307e0();
        return;
      }
      iVar1 = *(int *)(iVar1 + 0x210);
    }
  }
  return;
}
