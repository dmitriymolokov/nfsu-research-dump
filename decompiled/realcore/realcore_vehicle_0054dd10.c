/* spd-match: far pct=3.33 flags=/O1 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_0054DD10 */
...
extern unsigned char *DAT_00734f90;
void __fastcall FUN_0054dd10(int val, char *param_2)
