/* spd-match: far pct=6.58 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_00576F30 */
...
int __cdecl FUN_00472aa0();
int __cdecl FUN_004733a0();
void __cdecl FUN_00576f30(int obj, undefined4 *param_1, undefined4 *param_2)
