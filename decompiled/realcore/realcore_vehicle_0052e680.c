/* spd-match: close pct=98.46 flags=/O2 /c /nologo /TC method=m4_13_callee_stdcall_v2 source=m4_13/4.1.3/va_0052E680 */
...
/* M4.1.3-R3: FUN_0052e6d0 → unified __stdcall (callee_stdcall_v2). */
...
int __stdcall FUN_0052e6d0(undefined4 a1);
void __fastcall FUN_0052e680(int obj)

{

  if (*(int *)(*(int *)(obj + 0x204) + 0x168 + *(int *)(obj + 0xcc) * 4) != 0) {
    FUN_0052e6d0(*(int *)(obj + 0xcc));
  }
  if (*(int *)(*(int *)(obj + 0x204) + 0x188) == 1) {
    FUN_0052e6d0(*(int *)(obj + 0xcc) - 1U & 1);
  }
  return;
}
