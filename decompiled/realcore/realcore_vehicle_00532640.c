/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m3_bad_signature_fastcall */
...
void __fastcall FUN_00532640(undefined4 param_1,undefined4 *param_2)

{
  ...
  *param_2 = 0;
  ...
  do {
    ...
    *puVar1 = 0;
    puVar1[-0xc] = 0;
    *(undefined1 *)((int)param_2 + iVar2 + 0x4c) = 0;
    puVar1[8] = 0;
    iVar2 = iVar2 + 1;
    puVar1 = puVar1 + 1;
  } while (iVar2 < 6);
