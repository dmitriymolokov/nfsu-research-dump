/* spd-match: far pct=16.44 flags=/O1 /c /nologo /TC method=m39 source=m39/4.1.G.45-s0/va_00549E50 */
...
/* M4.1.5: primary __fastcall → __cdecl (cc_flip_to_cdecl). */
...
int __cdecl FUN_00549ed0();
extern int DAT_00734588;
typedef unsigned int uint; typedef unsigned char byte; int __cdecl FUN_00417600(void*); int __cdecl FUN_00549ed0(int, void*); extern int DAT_00734588; int __cdecl FUN_00549e50(int val, int param_1) { char local_730[1836]; if (val != 0) { FUN_00417600(local_730); if (FUN_00549ed0(param_1, local_730) != 0) { return *(int*)local_730 * 0xc90 + DAT_00734588; } } return 0; }
