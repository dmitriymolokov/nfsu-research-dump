/* spd-match: far pct=20.83 flags=/Ob2 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_00550BA0 */
...
int __cdecl FUN_004f9ed0();
extern int DAT_0073578c;
int __cdecl FUN_004f5ed0();
int __cdecl FUN_004f9ed0();
extern int DAT_0073578c;
void __cdecl FUN_00550ba0(int obj)

{

  FUN_004f9ed0();
  if ((**(int **)(obj + 0x38 + *(int *)(obj + 0x24) * 4) != 0) && (DAT_0073578c != 0)) {
