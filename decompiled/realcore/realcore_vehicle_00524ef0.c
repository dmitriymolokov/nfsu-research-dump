/* spd-match: far pct=27.45 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_00524EF0 */
...
int __cdecl FUN_00532640();
int __cdecl FUN_00532670();
void __cdecl FUN_00524ef0(int obj)

{
  ...
  *(undefined4 *)(obj + 0x2ec) = 0x3f800000;
  return;
}
