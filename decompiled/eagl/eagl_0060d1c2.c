/* spd-match: far pct=43.90 flags=/O1 /Gr /c /nologo /TC method=m4_13_callee_stdcall_v2 source=m4_13/4.1.3/va_0060D1C2 */
...
/* M4.1.3-R3: FUN_0061a3fb → unified __stdcall (callee_stdcall_v2). */
...
int __stdcall FUN_0061a3fb(undefined4 a1, undefined4 a2, undefined4 a3, undefined4 a4, undefined4 a5, undefined4 a6, undefined4 a7, undefined4 a8, undefined4 a9, undefined4 a10);
void __fastcall FUN_0060d1c2(int *param_1)

{
  ...
  iVar3 = (**(code **)(*param_1 + 0x6c))(param_1[0x25],local_30,4,0,0);
  if (-1 < iVar3) {
    local_8 = 0;
    do {
      local_50[local_8] = param_1[0x4d];
      local_40[local_8] = param_1[0x4e];
      if (local_8 < local_c) {
        local_20[local_8] =
             local_30[*(int *)(*(int *)(param_1[5] + *(int *)(local_8 * 4 + local_10) * 4) + 0xc)];
      }
      local_8 = local_8 + 1;
    } while (local_8 < 4);
    FUN_0061a3fb(2,local_20,local_c,uVar2,uVar2 + uVar4 * 4,0,uVar4,0,0x1000000,0);
    FUN_0061a3fb(0x58,local_10,local_c,local_20,local_50,local_40,uVar4,0,0,0);
  }
  return;
}
