/* spd-match: far pct=15.85 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_c2120 */
...
undefined4 FUN_0063a510(char *param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  iVar2 = FUN_0063a310(7,param_2,param_3,uVar3);
  if (param_1 == (char *)0x0) {
    param_1 = "";
  }
  pcVar4 = param_1;
