/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=m36_pass_b source=m36_pass_b/va_00634150 */
...
undefined4 * FUN_00634150(int param_1)

{
  return (undefined4 *)0x0070d638 + param_1 * 3;
}
