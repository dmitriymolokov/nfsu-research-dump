/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=m4_13_fc_wrapper_thiscall source=m4_13/4.1.3/va_0061B20C */
...
int __stdcall FUN_0061af1a(void);

void __fastcall FUN_0061b20c(int head)

{
  int iVar1;
  
  iVar1 = *(int *)(head + 0x98);
  FUN_0061af1a(0xe,*(undefined4 *)(iVar1 + 0x10),*(undefined4 *)(iVar1 + 8),
               *(undefined4 *)(iVar1 + 0xc),*(undefined4 *)(iVar1 + 4),0,0);
  return;
}
