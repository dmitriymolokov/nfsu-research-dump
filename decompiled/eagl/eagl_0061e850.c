/* spd-match: far pct=15.17 flags=/O2 /Gr /c /nologo /TC method=m4_13_callee_stdcall_v2 source=m4_13/4.1.3/va_0061E850 */
...
/* M4.1.3-R3: FUN_0061e4d0 → unified __stdcall (callee_stdcall_v2). */
...
int __stdcall FUN_0061e4d0(void *a1, undefined4 a2);
...
void __fastcall FUN_0061e850(int *param_1)

{
  ...
  if (0 < local_14) {
    do {
      FUN_0061e4d0(&local_10,iVar4);
      if ((local_4 != '\0') && (iVar1 = FUN_0061f570(local_c), iVar1 != 0)) {
        iVar6 = iVar6 + 1;
      }
      iVar4 = iVar4 + 1;
    } while (iVar4 < local_14);
    if (0 < iVar6) {
      iVar4 = (*(code *)PTR_FUN_006dfa9c)(iVar6 * 8,"EAGL::dynamic destructor list");
      param_1[2] = iVar4;
      iVar4 = 0;
      iStack_18 = 0;
      do {
        FUN_0061e4d0(&local_10,iStack_18);
        if (local_4 != '\0') {
          iVar6 = 0xd;
          bVar8 = true;
          pcVar5 = "RenderMethod";
          ...
          if ((bVar8) && (pcVar2 = (code *)FUN_0061f570(local_c), pcVar2 != (code *)0x0)) {
            uVar3 = FUN_0061f590(local_c);
            (*pcVar2)(uStack_8,param_1,local_10);
            *(undefined4 *)(param_1[2] + iVar4 * 8) = uVar3;
            *(undefined4 *)(param_1[2] + 4 + iVar4 * 8) = uStack_8;
            iVar4 = iVar4 + 1;
          }
        }
        iStack_18 = iStack_18 + 1;
      } while (iStack_18 < local_14);
      iStack_18 = 0;
      do {
        FUN_0061e4d0(&local_10,iStack_18);
        if (local_4 != '\0') {
