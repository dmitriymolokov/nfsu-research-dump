/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=m36_pass_b source=m36_pass_b/va_0061B22A */
...
int __stdcall FUN_0061af1a(int,undefined4,int*,int*,uint,uint,undefined4);

void __fastcall FUN_0061b22a(int param_1)

{
  int iVar1;
  
  iVar1 = *(int *)(param_1 + 0x98);
  FUN_0061af1a(0xf,*(undefined4 *)(iVar1 + 0x10),*(undefined4 *)(iVar1 + 8),
