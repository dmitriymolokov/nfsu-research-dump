/* spd-match: far pct=60.53 flags=/O1 /c /nologo /TP method=m4_14_eagl_fastcall_base source=m4_14/4.1.4/va_00626CA0 */
...
/* M4.1.4: FUN_00628ed0 → __fastcall base (eagl_fastcall_base). */
...
int __fastcall FUN_00628ed0(undefined4 *param_1);
extern void *PTR_FUN_006a7a98;
...
struct ThisCallBox {
  undefined4 * FUN_00626ca0(byte param_2);
};
undefined4 * ThisCallBox::FUN_00626ca0(byte param_2) {
  *((undefined4 *)this) = (unsigned int)&PTR_FUN_006a7a98;
  FUN_00628ed0((undefined4 *)this);
  if ((param_2 & 1) != 0) {
    (*(int (__cdecl *)(...))PTR_FUN_006dfaa0)(((undefined4 *)this),0x14);
  }
