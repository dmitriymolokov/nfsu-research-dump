/* spd-match: far pct=42.59 flags=/O1 /c /nologo /TC method=m4_13_fc_wrapper_thiscall source=m4_13/4.1.3/va_0061B3B4 */
...
/* M4.1.3: FUN_0061af1a → __stdcall (callee_stdcall). */
...
int __stdcall FUN_0061af1a(int a1, int a2, int a3, int a4, int a5, int a6, int a7);

void __fastcall FUN_0061b3b4(int head)

{
  uint *puVar1;
  undefined4 uVar2;
  
  puVar1 = *(uint **)(head + 0x98);
  if ((*puVar1 & 0xff000000) == 0xf4000000) {
    uVar2 = 0x1000000;
  }
  else {
    uVar2 = 0;
  }
  FUN_0061af1a(7,puVar1[4],puVar1[2],puVar1[3],puVar1[1],uVar2,0);
  return;
}
