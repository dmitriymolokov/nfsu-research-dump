/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=m39 source=m39/m39/va_0061F5E0 */
...
typedef unsigned char byte; typedef struct { char reserved[0x28]; byte data; } *S_ptr; byte __fastcall FUN_0061f5e0(void **ecx) { byte *p = (byte *)(*ecx); return p[0x28]; }
