/* spd-match: matched pct=100.00 flags=/O2 /c /nologo /TC method=m36_pass_b source=m36_pass_b/va_0063C4A0 */
...
void fn_0063c4a0(undefined4 param_1)

{
  fn_0063c420(param_1, *(int *)0x006e761c);
  return;
}
