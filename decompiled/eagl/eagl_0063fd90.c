/* spd-match: far pct=57.14 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
extern unsigned char *_DAT_0070fdb8;

void FUN_0063fd90(void)

{
  _DAT_0070fdb8 = _DAT_0070fdb8 + 1;
  return;
}
