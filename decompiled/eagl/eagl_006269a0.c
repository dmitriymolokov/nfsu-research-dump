/* spd-match: far pct=46.88 flags=/O2 /c /nologo /TP method=m39 source=m39/4.1.4/va_006269A0 */
...
int __cdecl FUN_006268d0(...);

struct ThisCallBox {
  void FUN_006268d0(undefined4 param_1);
  void FUN_006269a0(undefined4 *param_2, undefined4 param_3);
};

struct EaglObject {
  undefined4 padding[5];
  undefined4 **ppData; // 0x14
  undefined4 padding2[2];
  int index;           // 0x20
};

void ThisCallBox::FUN_006269a0(undefined4 *param_2, undefined4 param_3) {
  EaglObject *obj = (EaglObject *)this;
  *param_2 = obj->ppData[obj->index][2];
  this->FUN_006268d0(param_3);
}
