/* spd-match: matched pct=100.00 flags=/O2 /c /nologo /TP method=m36_pass_b source=m36_pass_b/va_00620D60 */
...
void __fastcall FUN_006203e0(void *self);

struct ThisCallBox {
  undefined4 FUN_00620d60(byte param_2);
};
undefined4 ThisCallBox::FUN_00620d60(byte param_2) {
  FUN_006203e0((void *)((int)this));
  if ((param_2 & 1) != 0) {
    (*(void (__cdecl **)(void *, uint))0x006dfaa0)((void *)((int)this), 0x100);
  }
