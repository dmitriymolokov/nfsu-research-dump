/* spd-match: far pct=25.00 flags=/O1 method=thiscall_tp source=m375_sync_decomp:m375_inventory */
...
struct ThisCallBox {
  undefined4 FUN_00627ea0(int param_2);
};
undefined4 ThisCallBox::FUN_00627ea0(int param_2) {
  return CONCAT31((int3)(param_2 >> 0xd),
                  (*(uint *)(((int)this) + (param_2 >> 5) * 4) & 1 << ((byte)param_2 & 0x1f)) != 0);
}
