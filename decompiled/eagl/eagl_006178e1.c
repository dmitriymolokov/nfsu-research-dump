/* spd-match: far pct=66.67 flags=/O1 /c /nologo /TC method=m4_13_fc_wrapper_thiscall source=m4_13/4.1.3/va_006178E1 */
...
/* M4.1.3: FUN_0061742a → __stdcall (callee_stdcall). */
...
int __stdcall FUN_0061742a(void);

void __fastcall FUN_006178e1(int head)

{
  *(undefined4 *)(head + 0xf0) = 0;
  FUN_0061742a(0x80000,0xe0000,*(undefined4 *)(*(int *)(head + 0x98) + 8),0x80000,0);
  return;
}
