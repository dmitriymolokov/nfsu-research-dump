/* spd-match: matched pct=100.00 flags=/O2 /c /nologo /TP method=m39 source=m39/4.1.4/va_00626E10 */
...
void __fastcall FUN_00629280(undefined4 *param_1);

struct ThisCallBox {
  undefined4 FUN_00626e10(byte param_2);
};
undefined4 ThisCallBox::FUN_00626e10(byte param_2) {
  FUN_00629280((undefined4 *)this);
  if ((param_2 & 1) != 0) {
    (*(void (__cdecl **)(void *, unsigned int))0x006dfaa0)((void *)this, 0x20);
  }
