/* spd-match: far pct=23.53 flags=/O1 method=thiscall_tp source=m375_sync_decomp:m375_inventory */
...
struct ThisCallBox {
  undefined4 FUN_0061f780(undefined4 *param_2);
};
undefined4 ThisCallBox::FUN_0061f780(undefined4 *param_2) {
  int iVar1;
  
  iVar1 = *(int *)(((int)this) + 0xc);
  *param_2 = *(undefined4 *)(iVar1 + 0x44);
