/* spd-match: matched pct=100.00 flags=/O2 /c /nologo /TC method=m36_pass_b source=m36_pass_b/va_00634160 */
...
int __stdcall FUN_005ac68f(undefined4 p1, undefined4 p2, undefined4 p3);

void FUN_00634160(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  FUN_005ac68f(param_1,param_3,param_2);
  return;
}
