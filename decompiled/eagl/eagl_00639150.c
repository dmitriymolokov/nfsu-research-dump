/* spd-match: far pct=22.95 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_00639150 */
...
undefined4 __fastcall FUN_00639150(int obj)

{
  int iVar1;

  iVar1 = (*(uint *)(obj + 4) & 0x1f) * 0xac + DAT_0070f36c;
  if (iVar1 == 0) {
    FUN_00642450("FILE_queueop - ATTEMPT TO QUEUE FILEOP ON NON-EXISTANT DEVICE.\n");
  }
  FUN_00641e00(iVar1 + 0x14);
  FUN_00641a90(iVar1 + 0x7c);
