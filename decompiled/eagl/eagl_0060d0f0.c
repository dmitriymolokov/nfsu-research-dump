/* spd-match: far pct=43.90 flags=/O1 /Gr /c /nologo /TC method=m4_13_callee_stdcall_v2 source=m4_13/4.1.3/va_0060D0F0 */
...
void __fastcall FUN_0060d0f0(int *param_1)

{
  ...
  if (-1 < iVar3) {
    local_8 = 0;
    do {
      local_40[local_8] = param_1[0x4d];
      local_50[local_8] = param_1[0x4e];
      if (local_8 < local_c) {
        local_20[local_8] =
