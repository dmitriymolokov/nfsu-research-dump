/* spd-match: far pct=32.00 flags=/O1 /c /nologo /TC method=m4_13_fc_wrapper_thiscall source=m4_13/4.1.3/va_006353D0 */
...
/* M4.1.3: FUN_00628eb0 → __stdcall (callee_stdcall). */
...
int __stdcall FUN_00628eb0(int arg);

undefined4 * __fastcall FUN_006353d0(undefined4 *head)

{
  FUN_00628eb0(head);
  *head = (undefined4 *)0x006a8590;
  head[2] = 0x17;
  return head;
}
