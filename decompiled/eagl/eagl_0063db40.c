/* spd-match: far pct=67.19 flags=/O2 /c /nologo /TC method=m39 source=m39/4.1.2/va_0063DB40 */
...
unsigned char FUN_0063db40(uint param_1)

{
  ...
  base = DAT_0070f48c;
  idx = ~param_1;
  if (((base != 0) && ((int)idx >= 0)) && ((int)idx < DAT_0070f488)) {
    pcVar1 = (char *)(base + idx * 0x24);
    if (*pcVar1 != '\0') {
      return (unsigned char)(*(int *)(pcVar1 + 4) == -1);
    }
  }
  SetLastError(6);
  return 0;
