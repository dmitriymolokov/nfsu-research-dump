/* spd-match: far pct=18.82 flags=/O1 /c /nologo /TC method=m39 source=m39/m39/va_0061A69C */
...
/* M4.1.3: FUN_005f7a5c → __stdcall (callee_stdcall). */
...
int __stdcall FUN_005f7a5c(int a, int b);
int __cdecl FUN_0061a3fb();
typedef unsigned int uint; struct Context { char pad0[144]; uint *ptr; }; int __stdcall FUN_005f7a5c(int, int *); int __cdecl FUN_0061a3fb(int, ...); void __fastcall FUN_0061a69c(struct Context *ctx) { uint *p = ctx->ptr; uint var0 = p[0]; uint var1 = p[3]; uint var2 = p[4]; int l1, l2; FUN_005f7a5c(0, &l1); FUN_005f7a5c(1, &l2); FUN_0061a3fb(0x42, var2, var1, l2, l1, 0, var0 & 0xffffff, 0, 0, 0); }
