...
extern void *PTR_FUN_006a5ba8;

struct ThisCallBox {
  undefined4 * FUN_0060ec76(byte param_2);
};
undefined4 * ThisCallBox::FUN_0060ec76(byte param_2) {
  *((undefined4 *)this) = (unsigned int)&PTR_FUN_006a5ba8;
  FUN_00613825();
  if ((param_2 & 1) != 0) {
