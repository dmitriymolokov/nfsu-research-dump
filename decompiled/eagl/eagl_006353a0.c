/* spd-match: far pct=21.21 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
int __cdecl FUN_00635360();

undefined4 FUN_006353a0(undefined2 param_1,undefined4 *param_2)

{
  undefined4 uVar1;
  int iVar2;
  
  iVar2 = FUN_00635360(param_1);
  if (iVar2 != 0) {
