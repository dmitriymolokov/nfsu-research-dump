/* spd-match: far pct=19.40 flags=/O1 /c /nologo /TP method=m4_14_eagl_fastcall_base source=m4_14/4.1.4/va_0061EEE0 */
...
/* M4.1.4: FUN_0061e010 → __fastcall base (eagl_fastcall_base). */
...
int __fastcall FUN_0061e010(undefined4 *param_1);
int __cdecl FUN_0061ea00(...);

struct ThisCallBox {
  undefined4 * FUN_0061eee0(undefined4 param_2, undefined4 param_3, undefined4 param_4);
};
undefined4 * ThisCallBox::FUN_0061eee0(undefined4 param_2, undefined4 param_3, undefined4 param_4) {
