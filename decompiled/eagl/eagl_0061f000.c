/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=m36_pass_b source=m36_pass_b/va_0061F000 */
...
void __stdcall FUN_0061f000(undefined4 param_1)

{
  *(int *)0x007096a4 = param_1;
  *(int *)0x007096ac = param_1;
  return;
}
