/* spd-match: far pct=8.65 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_004834E0 */
...
int __cdecl FUN_004835a0();
extern unsigned char *DAT_00740460;
extern int DAT_007404a0;
extern unsigned char *PTR_LAB_006c7c50;
...
void __fastcall FUN_004834e0(int val, undefined4 param_1, undefined4 param_2, undefined4 * obj)

{
  int iVar1;

  *obj = &PTR_LAB_006c7c50;
  obj[4] = val;
  obj[5] = 0;
  obj[3] = param_2;
  obj[8] = 0;
  ...
  obj[6] = &DAT_00740460 + val * 0x18;
  iVar1 = (&DAT_007404a0)[val * 0x18];
  obj[7] = iVar1;
  *(undefined4 *)(iVar1 + 0xc0) = 0x461c4000;
  obj[9] = *(undefined4 *)(obj[7] + 0x280);
  obj[10] = *(undefined4 *)(obj[7] + 0x284);
  FUN_004835a0();
  return;
}
