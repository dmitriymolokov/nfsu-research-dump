/* spd-match: far pct=39.34 flags=/O2 /Gr /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_00460930 */
/* Pass A — minimal Ghidra → MSVC6 typedefs (not from speed.exe) */
/* M4.1.2: unaff_ESI → __fastcall 1st arg (unaff_2nd; sync only on uplift). */
...
int __cdecl FUN_00460970();
int __cdecl FUN_00584500();
extern int DAT_0073ad3c;
extern int _DAT_006cca38;

undefined2 __fastcall FUN_00460930(int obj, undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  
  FUN_00584500(param_1,(float)DAT_0073ad3c * _DAT_006cca38);
  FUN_00460970(param_1,param_2,param_3);
  *(undefined4 *)(obj + 0x78) = param_1;
  return *(undefined2 *)(obj + 0x70);
}
