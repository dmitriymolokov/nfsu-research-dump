/* spd-match: far pct=10.21 flags=/O1 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_004A7B80 */
...
void __fastcall FUN_004a7b80(int param_2, char param_3)

{
  ...
  if (in_AL != '\0') {
    FUN_004f6970(*(undefined4 *)(param_2 + 0x80));
    if ((*(int *)(extraout_EDX + 0x80) != 0) &&
       (iVar3 = *(int *)(*(int *)(extraout_EDX + 0x80) + 0x54), iVar3 != 0)) {
      pcVar4 = "LosingMult";
      do {
        cVar1 = pcVar4[*(int *)(iVar3 + 0x2c) + -0x6c6d5c];
        cVar2 = *pcVar4;
        pcVar4 = pcVar4 + 1;
        if ((cVar1 == '\0') || (cVar2 == '\0')) break;
      } while (cVar1 == cVar2);
      if ((cVar1 == cVar2) && (*(int *)(iVar3 + 0x10) <= *(int *)(iVar3 + 0xc))) {
        return;
      }
    }
    FUN_004f6b70("LosingMult",1);
    return;
  }
  if (param_3 == '\0') {
    FUN_004f6910(*(undefined4 *)(param_2 + 0x80));
    return;
  }
  FUN_004f6970(*(undefined4 *)(param_2 + 0x80));
  if ((*(int *)(extraout_EDX_00 + 0x80) != 0) &&
     (iVar3 = *(int *)(*(int *)(extraout_EDX_00 + 0x80) + 0x54), iVar3 != 0)) {
    pcVar4 = "TooSlowToGain";
    do {
      cVar1 = pcVar4[*(int *)(iVar3 + 0x2c) + -0x6c6d4c];
      cVar2 = *pcVar4;
      pcVar4 = pcVar4 + 1;
      if ((cVar1 == '\0') || (cVar2 == '\0')) break;
    } while (cVar1 == cVar2);
