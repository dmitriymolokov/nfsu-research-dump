/* spd-match: far pct=9.49 flags=/Og /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_004A7D60 */
...
/* M4.1.3: FUN_004f6b70 → __stdcall (callee_stdcall). */
...
int __stdcall FUN_004f6b70(int a, int b);
...
extern void LAB_004a7e18(void);
extern void LAB_004a7f31(void);

void __fastcall FUN_004a7d60(undefined4 param_1,int param_2,int param_3)

{
  ...
  if ((*(uint *)(param_3 + 0x18) & *(uint *)(param_3 + 0x10)) == 0 &&
      (*(uint *)(param_3 + 0x1c) & *(uint *)(param_3 + 0x14)) == 0) {
    return;
  }
  iVar6 = *(int *)(param_2 + 4);
  ...
  sVar2 = *(short *)(*(int *)(iVar6 + 0x1c) + 0x10);
  FUN_00586580(local_20);
  if ((*(int *)(param_3 + 0x20) == 0) ||
     (iVar6 = *(int *)(*(int *)(param_3 + 0x20) + 0x54), iVar6 == 0)) {
LAB_004a7e18:
    if (*(char *)(param_3 + 0x28) == '\0') {
      FUN_004f6b70("Animate",1);
      FUN_004f6b70("Animate",1);
    ...
    pcVar5 = "Animate";
    do {
      cVar3 = pcVar5[*(int *)(iVar6 + 0x2c) + -0x6c6cbc];
      cVar1 = *pcVar5;
      pcVar5 = pcVar5 + 1;
      if ((cVar3 == '\0') || (cVar1 == '\0')) break;
    } while (cVar3 == cVar1);
    if ((cVar3 != cVar1) || (*(int *)(iVar6 + 0xc) < *(int *)(iVar6 + 0x10))) goto LAB_004a7e18;
  }
  if ((DAT_0078a344 == '\0') && (DAT_007361a8 == 0)) {
    if (sVar2 == 3) {
      ...
      FUN_004f68a0(&DAT_006cc568,iVar6);
      goto LAB_004a7f31;
    }
  }
  else {
    if (sVar2 == 1) {
      ...
      pcVar5 = local_40;
      do {
        cVar3 = pcVar5[iVar6 - (int)local_40];
        iVar4 = iVar4 + -1;
        *pcVar5 = cVar3;
        if (cVar3 == '\0') break;
        pcVar5 = pcVar5 + 1;
      ...
      FUN_004f68a0("%s\n%s%s  ",iVar6,local_40,local_20);
      goto LAB_004a7f31;
    }
    if ((sVar2 != 6) && (sVar2 != 7)) goto LAB_004a7f31;
  }
  FUN_004f66f0();
LAB_004a7f31:
  cVar3 = FUN_0043a2e0();
