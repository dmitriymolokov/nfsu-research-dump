/* spd-match: far pct=13.70 flags=/O1 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_00473EA0 */
/* Pass A — minimal Ghidra → MSVC6 typedefs (not from speed.exe) */
/* M4.1.2: unaff_EDI+ESI → __fastcall dual (multi_dual; sync only on uplift). */
...
int __cdecl FUN_00472a90();
int __cdecl FUN_00473f20();
extern void LAB_00473ef0(void);

void __fastcall FUN_00473ea0(undefined4 * obj, int esi)

{
  ...
  FUN_00472a90();
  FUN_004665e0();
  *(code **)(esi + 8) = FUN_00473f20;
  *(undefined1 **)(esi + 0xc) = &LAB_00473ef0;
  uVar1 = obj[1];
  uVar2 = obj[2];
  *(undefined4 *)(esi + 0x30) = *obj;
  *(undefined4 *)(esi + 0x34) = uVar1;
  *(undefined4 *)(esi + 0x3c) = 0;
  *(undefined4 *)(esi + 0x38) = uVar2;
  *(undefined2 *)(esi + 0x2c) = 0;
  *(undefined4 *)(esi + 0x14) = 1;
  *(undefined4 *)(esi + 0x10) = 4;
  return;
}
