/* spd-match: far pct=16.67 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
extern void LAB_004605e0(void);

void __fastcall FUN_004604d0(int *param_1)

{
  (**(code **)(param_1[0x94] + 0x14))();
  if ((char)param_1[0x144] == '\0') {
    (**(code **)(*param_1 + 0xc))(0xa6,&LAB_004605e0,param_1);
    FUN_00574020();
    (**(code **)(*param_1 + 0xc))(0xa7,&LAB_004605e0,param_1);
    FUN_00574020();
    (**(code **)(*param_1 + 0xc))(0xa8,&LAB_004605e0,param_1);
    FUN_00574020();
    (**(code **)(*param_1 + 0xc))(0xa9,&LAB_004605e0,param_1);
    FUN_00574020();
