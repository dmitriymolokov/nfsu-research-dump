/* spd-match: far pct=7.92 flags=/O2 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_004801C0 */
...
float10 __fastcall FUN_004801c0(int obj, uint esi)

{
  ...
  uVar1 = *(uint *)(obj + 0xcb0);
  uVar3 = esi + 1 & ((int)(esi + 1) < 1) - 1;
  uVar4 = uVar3;
  if ((int)uVar3 > (int)uVar1) {
    uVar4 = uVar1;
  }
  fVar2 = DAT_007372b0;
  if (SBORROW4(uVar4,uVar1) != ((int)uVar3 <= (int)uVar1 && (int)(uVar3 - uVar1) < 0)) {
    fVar2 = *(float *)(uVar4 * 0x4c + 0xd8 + obj);
  }
  uVar3 = ((int)esi < 1) - 1 & esi;
  uVar4 = uVar3;
  if ((int)uVar3 > (int)uVar1) {
    uVar4 = uVar1;
  }
  if (SBORROW4(uVar4,uVar1) == ((int)uVar3 <= (int)uVar1 && (int)(uVar3 - uVar1) < 0)) {
    return (float10)fVar2 - (float10)DAT_007372b0;
  }
  return (float10)fVar2 - (float10)*(float *)(uVar4 * 0x4c + 0xd8 + obj);
}
