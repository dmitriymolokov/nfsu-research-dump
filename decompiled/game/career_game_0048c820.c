/* spd-match: far pct=18.45 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_0048C820 */
...
void __fastcall FUN_0048c820(int param_1)

{
  ...
  if (((cVar3 != '\0') || (DAT_007361f0 == (int *)0x0)) ||
    ...
    local_5c = puVar1[0xc];
    local_60 = *puVar1;
    local_58 = puVar1[0x18];
    puVar1 = *(undefined4 **)(param_1 + 0x34);
    local_70 = *puVar1;
    local_6c = puVar1[0xc];
    local_68 = puVar1[0x18];
    local_80 = 0;
    local_7c = 0;
    local_78 = 0x3f800000;
    FUN_0040b780(&local_80);
    FUN_00483b90(param_1,local_50,*(undefined4 *)(*(int *)(param_1 + 0x20) + 4));
    FUN_0047d070(*(undefined4 *)(param_1 + 0x1c),local_50,DAT_0073457c);
  }
  return;
}
