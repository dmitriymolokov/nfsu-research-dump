/* spd-match: far pct=11.02 flags=/O2 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_0044BC30 */
...
extern int iRam00000208;
extern undefined4 *puRam00000014;
int __cdecl FUN_0044bc30(int * obj)

{
  ...
  local_4 = 0;
  if (iVar1 == 0x14) {
    (**(code **)(*obj + 0x84))(&local_4);
    iVar1 = 0x14;
    if ((obj[0xfe] == 0) || (iRam00000208 <= *(int *)(obj[0xfe] + 500))) {
      (*(code *)*puRam00000014)(1);
      return 0;
    }
  }
  else {
