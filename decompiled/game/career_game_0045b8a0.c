/* spd-match: far pct=19.57 flags=/O1 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_0045B8A0 */
...
void __fastcall FUN_0045b8a0(undefined4 * obj, undefined4 *param_2)

{
  ...
  *(undefined1 *)(obj + 0x74) = *(undefined1 *)(param_2 + 0x74);
  obj[0x75] = param_2[0x75];
  obj[0x76] = param_2[0x76];
  obj[0x77] = param_2[0x77];
  return;
}
