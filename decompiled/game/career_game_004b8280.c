/* spd-match: far pct=24.71 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_004B8280 */
...
void __fastcall FUN_004b8280(int param_1)

{
  int iVar1;
  
  FUN_004f68c0(0x20,"Option%1dTextString",*(undefined4 *)(param_1 + 0x90));
  iVar1 = FUN_0059fb80();
  if (iVar1 == 0) {
    iVar1 = FUN_0059fb80();
  }
  FUN_004f67f0(iVar1);
  FUN_004f68c0(0x20,"Option%1dData",*(undefined4 *)(param_1 + 0x90));
  iVar1 = FUN_004ab510();
  FUN_004f67f0(&DAT_006ca778,*(undefined4 *)(iVar1 + 0x20));
  return;
}
