/* spd-match: far pct=12.68 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_004A1E20 */
...
extern int DAT_006cc568;
extern unsigned char *DAT_0073619c;
void __cdecl FUN_004a1e20(int obj, int param_1)

{
  ...
  if (*(char *)(obj + 0xd) != '\0') {
    *(undefined4 *)(param_1 + 0x34) =
         *(undefined4 *)(obj + 0x38 + *(char *)(DAT_0073619c + 0x53f) * 4);
