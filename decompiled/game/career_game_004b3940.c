/* spd-match: far pct=22.22 flags=/O1 /c /nologo /TP method=m39 source=m39/4.1.4/va_004B3940 */
...
struct ThisCallBox {
  void FUN_004b3940(undefined4 param_3, undefined4 param_4, undefined4 param_5, undefined4 param_6);
};
void ThisCallBox::FUN_004b3940(undefined4 param_3, undefined4 param_4, undefined4 param_5, undefined4 param_6) {
  undefined4 uVar1;
  
  uVar1 = 0;
  if (((int)this) != 0x23) {
    if (((int)this) * 0xc90 + DAT_00734588 == 0) {
      uVar1 = 0;
    }
    else {
      uVar1 = FUN_00567c70();
  ...
  FUN_0057ce10(uVar1,param_4,param_5,param_3,param_6);
  return;
}
