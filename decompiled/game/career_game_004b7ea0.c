/* spd-match: far pct=16.22 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_004B7EA0 */
...
extern void LAB_004b7ebe(void);

void __fastcall FUN_004b7ea0(int obj)

{
  ...
  for (puVar1 = *(undefined4 **)(obj + 0x40); puVar1 != (undefined4 *)(obj + 0x40);
    ...
    if (puVar1[2] == DAT_00777cc8) goto LAB_004b7ebe;
  }
  puVar1 = (undefined4 *)0x0;
LAB_004b7ebe:
  FUN_00495f00(puVar1[5]);
  return;
}
