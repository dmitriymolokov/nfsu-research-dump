/* spd-match: far pct=12.73 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_004484F0 */
...
void __fastcall FUN_004484f0(int esi)

{
  int iVar1;

  iVar1 = 0;
  DAT_00736174 = DAT_00736168;
  if (0 < DAT_0073616c) {
    do {
      if (*(short *)(DAT_00736174 + 0x6c) == esi) {
        return;
      }
      iVar1 = iVar1 + 1;
      DAT_00736174 = DAT_00736174 + 0xfc;
