/* spd-match: far pct=40.43 flags=/O2 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_004573F0 */
...
void __fastcall FUN_004573f0(int obj, undefined4 *param_2)

{
  ...
  if (*(char *)(obj + 0xf8) == '\0') {
    puVar1 = (undefined4 *)(obj + *(int *)(obj + 0xf4) * 0xc);
    *puVar1 = *param_2;
    puVar1[1] = param_2[1];
    puVar1[2] = param_2[2];
    iVar2 = *(int *)(obj + 0xf4) + 1;
    *(int *)(obj + 0xf4) = iVar2;
    if (iVar2 == 0x14) {
