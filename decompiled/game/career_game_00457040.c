/* spd-match: far pct=43.48 flags=/O1 /Gr /c /nologo /TC method=m39 source=m39/4.1.G.1-filter100/va_00457040 */
...
int FUN_00457040(int val) { if (val < 5) return val + 5; return (val > 10 && val < 17) ? val + 6 : val; }
