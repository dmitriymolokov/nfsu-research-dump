/* spd-match: far pct=11.11 flags=/O2 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_0045D5E0 */
...
int __cdecl FUN_0045c0d0();
int __cdecl FUN_0045cfb0();
uint __fastcall FUN_0045d5e0(int obj, uint * esi_obj)

{
  ...
  if ((1 < (int)uVar2) && ((int)uVar2 < 4)) {
    uVar2 = 0;
    if (0 < *(int *)(obj + 4)) {
      puVar3 = (uint *)(obj + 0x3c);
      do {
        if (*puVar3 == esi_obj[1]) {
          if ((uVar2 != 0xffffffff) && (iVar1 = uVar2 * 0x38 + 8 + obj, uVar2 = 0, iVar1 != 0)) {
            FUN_0045c0d0(esi_obj,iVar1);
            uVar2 = FUN_0045cfb0();
            return uVar2;
          }
          break;
