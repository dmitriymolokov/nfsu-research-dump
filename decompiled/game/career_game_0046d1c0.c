/* spd-match: far pct=7.24 flags=/O2 /c /nologo /TC method=m4_13_callee_stdcall_v2 source=m4_13/4.1.3/va_0046D1C0 */
...
/* M4.1.3-R3: FUN_00583ea0 → unified __stdcall (callee_stdcall_v2). */
...
int __stdcall FUN_00583ea0(undefined4 a1);
extern int DAT_006cc7a4;
extern int DAT_00700030;
extern int _DAT_006b7244;
extern int _DAT_006cc7bc;
extern int _DAT_006cc7dc;
extern int _DAT_006cc9f8;
extern int _DAT_006ccb7c;
extern void LAB_0046d319(void);
int unaff_EDI;
int __stdcall FUN_00583ea0(undefined4 a1);
extern int DAT_006cc7a4;
extern int DAT_00700030;
...
void __fastcall FUN_0046d1c0(undefined4 param_1,int param_2,float *param_3,float param_4)

{
  ...
  iVar6 = (int)param_4;
  iVar8 = 2;
  *(float *)((int)param_4 + 4) = (unaff_EDI[1] - *unaff_EDI) * *param_3 + *unaff_EDI;
  fVar1 = param_3[6];
  if ((int)fVar1 + 1 < 3) {
    *(float *)((int)param_4 + 8) = unaff_EDI[1];
    return;
  }
  local_34 = (float *)(param_2 + 0xc);
  pfVar7 = param_3 + 0xb;
  do {
    fVar2 = pfVar7[-1];
    fVar3 = *pfVar7;
    if (DAT_00700030 == 0) {
      param_4 = (unaff_EDI[1] - *unaff_EDI) * *param_3 + *unaff_EDI;
    }
    else {
      fVar4 = unaff_EDI[1];
      param_4 = (unaff_EDI[1] + *unaff_EDI) * _DAT_006cc7dc;
      if (param_4 < fVar4) {
        do {
          fVar9 = (float10)FUN_00583ea0(param_4);
          if (ABS(fVar2) <= _DAT_006ccb7c) {
            fVar10 = (float10)DAT_006cc7a4;
          }
          else {
            fVar5 = _DAT_006cc7bc / fVar2;
            fVar10 = (float10)FUN_00583ea0(fVar5 * param_4 * fVar3);
            fVar10 = fVar10 * (float10)fVar5 * (float10)fVar3;
          }
          if ((float10)(float)fVar9 < fVar10) goto LAB_0046d319;
          param_4 = ((int)(_DAT_006b7244)) + param_4;
        } while (param_4 < fVar4);
      }
      param_4 = unaff_EDI[1] - _DAT_006cc9f8;
    }
LAB_0046d319:
    *(float *)(iVar6 + iVar8 * 4) = param_4;
    if (ABS(fVar2) <= _DAT_006ccb7c) {
      *local_34 = 0.0;
    }
    else {
      *local_34 = (fVar3 / fVar2) * *(float *)(iVar6 + iVar8 * 4);
    }
    iVar8 = iVar8 + 1;
    pfVar7 = pfVar7 + 1;
    local_34 = local_34 + 1;
    if ((int)fVar1 + 1 <= iVar8) {
      *(float *)(iVar6 + iVar8 * 4) = unaff_EDI[1];
      return;
    }
  } while( true );
}
