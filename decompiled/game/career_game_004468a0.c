/* spd-match: far pct=25.84 flags=/O2 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_004468A0 */
...
void __fastcall FUN_004468a0(int obj, int param_2, code *param_3)

{
  ...
  piVar1 = (int *)(obj + 0x820);
  iVar2 = 0;
  if (0 < *piVar1) {
    while (*(int *)(obj + 0x80) != param_2) {
      iVar2 = iVar2 + 1;
      obj = obj + 0xd0;
      if (*piVar1 <= iVar2) {
        return;
    ...
    uVar3 = *(uint *)(obj + 0x88);
    if (uVar3 < *(uint *)(obj + 0x8c)) {
      do {
        (*param_3)(uVar3);
        uVar3 = uVar3 + 0xc;
      } while (uVar3 < *(uint *)(obj + 0x8c));
    }
  }
  return;
}
