/* spd-match: far pct=20.79 flags=/O2 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.5/va_00482FC0 */
...
int __cdecl FUN_0063c290();
extern int DAT_0078a2f0;
void __fastcall FUN_00482fc0(int obj)

{
  ...
  _Size = *(int *)(obj + 0xcb0) * 0x4c + 8;
  puVar1 = _malloc(_Size);
  *puVar1 = 0x12345678;
  puVar1[1] = 4;
  puVar5 = (undefined4 *)(obj + 0xd0);
  puVar6 = puVar1 + 2;
  for (uVar2 = (uint)(*(int *)(obj + 0xcb0) * 0x4c) >> 2; uVar2 != 0; uVar2 = uVar2 - 1) {
    *puVar6 = *puVar5;
    puVar5 = puVar5 + 1;
    puVar6 = puVar6 + 1;
  }
  ...
  FUN_00565da0("..\\..\\World\\Location1\\Track_%04d\\DragCameras.bin",DAT_0078a2f0);
  iVar3 = FUN_00594c60(local_80,1,6);
  if (iVar3 != 0) {
    FUN_0063c290(*(undefined4 *)(iVar3 + 0xc),*(undefined4 *)(iVar3 + 8),puVar1,_Size,100);
    iVar4 = *(int *)(iVar3 + 8) + _Size;
    *(int *)(iVar3 + 8) = iVar4;
