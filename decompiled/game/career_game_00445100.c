/* spd-match: far pct=12.40 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
undefined4 FUN_00445100(int param_1)

{
  ...
  uVar4 = (uint)*(byte *)(param_1 + 0x15c);
  if (DAT_0073459c != 0) {
    uVar4 = FUN_0057c5a0(9);
  }
  uVar2 = 0;
  if (DAT_007345a0 != 0) {
    uVar2 = FUN_0057c3b0(uVar4,1,9);
  }
