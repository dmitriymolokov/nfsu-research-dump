/* spd-match: far pct=8.52 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_004BE9A0 */
...
void __fastcall FUN_004be9a0(int param_1)

{
  ...
  FUN_004f68c0(0x20,"%s%1d",param_1 + 0x21d,*(undefined4 *)(param_1 + 400));
  iVar2 = FUN_0059fb80();
  if (iVar2 == 0) {
    iVar2 = FUN_0059fb80();
  }
  FUN_004f67f0(iVar2);
  FUN_004f68c0(0x20,"OptionData_%1d",*(undefined4 *)(param_1 + 400));
  if (DAT_007361b4 == 0) {
    iVar2 = -1;
  }
  else {
  ...
  if (*(int *)(DAT_007361f0 + 0x1c) == iVar2) {
    ...
    uVar3 = (uint)(*(int *)(DAT_007361f0 + 0x1c) == iVar2);
  }
  cVar1 = *(char *)((&DAT_007361b4)[uVar3] + 0x23);
  if (((cVar1 == '\x01') || (cVar1 == '\x03')) || (cVar1 == '\0')) {
    iVar2 = FUN_0059fb80();
    if (iVar2 == 0) {
      iVar2 = FUN_0059fb80();
    }
