/* spd-match: far pct=17.20 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
extern int DAT_0072cbf0;
extern int DAT_0072cbf4;
extern int DAT_0072cbf8;
extern int DAT_0072cbfc;
extern int DAT_0072cc00;
extern int DAT_0072cc04;
extern int DAT_0072cc08;
extern int DAT_00736050;
extern unsigned char *DAT_00736070;

void FUN_00466bf0(void)

{
  ...
  DAT_0072cc04 = 0;
  DAT_0072cc08 = 0;
  if (DAT_00736070 != (int *)0x0) {
    if (*DAT_00736070 != 0) {
      piVar1 = DAT_00736070 + 1;
      *DAT_00736070 = 0;
      _free((void *)*piVar1);
      *piVar1 = 0;
      _Memory[2] = 0;
  ...
  DAT_00736070 = (int *)0x0;
  _free(DAT_00736050);
  DAT_00736050 = (void *)0x0;
  _free(DAT_0072cbfc);
  DAT_0072cbfc = (void *)0x0;
  return;
}
