/* spd-match: far pct=18.18 flags=/Og /c /nologo /TP method=m4_14_thin_callee_fastcall source=m4_14/4.1.4/va_0045FAF0 */
...
/* M4.1.4: FUN_00459980 → __fastcall(this) (thin_callee_fastcall). */
...
int __fastcall FUN_00459980(undefined4 *param_1);

struct ThisCallBox {
  void FUN_0045faf0(char *param_2);
};
void ThisCallBox::FUN_0045faf0(char *param_2) {
  int iVar1;
  undefined4 *puVar2;
  
  if (((param_2 != (char *)0x0) && (-1 < *param_2)) && (*param_2 < '\x15')) {
