/* spd-match: far pct=12.82 flags=/O1 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_004B91E0 */
...
void __fastcall FUN_004b91e0(int edi, int ebx)

{
  ...
  if ((*(int *)(iVar2 + 0x18) == 1) && (*(int *)(iVar2 + 0x24) != ebx)) {
    *(int *)(iVar2 + 0x24) = ebx;
