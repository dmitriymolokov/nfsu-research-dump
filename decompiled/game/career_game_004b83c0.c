/* spd-match: far pct=23.85 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_004B83C0 */
...
void __fastcall FUN_004b83c0(int param_1)

{
  int iVar1;
  
  FUN_004f68c0(0x20,"Option%1dTextString",*(undefined4 *)(param_1 + 0x9c));
  iVar1 = FUN_0059fb80();
  if (iVar1 == 0) {
    iVar1 = FUN_0059fb80();
  }
  FUN_004f67f0(iVar1);
  FUN_004f68c0(0x20,"Option%1dData",*(undefined4 *)(param_1 + 0x9c));
  iVar1 = FUN_004ab510();
