/* spd-match: far pct=24.39 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_004AA1C0 */
...
void __fastcall FUN_004aa1c0(int obj)

{
  ...
  iVar1 = 0;
  do {
    if (*(short *)(obj + iVar1 * 8) != 0) {
      FUN_00586580(local_10);
    }
    iVar1 = iVar1 + 1;
  } while (iVar1 < 0x140);
  return;
