/* spd-match: far pct=39.29 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
int __cdecl FUN_00594970();
int __cdecl FUN_00594c60();
int __cdecl FUN_00594d40();
extern int _DAT_00736108;

void FUN_00447160(void)

{
  int iVar1;
  
  iVar1 = FUN_00594c60("NFSUNDER\\ZDIR.BIN",0,1);
  if (iVar1 != 0) {
    iVar1 = *(int *)(iVar1 + 4);
    FUN_00594d40();
    if (iVar1 != -1) {
      FUN_00594970("NFSUNDER\\ZZDATA");
      return;
    }
  }
  _DAT_00736108 = 0;
