/* spd-match: far pct=13.89 flags=/O1 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_0049DE00 */
...
void __fastcall FUN_0049de00(int edi, int obj, int param_1)

{
  ...
  iVar1 = *(int *)(obj + 0xd0 + edi * 4);
  if (iVar1 != 0) {
    *(uint *)(iVar1 + 0x1c) = *(uint *)(iVar1 + 0x1c) | 0x400000;
    puVar2 = DAT_00735710;
    bVar3 = DAT_00735710 != (undefined4 *)0x0;
    *(undefined4 *)(iVar1 + 0x5c) = 0x680ac597;
    if (bVar3) {
      (**(code **)*puVar2)(iVar1);
    }
    *(uint *)(iVar1 + 0x1c) = *(uint *)(iVar1 + 0x1c) & 0xfffffffd | 0x400000;
  }
  FUN_004f68a0("%d/%d",(&DAT_00777cc4)[*(char *)(param_1 + 10) * 0x57],
               (&DAT_00777cc8)[*(char *)(param_1 + 10) * 0x57]);
  return;
}
