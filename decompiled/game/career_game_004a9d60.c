/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=m4_13_fc_wrapper_thiscall source=m4_13/4.1.3/va_004A9D60 */
...
/* M4.1.3: FUN_004a9d70 → __stdcall (callee_stdcall). */
...
int __stdcall FUN_004a9d70(int arg);

void __fastcall FUN_004a9d60(int head)

{
  FUN_004a9d70(head + 0x6634);
  return;
}
