/* spd-match: far pct=21.54 flags=/O1 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_00536690 */
...
int __cdecl FUN_005366e0();
int __cdecl FUN_005368b0();
void __fastcall FUN_00536690(undefined4 edi, undefined4 esi)

{
  
  FUN_005366e0(esi);
  FUN_005368b0(esi,edi,0xbf800000,0);
  FUN_005368b0(esi,edi,0xbf800000,1);
  FUN_005368b0(esi,edi,0xbf800000,2);
  FUN_005368b0(esi,edi,0xbf800000,3);
  return;
}
