/* spd-match: far pct=9.52 flags=/Og /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_00446B10 */
...
void __fastcall FUN_00446b10(int obj, int edi)

{
  ...
  iVar1 = 0;
  if (0 < *(int *)(obj + 0x10)) {
    psVar3 = (short *)(obj + 0x14);
    while (*psVar3 != edi) {
      iVar1 = iVar1 + 1;
      psVar3 = psVar3 + 1;
      if (*(int *)(obj + 0x10) <= iVar1) {
        return;
      }
    }
    if (iVar1 < *(int *)(obj + 0x10) + -1) {
      puVar2 = (undefined2 *)(obj + 0x14 + iVar1 * 2);
      do {
        *puVar2 = puVar2[1];
        iVar1 = iVar1 + 1;
        puVar2 = puVar2 + 1;
      } while (iVar1 < *(int *)(obj + 0x10) + -1);
    }
    iVar1 = *(int *)(obj + 0x10) + -1;
    *(int *)(obj + 0x10) = iVar1;
    *(undefined2 *)(obj + 0x14 + iVar1 * 2) = 0;
  }
  return;
}
