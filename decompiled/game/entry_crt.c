/* spd-match: far pct=14.32 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m375_9/buckets/p09_game_a/attempt2_entry_pe */
...
int __cdecl FUN_004472e0();
int __cdecl FUN_00671fb2();
int __cdecl FUN_006720ea();
int __cdecl FUN_0067210c();
int __cdecl FUN_00675450();
int __cdecl FUN_00675614();
int __cdecl FUN_00675812();
int __cdecl FUN_00675aa7();
extern int DAT_00717a74;
extern int DAT_00717a88;
extern int DAT_00717a94;
extern int DAT_00717a9c;
extern int DAT_00717aa0;
extern int DAT_00717aa8;
extern int DAT_00717aac;
extern int DAT_00794364;
extern int _DAT_00717a8c;
extern int _DAT_00717a90;
extern int _DAT_00717a98;
extern void LAB_00670d74(void);
extern void LAB_00670d7a(void);
...

{
  ...
  local_cc.szCSDVersion[0x7c] = -0x33;
  local_cc.szCSDVersion[0x7d] = '\f';
  local_cc.szCSDVersion[0x7e] = 'g';
  local_cc.szCSDVersion[0x7f] = '\0';
  local_cc.dwOSVersionInfoSize = 0x94;
  GetVersionExA(&local_cc);
  DAT_00717a88 = local_cc.dwPlatformId;
  DAT_00717a94 = local_cc.dwMajorVersion;
  _DAT_00717a98 = local_cc.dwMinorVersion;
  _DAT_00717a8c = local_cc.dwBuildNumber & 0x7fff;
  if (local_cc.dwPlatformId != 2) {
    _DAT_00717a8c = _DAT_00717a8c | 0x8000;
  }
  _DAT_00717a90 = local_cc.dwMajorVersion * 0x100 + local_cc.dwMinorVersion;
  pHVar1 = GetModuleHandleA((LPCSTR)0x0);
  if (((short)(*(short *)(pHVar1)) == 0x5a4d) &&
     (piVar4 = (int *)((char *)(pHVar1) + *(int *)((char *)(pHVar1) + 0x3c)), *piVar4 == 0x4550)) {
...
LAB_00670d7a:
  ...
  DAT_00794364 = GetCommandLineA();
  DAT_00717a74 = ___crtGetEnvironmentStringsA();
  iVar2 = FUN_00675450();
  if (iVar2 < 0) {
    __amsg_exit(8);
  }
  ...
  DAT_00717aac = DAT_00717aa8;
  uVar3 = FUN_004472e0(DAT_00717a9c,DAT_00717aa0,DAT_00717aa8);
  if (!bVar5) {
    FUN_006720ea(uVar3);
  }
  FUN_0067210c();
