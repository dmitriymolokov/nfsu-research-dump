/* spd-match: far pct=14.58 flags=/O2 /c /nologo /TC method=m4_13_callee_stdcall_v2 source=m4_13/4.1.3/va_00481970 */
...
/* M4.1.3-R3: FUN_00481720 → unified __stdcall (callee_stdcall_v2). */
...
int __stdcall FUN_00481720(void *a1, undefined4 a2);
int _local_4;
undefined4 __fastcall FUN_00481970(char * obj)

{
  ...
  piVar1 = (int *)(obj + 0xcb4);
  uVar3 = 0;
  do {
    if (*obj != obj[*piVar1 * 0x4c + 0xd0]) {
      _local_4 = CONCAT31((uint3)*piVar1 & 0xff,3);
      _local_4 = CONCAT22(0x50,_local_4);
      uVar2 = FUN_00481720(&local_4,4);
      FUN_00481720(uVar2,0x4c);
      return 1;
    }
    uVar3 = uVar3 + 1;
    obj = obj + 1;
