/* spd-match: far pct=8.11 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_0044CA70 */
...
int __cdecl FUN_005aaea0();
extern int DAT_00736158;
extern int DAT_0073615c;

void __fastcall FUN_0044ca70(int obj)

{
  ...
  if (0 < DAT_0073615c) {
    do {
      iVar1 = (int)*(short *)(*(int *)(obj + 4) + 10);
      *(undefined1 *)((iVar1 + -0x31) * 0x10 + iVar4) = 0;
      iVar3 = 0;
      do {
        if (*(char *)(iVar4 + 6 + iVar3) == iVar1) {
          FUN_005aaea0();
          break;
        }
        iVar3 = iVar3 + 1;
