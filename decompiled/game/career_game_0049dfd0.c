/* spd-match: far pct=10.75 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_0049DFD0 */
...
int __cdecl FUN_0049eee0();
int __cdecl FUN_004f0800();
int __cdecl FUN_004f3f90();
int __cdecl FUN_00567da0();
...
extern int DAT_0073578c;
extern int DAT_00746104;
void __cdecl FUN_0049dfd0(int obj)

{
  ...
  if (*(undefined4 **)(obj + 8) != puVar1) {
    uVar2 = puVar1[2];
    *(undefined4 *)(obj + 0xc) = *puVar1;
    iVar4 = FUN_00567da0();
    iVar3 = DAT_0073578c;
    if (iVar4 == 0) {
      FUN_0049eee0(obj + 0x10,uVar2);
      return;
    }
