/* spd-match: far pct=7.41 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_004B1530 */
...
int __cdecl FUN_004ad7b0();
extern int DAT_00734588;
void __cdecl FUN_004b1530(int obj)

{
  ...
  pbVar3 = (byte *)(obj * 0xc90 + DAT_00734588);
  if (pbVar3 != (byte *)0x0) {
    pcVar6 = "SECONDARY_LOGO_";
    iVar5 = -1;
    uVar4 = 0x53;
    do {
