/* spd-match: far pct=10.64 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_0049E040 */
...
extern int DAT_0073578c;
extern int DAT_00746104;
void __cdecl FUN_0049e040(int obj)

{
  ...
  if (*(int *)(obj + 4) != iVar1) {
    ...
    *(undefined4 *)(obj + 0xc) = *(undefined4 *)(iVar1 + 4);
    iVar3 = FUN_00567da0();
    iVar1 = DAT_0073578c;
    if (iVar3 == 0) {
