/* spd-match: far pct=18.18 flags=/O2 /c /nologo /TC method=m4_11_r2_edi_stack source=m4_11/4.1.1.r2/va_004AEE90 */
...
void __fastcall FUN_004aee90(undefined4 val, undefined4 param_1, undefined1 * obj)

{
  ...
  *(undefined4 *)(obj + 0xc) = val;
  *obj = 0;
  FUN_004f7350(&local_8,local_4);
  *(undefined4 *)(obj + 0x10) = local_8;
  FUN_004f6d10(&local_8,local_4);
  *(undefined4 *)(obj + 4) = local_8;
