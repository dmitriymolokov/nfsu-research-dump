...
struct ThisCallBox {
  void FUN_00487810(undefined4 param_2);
};
void ThisCallBox::FUN_00487810(undefined4 param_2) {
  if ((*(int *)(((int)this) + 0x2c) != 2) && (*(int *)(((int)this) + 0x2c) != 0)) {
    *(undefined4 *)(((int)this) + 0x2c) = 3;
    *(undefined4 *)(((int)this) + 0x180) = param_2;
  }
  return;
}
