/* Decompiled from Speed.exe @ 0049da50 */
/* Module: Career_Game */
/* Ghidra DecompileAll */
...
void FUN_0049da50(int param_1,int param_2)

{
  ...
  if (iVar1 != 0) {
    ...
    *(undefined4 *)(iVar1 + 0x5c) = 0xae280d3d;
    if (bVar3) {
      (**(code **)*puVar2)(iVar1);
      puVar2 = DAT_00735710;
    }
  ...
  if ((float)*(int *)(&DAT_00777b84 + *(char *)(param_2 + 10) * 0x15c) * _DAT_006cca38 <=
      DAT_006cc7a4) {
