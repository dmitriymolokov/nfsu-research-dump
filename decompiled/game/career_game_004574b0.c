/* spd-match: far pct=29.59 flags=/O2 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_004574B0 */
...
undefined4 __fastcall FUN_004574b0(int obj, undefined4 *param_2)

{
  ...
  if ((*(char *)(obj + 0xf8) == '\0') && (*(int *)(obj + 0xf4) == *(int *)(obj + 0xf0))) {
    return 0;
  }
  ...
  *param_2 = *puVar1;
  param_2[1] = puVar1[1];
  param_2[2] = puVar1[2];
  iVar2 = *(int *)(obj + 0xf0) + 1;
  *(int *)(obj + 0xf0) = iVar2;
  if (iVar2 == 0x14) {
    *(undefined4 *)(obj + 0xf0) = 0;
  }
  *(undefined1 *)(obj + 0xf8) = 0;
  return 1;
}
