/* spd-match: far pct=31.11 flags=/O2 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_004AD6D0 */
...
undefined4 __fastcall FUN_004ad6d0(int esi, int param_1)

{
  ...
  if (0 < DAT_0073616c) {
    do {
      if (*(short *)(iVar3 + 0x6c) == esi) {
        if (param_1 != 0) {
          uVar2 = FUN_004f42f0("REVERSE_TRACK_NAME_%d",(int)*(short *)(iVar3 + 0x6c));
          return uVar2;
        }
        uVar2 = FUN_004f42f0("TRACK_NAME_%d",(int)*(short *)(iVar3 + 0x6c));
        return uVar2;
      }
      iVar1 = iVar1 + 1;
      iVar3 = iVar3 + 0xfc;
