/* spd-match: far pct=15.87 flags=/O1 /c /nologo /TC method=m39 source=m39/4.1.1/va_00494CB0 */
...
int __cdecl FUN_00494cb0(int obj)

{
  ...
  uVar1 = FUN_004fd230();
  if (((((obj != 0) && (iVar2 = FUN_004f65d0(), iVar2 != 0)) &&
