/* spd-match: far pct=17.24 flags=/O2 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_00496040 */
...
int __cdecl FUN_004f7350();
void __cdecl FUN_00496040(int obj, undefined4 param_1)

{
  ...
  FUN_004f7350(local_4,&local_8);
  if (obj != 0) {
    iVar1 = *(int *)(obj + 0x18);
    iVar2 = *(int *)(obj + 0x2c);
    if (((iVar1 == 1) || (iVar1 == 7)) || (iVar1 == 9)) {
      *(undefined4 *)(iVar2 + 0x38) = param_1;
      *(undefined4 *)(iVar2 + 0x3c) = local_8;
    }
    *(undefined4 *)(iVar2 + 0x3c) = local_8;
    *(undefined4 *)(iVar2 + 0x38) = param_1;
