/* spd-match: far pct=10.00 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_0047D680 */
...
int * __fastcall FUN_0047d680(int * obj, int edi)
