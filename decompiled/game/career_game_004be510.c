/* spd-match: far pct=10.19 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_004BE510 */
...
void __fastcall FUN_004be510(int param_1)

{
  ...
  if (DAT_007361b4 == 0) {
    ...
    iVar4 = *(int *)(DAT_007361b4 + 8);
  }
  if (*(int *)(DAT_007361f0 + 0x1c) == iVar4) {
    uVar2 = 0;
  }
  else {
    if (DAT_007361b8 == 0) {
      ...
      iVar4 = *(int *)(DAT_007361b8 + 8);
    }
    uVar2 = (uint)(*(int *)(DAT_007361f0 + 0x1c) == iVar4);
  }
  iVar4 = (&DAT_007361b4)[uVar2];
  FUN_004f68c0(0x20,"%s%1d",param_1 + 0x21d,*(undefined4 *)(param_1 + 0x180));
  iVar3 = FUN_0059fb80();
  if (iVar3 == 0) {
    iVar3 = FUN_0059fb80();
  }
  FUN_004f67f0(iVar3);
  FUN_004f68c0(0x20,"OptionData_%1d",*(undefined4 *)(param_1 + 0x180));
  cVar1 = *(char *)(iVar4 + 0x24);
  if ((((DAT_0078a344 == '\0') && (DAT_007361a8 == 0)) || (DAT_00700b5c != 0)) &&
     (((cVar1 != '\0' && (cVar1 != '\x01')) && ((cVar1 != '\x02' && (cVar1 != '\x04')))))) {
    FUN_004f67f0("NOT DRAWING ANYTHING");
    return;
  }
  iVar4 = FUN_0059fb80();
  if (iVar4 == 0) {
