/* Decompiled from Speed.exe @ 00454960 */
/* Module: Career_Game */
/* Ghidra DecompileAll */


void __thiscall FUN_00454960(int param_1,int param_2)

{
  int iVar1;
  char cVar2;
  
  FUN_00571ea0(0,"AIActionPickRouteToAvoidAnimation");
  FUN_0044e370(param_2);
  FUN_00571c20(param_2,param_1 + 0x200,1,1,0);
