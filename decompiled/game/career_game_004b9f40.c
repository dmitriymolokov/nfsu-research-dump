/* spd-match: far pct=13.54 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_004B9F40 */
...
void __fastcall FUN_004b9f40(undefined4 val, undefined4 param_1, int obj)

{
  ...
  if (puVar2 == (undefined4 *)0x0) {
    ...
    puVar2[5] = 0;
    *puVar2 = &PTR_FUN_006c5bbc;
    puVar2[3] = param_1;
    puVar2[6] = val;
    piVar3 = puVar2 + 1;
    puVar4 = puVar2;
  }
  puVar2 = *(undefined4 **)(obj + 0x44);
  *puVar2 = piVar3;
  *(int **)(obj + 0x44) = piVar3;
  piVar3[1] = (int)puVar2;
  *piVar3 = obj + 0x40;
  *(int *)(obj + 0xa0) = *(int *)(obj + 0xa0) + 1;
  cVar1 = FUN_005a16f0(&DAT_0075eef8);
  *(char *)(puVar4 + 4) = '\x01' - (cVar1 != '\0');
  return;
}
