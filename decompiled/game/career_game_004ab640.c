/* spd-match: far pct=37.14 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
uint __fastcall FUN_004ab640(int param_1)

{
  ...
  if (0 < *(int *)(param_1 + 0x74)) {
    ...
    do {
      ...
      uVar1 = uVar1 + 1;
      piVar2 = piVar2 + 3;
    } while ((int)uVar1 < *(int *)(param_1 + 0x74));
  }
