/* spd-match: far pct=21.31 flags=/O2 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_004904F0 */
...
int __cdecl FUN_00490560();
void __fastcall FUN_004904f0(int obj, undefined4 param_1, undefined4 * esi_obj)

{

  
  esi_obj[8] = *(undefined4 *)(obj + 0x20);
  esi_obj[7] = obj + 0x24;
  esi_obj[10] = *(undefined4 *)(obj + 0x4c);
  esi_obj[9] = obj + 0x50;
  esi_obj[0xc] = *(undefined4 *)(obj + 0x78);
  esi_obj[0xb] = obj + 0x7c;
  *esi_obj = 0;
  esi_obj[1] = param_1;
  FUN_00490560(esi_obj,obj);
  return;
}
