/* spd-match: far pct=18.60 flags=/O1 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_004AD270 */
...
int __fastcall FUN_004ad270(int edi, int obj)

{
  ...
  if (0 < *(int *)(obj + 0xae0)) {
    ...
    do {
      if (*piVar2 == edi) {
        return iVar1 * 0x15c + obj;
      }
      iVar1 = iVar1 + 1;
      piVar2 = piVar2 + 0x57;
    } while (iVar1 < *(int *)(obj + 0xae0));
  }
  return 0;
}
