/* spd-match: far pct=12.50 flags=/O1 /c /nologo /TC method=m4_11_unaff source=m4_11/4.1.1/va_004B93A0 */
...
bool __fastcall FUN_004b93a0(int obj)

{
  ...
  for (puVar1 = *(undefined4 **)(obj + 4);
      (puVar1 != (undefined4 *)(obj + 4) && (iVar2 = iVar2 + 1, puVar1 != (undefined4 *)0x0));
      puVar1 = (undefined4 *)*puVar1) {
  }
  return iVar2 == *(int *)(obj + 0x10);
}
