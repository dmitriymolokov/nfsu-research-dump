/* spd-match: far pct=20.00 flags=/O2 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_004AE9A0 */
...
void __fastcall FUN_004ae9a0(undefined4 val, int obj)
  ...
  *(undefined4 *)(obj + 4) = 0;
  ...
  do {
    if (*(int *)(obj + 8) == -2) {
      ...
      FUN_00574020(*puVar2,&LAB_004ae910);
    }
    puVar2 = puVar2 + 1;
