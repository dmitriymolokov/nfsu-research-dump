/* spd-match: far pct=28.00 flags=/O1 /c /nologo /TC method=m4_11_unaff source=m4_11/4.1.1/va_0048EBE0 */
...
void __fastcall FUN_0048ebe0(undefined4 * obj)

{
  
  *obj = &PTR_FUN_006c7d70;
  _free((void *)obj[2]);
  *obj = &PTR_LAB_006c7d78;
  return;
}
