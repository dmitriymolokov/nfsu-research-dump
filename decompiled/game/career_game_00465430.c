/* spd-match: far pct=11.49 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_00465430 */
...
extern int DAT_0073ad34;
extern int _DAT_006cca38;
uint __cdecl FUN_00465430(int obj)

{
  ...
  uVar4 = *(uint *)(obj + 0x3bc);
  if ((uVar4 != 0) && (uVar4 != 0x7fffffff)) {
    iVar3 = DAT_0073ad34 - *(int *)(obj + 0x3bc);
    fVar1 = (float)iVar3 * _DAT_006cca38;
    fVar2 = (float)*(int *)(obj + 0x3b8) * _DAT_006cca38;
    if (fVar2 >= fVar1) {
