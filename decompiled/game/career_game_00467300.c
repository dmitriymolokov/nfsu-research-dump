/* spd-match: far pct=8.24 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_00467300 */
...
undefined4 __fastcall FUN_00467300(int obj)

{
  ...
  iVar3 = *(int *)(obj + 0x25c);
  piVar1 = *(int **)(obj + 600);
  iVar2 = FUN_00466600(0);
  if ((iVar2 != 0) && ((*(char *)((int)piVar1 + 0x1d) != '\0' || (*(char *)(iVar3 + 0x1d) != '\0')))
     ) {
    iVar3 = (**(code **)(*piVar1 + 0x50))();
    if (iVar3 != 0) {
      iVar3 = (**(code **)(**(int **)(obj + 0x25c) + 0x50))();
      if (iVar3 != 0) {
        return 0;
      }
    }
