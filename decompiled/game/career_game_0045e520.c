/* spd-match: far pct=23.16 flags=/O2 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_0045E520 */
...
/* M4.1.3: FUN_005842d0 → __stdcall (callee_stdcall). */
...
int __stdcall FUN_005842d0(int arg);

void __fastcall FUN_0045e520(int param_1)
