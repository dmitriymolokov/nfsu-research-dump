/* spd-match: far pct=27.91 flags=/O1 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_004AD2A0 */
...
int * __fastcall FUN_004ad2a0(int edi, int * obj)

{
  ...
  if (0 < obj[0x2b8]) {
    do {
      if (*piVar2 == edi) {
        return obj + iVar1 * 0x57;
      }
      iVar1 = iVar1 + 1;
      piVar2 = piVar2 + 0x57;
    } while (iVar1 < obj[0x2b8]);
  }
  return (int *)0x0;
}
