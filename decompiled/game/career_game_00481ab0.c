/* spd-match: far pct=16.11 flags=/O1 method=thiscall_tp source=m375_sync_decomp:m375_inventory */
...
int __cdecl FUN_00480120(...);
int __cdecl FUN_00480f10(...);
int __cdecl FUN_00481850(...);
int __cdecl FUN_00481970(...);
int __cdecl FUN_004819d0(...);
int __cdecl FUN_00481a10(...);
...
extern void LAB_00481c93(...);
extern void LAB_00482850(...);

struct ThisCallBox {
  void FUN_00481ab0(int param_2);
};
void ThisCallBox::FUN_00481ab0(int param_2) {
  char cVar1;
  uint uVar2;
  float fVar3;
  float fVar4;
  ...
  iVar9 = *(int *)(((int)this) + 0xcb8);
  if (iVar9 == param_2) {
    return;
  }
  if (2 < iVar9) {
    *(undefined4 *)(((int)this) + 0xcc0) = *(undefined4 *)(((int)this) + 0xcc8);
  }
  switch(iVar9) {
  case 0:
    iVar9 = *(int *)(DAT_007361f8 + 0x28);
    *(int *)(((int)this) + 0xcf8) = iVar9;
    uVar11 = *(undefined4 *)(iVar9 + 0x814);
    *(undefined4 *)(((int)this) + 0xcc0) = uVar11;
    *(undefined4 *)(((int)this) + 0xcc4) = uVar11;
    FUN_00426110();
    iVar9 = *(int *)(*(int *)(((int)this) + 0xcf8) + 0x3c);
    *(char *)(iVar9 + 0x1b) = *(char *)(iVar9 + 0x1b) + '\x01';
    pvVar5 = _malloc(0x1000);
    *(void **)(((int)this) + 0x54) = pvVar5;
    pvVar5 = _malloc(0xa0);
    *(void **)(((int)this) + 0x4c) = pvVar5;
    pvVar5 = _malloc(0x430);
    if (pvVar5 == (void *)0x0) {
      puVar6 = (undefined4 *)0x0;
    }
    else {
      puVar6 = (undefined4 *)FUN_00464860(*(undefined4 *)(*(int *)(((int)this) + 0xcf8) + 0x20));
    }
    *(undefined4 **)(((int)this) + 0x50) = puVar6;
    puVar10 = (undefined4 *)(*(int *)(((int)this) + 0xcf8) + 0x40);
    for (iVar9 = 0x10c; iVar9 != 0; iVar9 = iVar9 + -1) {
      *puVar6 = *puVar10;
      puVar10 = puVar10 + 1;
      puVar6 = puVar6 + 1;
    }
...
LAB_00481c93:
  ...
  *(int *)(((int)this) + 0xcb8) = param_2;
  ...
  if (2 < param_2) {
    *(undefined4 *)(((int)this) + 0xcc8) = *(undefined4 *)(((int)this) + 0xcc0);
    fVar3 = _DAT_006cc79c;
    if (iVar9 != 0) {
      fVar3 = _DAT_006ccd98;
    }
    uVar7 = *(int *)(((int)this) + 0xcb4) + iVar9;
    uVar2 = *(uint *)(((int)this) + 0xcb0);
    ...
    fVar4 = DAT_007372b0;
    if (SBORROW4(uVar8,uVar2) != ((int)uVar7 <= (int)uVar2 && (int)(uVar7 - uVar2) < 0)) {
      fVar4 = *(float *)(uVar8 * 0x4c + 0xd8 + ((int)this));
    }
    *(float *)(((int)this) + 0xcc0) = fVar4 + fVar3;
  }
  switch(param_2) {
  case 0:
    FUN_00426110();
    ...
    if (cVar1 != '\0') {
      *(char *)(iVar9 + 0x1b) = cVar1 + -1;
    }
    if (*(float *)(((int)this) + 0xcc0) == *(float *)(((int)this) + 0xcc4)) {
      FUN_00427e60(*(undefined4 *)(*(int *)(((int)this) + 0x50) + 0x390),0);
    ...
    *(undefined4 *)(((int)this) + 0x50) = 0;
    return;
  case 1:
    FUN_00574020(0x60,&LAB_00482850,0);
    FUN_00574020(0x22,&LAB_00482850,0);
    FUN_00574020(0x23,&LAB_00482850,0);
    FUN_00574020(0x24,&LAB_00482850,0);
    FUN_00574020(0x25,&LAB_00482850,0);
    FUN_00574020(9,&LAB_00482850,0);
    FUN_00574020(10,&LAB_00482850,0);
    FUN_00574020(0xc,&LAB_00482850,0);
    FUN_00574020(0xb,&LAB_00482850,0);
    FUN_00574020(0x16,0,0);
    return;
  case 2:
    FUN_00574020(0x22,&LAB_00482850,0);
    FUN_00574020(0x23,&LAB_00482850,0);
  ...
  case 6:
    ...
    FUN_004819d0();
    FUN_00480120();
    *(undefined1 *)(((int)this) + 0xd08) = 1;
    FUN_00574020(9,&LAB_00482850,0);
    FUN_00574020(0xb,&LAB_00482850,0);
    FUN_00574020(0x23,0,0);
    FUN_00574020(0x22,0,0);
    FUN_00574020(0x24,0,0);
    FUN_00574020(0x25,0,0);
    FUN_00574020(0x53,0,0);
    FUN_00574020(0x52,0,0);
    FUN_00574020(0x58,0,0);
    FUN_00574020(0x59,0,0);
    FUN_00574020(0x5e,0,0);
    FUN_00574020(0x5f,0,0);
    FUN_00574020(0x60,0,0);
    FUN_00574020(0x61,0,0);
    FUN_00574020(0x16,&LAB_00482850,0);
  default:
    return;
  }
  FUN_00574020(uVar11,&LAB_00482850,0);
  FUN_00574020(10,&LAB_00482850,0);
  FUN_00574020(0xc,&LAB_00482850,0);
  FUN_00574020(9,&LAB_00482850,0);
  FUN_00574020(0x16,0,0);
