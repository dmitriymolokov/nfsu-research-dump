/* spd-match: far pct=14.04 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_004BEB80 */
...
void __fastcall FUN_004beb80(int param_1)

{
  int iVar1;
  
  FUN_004f68c0(0x20,"%s%1d",param_1 + 0x21d,*(undefined4 *)(param_1 + 0x198));
  iVar1 = FUN_0059fb80();
  if (iVar1 == 0) {
    iVar1 = FUN_0059fb80();
  }
  FUN_004f67f0(iVar1);
  FUN_004f68c0(0x20,"OptionData_%1d",*(undefined4 *)(param_1 + 0x198));
  if ((DAT_0078a344 == '\0') && (DAT_007361a8 == 0)) {
    iVar1 = FUN_004cd610();
    if (((&DAT_0078a386)[iVar1 * 0x38] != '\0') &&
       (iVar1 = FUN_004cd610(), (&DAT_0078a386)[iVar1 * 0x38] != '\x01')) {
      return;
    }
  }
  else if ((DAT_007361ac != 2) && ((DAT_007361ac != 1 && (DAT_007361ac != 0)))) {
    return;
  }
  iVar1 = FUN_0059fb80();
  if (iVar1 == 0) {
