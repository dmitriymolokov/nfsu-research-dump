/* spd-match: far pct=9.45 flags=/O1 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_00446730 */
...
int __cdecl FUN_0040c910();
int __cdecl FUN_005437f0();
extern unsigned char *DAT_007355b4;
extern int DAT_007355b8;
extern int DAT_007355c4;
extern unsigned char *DAT_007355c8;
extern unsigned char *DAT_00736140;
extern int DAT_0078bcc0;
extern int DAT_0078ea40;
extern void LAB_0044685a(void);

void __fastcall FUN_00446730(int param_2, int param_3)

{
  ...
  piVar1 = (int *)(param_2 + 0x820);
  if (0 < *piVar1) {
    while (*(int *)(param_2 + 0x80) != param_3) {
      iVar4 = iVar4 + 1;
    ...
    if (puVar5 < *(uint **)(param_2 + 0x8c)) {
      do {
        uVar8 = DAT_007355b4;
        DAT_00736140 = *puVar5 & 0xfffffffc;
        puVar7 = (undefined *)puVar5[1];
        if (puVar7 == (undefined *)0x0) {
          uVar8 = *(uint *)(param_3 + 0x54);
          puVar7 = &DAT_0078bcc0;
LAB_0044685a:
          FUN_0040c910(param_3,DAT_00736140,puVar7,uVar8,0);
        }
        else {
          if ((*(int *)(DAT_00736140 + 0xc) == 0) ||
             ((*(byte *)(*(int *)(DAT_00736140 + 0xc) + 0xe) & 0x40) == 0)) {
            uVar8 = 0;
            goto LAB_0044685a;
          }
          uVar2 = DAT_007355b4 + 0x1c0;
          if (uVar2 < DAT_007355b8) {
            bVar6 = DAT_007355b4 != 0;
            DAT_007355b4 = uVar2;
            if (bVar6) {
              FUN_005437f0(uVar8,puVar7,&DAT_0078ea40,iVar3 + 0x40,param_3);
              puVar7 = (undefined *)puVar5[1];
              goto LAB_0044685a;
            }
          }
          else {
            DAT_007355c8 = DAT_007355c8 + 0x1c0;
            DAT_007355c4 = 1;
          }
        }
        *(undefined2 *)(puVar5[2] + 0x2e) = 0;
        DAT_00736140 = 0;
        puVar5 = puVar5 + 3;
      } while (puVar5 < *(uint **)(param_2 + 0x8c));
    }
  }
  return;
}
