/* spd-match: far pct=14.58 flags=/Og /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_00464660 */
...
void __fastcall FUN_00464660(int obj, float param_1, float * esi_obj)

{
  ...
  fVar1 = param_1 * *(float *)(obj + 0x24);
  fVar2 = fVar1 + *(float *)(obj + 0x20);
  FUN_0059d350(&local_20,
               (fVar1 * ((int)_DAT_006cc7dc) + *(float *)(obj + 0x20)) * param_1 +
               *(float *)(obj + 0x1c),1);
  *esi_obj = local_20 * fVar2;
  esi_obj[1] = local_1c * fVar2;
  esi_obj[2] = local_18 * fVar2;
  return;
}
