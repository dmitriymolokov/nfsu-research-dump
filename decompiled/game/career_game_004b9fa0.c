/* spd-match: far pct=11.11 flags=/Ob2 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_004B9FA0 */
...
undefined1 __fastcall FUN_004b9fa0(int obj)

{
  char cVar1;

  if (DAT_00735e74 == 0) {
    cVar1 = FUN_0059e510(*(undefined4 *)(obj + 0x18));
    if (cVar1 == '\0') {
      return *(undefined1 *)(obj + 0x10);
    }
  }
  return 0;
}
