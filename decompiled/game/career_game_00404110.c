/* spd-match: far pct=5.45 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m375_10/buckets/p10_04110/attempt2_c2100_fix */
  ...
  if (piVar7 != param_1) {
    ...
    if (puVar15 != puStack_15c) {
      do {
        ...
        fVar16 = (float)(unsigned int)puVar15[4];
...
LAB_004042e1:
          ...
          fStack_140 = _DAT_006cc7bc / *(float *)(unsigned int)(iVar8 + 0x38);
          if ((iVar13 != 0) && ((iStack_170 == 0 || (puVar15[3] == iStack_170)))) {
            puStack_200 = (undefined *)0x404320;
            FUN_0040e6d0();
            puStack_200 = &DAT_0078bcc0;
            pfStack_204 = (float *)(unsigned int)0x404330;
            FUN_00410400();
            pfStack_208 = (float *)(unsigned int)0x40433a;
            pfStack_204 = (float *)(unsigned int)iVar13;
            FUN_0040f3d0();
            ...
            puStack_168 = (undefined4 *)(unsigned int)((((int)_DAT_006cc7bc) / (float)(1 << (bVar2 & 0x1f))));
            pfStack_210 = (float *)(unsigned int)((undefined4 *)(unsigned int)(&DAT_00718738))[(int)(unsigned int)DAT_007187b4];
            pfStack_204 = (float *)(unsigned int)&stack0xfffffe10;
            pfStack_208 = (float *)(unsigned int)0x0;
            fStack_20c = 0.0;
            fVar16 = ((int)_DAT_006cc7bc) / (float)(1 << (*(byte *)(iVar8 + 0x1a) & 0x1f));
            ...
            if (puStack_1f8 != puStack_168) {
              do {
                ...
                puStack_200 = (undefined *)(unsigned int)(((int)_DAT_006cc7bc) -
                              (float)(int)*(short *)(puStack_1f8 + 2) * ((int)_DAT_006cc8e4) * fStack_154);
                fStack_1cc = (float)(unsigned int)puStack_1f8[5];
                fStack_1c8 = (float)(unsigned int)puStack_1f8[6];
                fStack_1d0 = (float)(unsigned int)puStack_1f8[4];
                ...
                if (iVar8 != 0) {
                  ...
                  *pfStack_204 = fStack_1b0 + fStack_1a0 + fStack_1d0;
                  ...
                  iVar13 = iVar13 + 1;
                  if (iVar13 == 300) {
                    piStack_214 = (int *)((undefined4 *)(unsigned int)(&DAT_00718738))[(int)(unsigned int)DAT_007187b4];
                    pfStack_218 = (float *)(unsigned int)0x404856;
                    (**(code **)(*piStack_214 + 0x30))();
                    puStack_220 = (undefined4 *)((undefined4 *)(unsigned int)(&DAT_00718738))[(int)(unsigned int)DAT_007187b4];
                    pfStack_218 = (float *)(unsigned int)0x18;
                    pfStack_21c = (float *)(unsigned int)0x0;
                    pfStack_224 = (float *)(unsigned int)0x0;
                    pfStack_228 = pfVar6;
                    ...
                    uStack_238 = 0x1b;
                    pfStack_23c = pfVar6;
                    pfStack_240 = (float *)(unsigned int)0x40488e;
                    (**(code **)((int)*pfVar6 + 0xe4))();
                    pfStack_240 = (float *)(unsigned int)0x258;
                    uStack_244 = 0;
                    uStack_248 = 0x4b0;
                    uStack_24c = 0;
                    (**(code **)((int)*pfVar6 + 0x148))(pfVar6,4,0);
                    DAT_007187b4 = (((int)DAT_007187b4) + 1) % 0x1e;
                    (**(code **)(*(int *)((undefined4 *)(unsigned int)(&DAT_00718738))[(int)(unsigned int)DAT_007187b4] + 0x2c))
                              ((int *)((undefined4 *)(unsigned int)(&DAT_00718738))[(int)(unsigned int)DAT_007187b4],0,0,&uStack_24c,0);
                    iVar13 = 0;
                  }
                }
            ...
            piStack_214 = (int *)((undefined4 *)(unsigned int)(&DAT_00718738))[(int)(unsigned int)DAT_007187b4];
            pfStack_218 = (float *)(unsigned int)0x404906;
            (**(code **)(*piStack_214 + 0x30))();
            fVar16 = fStack_1c0;
            if (iVar13 != 0) {
              pfStack_208 = (float *)(unsigned int)((undefined4 *)(unsigned int)(&DAT_00718738))[(int)(unsigned int)DAT_007187b4];
              puStack_200 = (undefined *)0x18;
              pfStack_204 = (float *)(unsigned int)0x0;
              fStack_20c = 0.0;
              pfStack_210 = pfVar6;
              ...
              pfStack_218 = pfVar6;
              pfStack_21c = (float *)(unsigned int)0x404935;
              (**(code **)((int)*pfVar6 + 0x1a0))();
              pfStack_21c = (float *)(unsigned int)0x1;
              puStack_220 = (undefined4 *)0x1b;
              pfStack_224 = pfVar6;
              pfStack_228 = (float *)(unsigned int)0x404942;
              (**(code **)((int)*pfVar6 + 0xe4))();
              pfStack_228 = (float *)(unsigned int)(iVar13 * 2);
              piStack_22c = (int *)0x0;
              pfStack_230 = (float *)(unsigned int)(iVar13 * 4);
              ppfStack_234 = (float **)0x0;
              uStack_238 = 0;
              pfStack_23c = (float *)(unsigned int)0x4;
              pfStack_240 = pfVar6;
              uStack_244 = 0x40495f;
...
LAB_00404987:
    ...
    pfStack_204 = (float *)(unsigned int)0xe;
