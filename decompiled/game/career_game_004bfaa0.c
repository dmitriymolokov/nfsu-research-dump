/* spd-match: far pct=11.96 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_004BFAA0 */
...
void __fastcall FUN_004bfaa0(int param_1)

{
  ...
  iVar2 = (&DAT_007361b4)[uVar1];
  FUN_004f68c0(0x20,"%s%1d",param_1 + 0x21d,*(undefined4 *)(param_1 + 0x1c4));
  iVar3 = FUN_0059fb80();
  if (iVar3 == 0) {
    iVar3 = FUN_0059fb80();
  }
  FUN_004f67f0(iVar3);
  FUN_004f68c0(0x20,"OptionData_%1d",*(undefined4 *)(param_1 + 0x1c4));
  switch(*(undefined1 *)(iVar2 + 0x26)) {
  case 0:
    break;
  case 1:
    break;
