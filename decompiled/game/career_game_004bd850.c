/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=m36_pass_b source=m36_pass_b/va_004BD850 */
...
void __cdecl FUN_004f7b50(void);

void __fastcall FUN_004bd850(undefined4 *param_1)

{
  undefined4 *lab;
  lab = (undefined4 *)0x006cbe74;
  *param_1 = (undefined4 *)0x006c56c8;
  param_1[0x4c] = lab;
  param_1[0x40] = lab;
  param_1[0x34] = lab;
  param_1[0x28] = lab;
