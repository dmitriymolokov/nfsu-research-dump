/* spd-match: far pct=4.41 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_004733A0 */
...
void __fastcall FUN_004733a0(undefined4 param_1,undefined4 *param_2,undefined4 *param_3, int obj)
