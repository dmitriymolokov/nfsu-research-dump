/* spd-match: far pct=12.50 flags=/Og /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_004ABE90 */
...
int __cdecl FUN_004abfc0();
int __cdecl FUN_004ac750();
extern int DAT_00777b4c;
void __fastcall FUN_004abe90(undefined4 * obj, int * esi)

{
  ...
  iVar1 = FUN_004abfc0(esi,*obj);
  if (DAT_00777b4c == 8) {
    esi[1] = *(int *)(iVar1 + 0x344);
  }
  else {
    *esi = *(int *)(iVar1 + 0x344);
  }
  ...
  if (0 < esi[0x1876]) {
    ...
    if (esi + iVar2 * 0xd2 + 0x80e != (int *)0x0) {
      FUN_004ac750(esi + iVar2 * 0xd2 + 0x80e,obj);
    }
  }
  return;
}
