/* spd-match: far pct=13.43 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_004AB570 */
...
int __cdecl FUN_004ac820();
int __cdecl FUN_004ac820();
void __cdecl FUN_004ab570(int obj)

{
  ...
  if (obj != -0x1f5fc) {
    iVar1 = *(int *)(obj + 0x257d4);
    iVar3 = 0;
    if (0 < iVar1) {
      iVar4 = obj + 0x21634;
      do {
        if ((iVar3 < 0) || (iVar2 = iVar4, 0x13 < iVar3)) {
          iVar2 = 0;
        }
        FUN_004ac820(iVar2);
        iVar3 = iVar3 + 1;
