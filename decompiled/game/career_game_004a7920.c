/* spd-match: far pct=20.59 flags=/O1 /Gr /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_004A7920 */
/* Pass A — minimal Ghidra → MSVC6 typedefs (not from speed.exe) */
/* M4.1.2: unaff_EDI → __fastcall 1st arg (unaff_2nd; sync only on uplift). */
...
extern unsigned char *DAT_00735710;
extern int DAT_0073ad34;

void __fastcall FUN_004a7920(int obj, undefined4 param_1)

{
  ...
  if ((*(uint *)(obj + 0x18) & *(uint *)(obj + 0x10)) != 0 ||
    ...
    *(undefined1 *)(obj + 0xad) = 1;
    *(undefined4 *)(obj + 0xb0) = DAT_0073ad34;
    iVar1 = *(int *)(obj + 0x88);
    if (iVar1 != 0) {
      *(uint *)(iVar1 + 0x1c) = *(uint *)(iVar1 + 0x1c) | 0x400000;
      *(undefined4 *)(iVar1 + 0x5c) = param_1;
      if (DAT_00735710 != (undefined4 *)0x0) {
        (**(code **)*DAT_00735710)(iVar1);
      }
      *(uint *)(iVar1 + 0x1c) = *(uint *)(iVar1 + 0x1c) & 0xfffffffd | 0x400000;
    }
    FUN_004f6970(*(undefined4 *)(obj + 0x88));
  }
  return;
}
