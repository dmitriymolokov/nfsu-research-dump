/* spd-match: far pct=18.92 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_00494890 */
...
int __cdecl FUN_0048edf0();

void __fastcall FUN_00494890(int * obj)
