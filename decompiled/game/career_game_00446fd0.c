/* spd-match: far pct=8.11 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_00446FD0 */
...
int __cdecl FUN_005679b0();
int __cdecl FUN_005679b0();
int * __cdecl FUN_00446fd0(int obj)

{
  ...
  while( true ) {
    ...
    cVar4 = FUN_005679b0(piVar1[3] + 0xc,(int)*(short *)(piVar1[3] + 10));
    if (cVar4 != '\0') break;
    piVar1 = (int *)*piVar1;
  }
  iVar2 = *piVar1;
