/* spd-match: matched pct=100.00 flags=/O2 /c /nologo /TC method=pass_a_tc source=reports/m3_bad_signature_fastcall */
...
undefined4 __fastcall FUN_00487d70(int param_1)

{
  if ((*(int *)(param_1 + 0x2c) != 1) &&
     ((*(int *)(param_1 + 0x2c) != 2 || (*(float *)(param_1 + 0x18c) < *(float *)(param_1 + 400)))))
  {
    return 0;
  }
  return 1;
