/* spd-match: far pct=4.50 flags=/O1 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.5/va_005032C0 */
...
int unaff_EDI;
uint __fastcall FUN_005032c0(uint val)

{
  ...
  while( true ) {
    ...
    if (((uint)puVar1[5] <= val) && (val < (uint)*(ushort *)(puVar1 + 3) * 0x20 + puVar1[5]))
    break;
    puVar1 = (undefined4 *)puVar1[1];
  }
  uVar2 = (ulonglong)(val - puVar1[5]) / (ulonglong)*(ushort *)(puVar1 + 3);
  *(short *)((int)puVar1 + 0xe) = *(short *)((int)puVar1 + 0xe) + -1;
  uVar3 = (undefined3)(uVar2 >> 8);
  uVar4 = (uint)uVar2 >> 3;
  *(byte *)(uVar4 + 0x10 + (int)puVar1) =
       *(byte *)(uVar4 + 0x10 + (int)puVar1) & ~('\x01' << ((byte)uVar2 & 7));
