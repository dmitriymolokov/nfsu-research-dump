/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_00688010 */
...
void __fastcall FUN_00589240(undefined4 *);

void FUN_00688010(undefined4 *p)
{
  FUN_00589240(p);
}
