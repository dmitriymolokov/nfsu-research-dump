/* spd-match: far pct=5.08 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_004FC640 */
...
/* M4.1.3: FUN_00674898 → __stdcall (callee_stdcall). */
...
int __cdecl FUN_004fbfc0();
int __cdecl FUN_004fc070();
int __cdecl FUN_00564b10();
int __cdecl FUN_00564cd0();
int __stdcall FUN_00674898(void);
...
void __fastcall FUN_004fc640(float *param_1)

{
  ...
  fVar4 = param_1[1] * unaff_ESI[1] +
          param_1[3] * unaff_ESI[3] + param_1[2] * unaff_ESI[2] + *param_1 * *unaff_ESI;
  if (fVar4 < DAT_006cc7a4) {
    fVar4 = -fVar4;
  }
  if (_DAT_006cc96c <= fVar4) {
    FUN_004fc070();
  }
  else {
    sVar1 = FUN_00564cd0(fVar4);
    fVar4 = (float)(ushort)(0x4000 - sVar1) * _DAT_006cc980;
    FUN_00674898();
    fVar3 = (float10)FUN_00564b10();
    FUN_00674898((float)fVar3,fVar4);
    FUN_00564b10();
    FUN_00674898();
    FUN_00564b10();
  }
  puVar2 = (undefined4 *)FUN_004fbfc0();
  *unaff_EDI = *puVar2;
  unaff_EDI[1] = puVar2[1];
  unaff_EDI[2] = puVar2[2];
  unaff_EDI[3] = puVar2[3];
  return;
}
