/* spd-match: close pct=92.31 flags=/O1 /c /nologo /TC method=m4_13_fc_wrapper_thiscall source=m4_13/4.1.3/va_004DD690 */
...
/* M4.1.3: FUN_004dd6a0 → __stdcall (callee_stdcall). */
...
int __stdcall FUN_004dd6a0(int arg);

undefined4 __fastcall FUN_004dd690(undefined4 head)
