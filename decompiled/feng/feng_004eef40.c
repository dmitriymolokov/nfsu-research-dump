/* spd-match: far pct=35.63 flags=/Og /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_004EEF40 */
...
void __fastcall FUN_004eef40(int obj, int param_2)

{
  ...
  if (obj != 0) {
    ...
    if (*(int *)(param_2 + 0xf8) == iVar1) {
      *(int *)(param_2 + 0xf8) = obj;
    }
