/* spd-match: matched pct=100.00 flags=/O2 /c /nologo /TC method=pass_a_tc source=reports/m3_needs_data_leaf2 */
...
undefined4 FUN_0050fa10(void)

{
  if ((*(int *)0x00735718 == 3) && (*(int *)0x006f88a4 == 0xb)) {
    return 1;
  }
  return 0;
}
