/* spd-match: far pct=15.38 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...

{
  ...
  iVar1 = FUN_006767f9(&local_24,_Format,&stack0x0000000c);
  return iVar1;
}
