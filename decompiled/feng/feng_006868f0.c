/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_006868F0 */
...
void __fastcall FUN_00436fe0(undefined4 *);

void FUN_006868f0(undefined4 *p)
{
  FUN_00436fe0(p);
}
