/* spd-match: far pct=16.25 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_004C0490 */
...
void __fastcall FUN_004c0490(int param_1)

{
  FUN_004f68c0(0x20,"%s%1d",param_1 + 0x21d,*(undefined4 *)(param_1 + 0x1e0));
  FUN_004f67f0("Super Easy AI");
  FUN_004f68c0(0x20,"OptionData_%1d",*(undefined4 *)(param_1 + 0x1e0));
  FUN_004f67f0(&DAT_006ca778,DAT_007360b8);
  return;
}
