/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_00686040 */
...
void __fastcall FUN_0044a170(undefined4 *);

void FUN_00686040(undefined4 *p)
{
  FUN_0044a170(p);
}
