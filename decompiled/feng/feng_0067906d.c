/* spd-match: far pct=5.00 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...

{
  ...
  do {
    ...
    if (dwBytes < 0xffffffe1) {
      if ((DAT_00793220 == 3) && (dwBytes = dwBytes + 0xf & 0xfffffff0, _Size_00 <= DAT_0079320c)) {
        __lock(4);
...
LAB_006790e2:
      ...
      _Dst = HeapAlloc(DAT_0079321c,8,dwBytes);
    }
    if (_Dst != (void *)0x0) {
      return _Dst;
    }
