/* spd-match: far pct=17.39 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m375_p3/buckets/typed_residual_tok_p2/batches/20260724T142426Z_w0_tc0 */
...
int __cdecl FUN_00696e80();
extern int DAT_0071201c;

void __cdecl _dynamic_initializer_for__afxGlobalUtils__(void)

{
  ((void (*)(unsigned char *))0)((unsigned char *)&DAT_0071201c);
  _atexit(FUN_00696e80);
  return;
}
