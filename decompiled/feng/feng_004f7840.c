/* spd-match: far pct=13.64 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_004F7840 */
...
undefined4 __fastcall FUN_004f7840(char * obj)

{
  ...
  iVar2 = 0;
  do {
    iVar1 = __stricmp(obj,*(char **)(iVar2 * 8 + 0x6f90d8));
    if (iVar1 == 0) {
      return *(undefined4 *)(iVar2 * 8 + 0x6f90dc);
    }
    iVar2 = iVar2 + 1;
  } while (iVar2 < 0x2a);
  return 0xffffffff;
