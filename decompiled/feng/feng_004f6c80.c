/* spd-match: far pct=18.75 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_004F6C80 */
/* Pass A — minimal Ghidra → MSVC6 typedefs (not from speed.exe) */
/* M4.1.2: unaff_EDI → __fastcall 2nd arg (unaff_2nd; sync only on uplift). */
...
extern void LAB_004f6c9d(void);
extern void LAB_004f6cd8(void);
int __cdecl FUN_004ef050();
int __cdecl FUN_004f65d0();
int __cdecl FUN_004ffb70();
int __cdecl FUN_00567d30();
...
extern void LAB_004f6c9d(void);
extern void LAB_004f6cd8(void);
uint __fastcall FUN_004f6c80(int val, undefined4 edi)
...
LAB_004f6c9d:
    uVar2 = 0;
    if (DAT_0073578c == 0) goto LAB_004f6cd8;
    uVar2 = FUN_004ef050(edi);
    if (uVar2 == 0) goto LAB_004f6cd8;
  }
  else {
    iVar1 = FUN_004f65d0();
    if (iVar1 == 0) goto LAB_004f6c9d;
    uVar2 = FUN_004ffb70();
    if (uVar2 == 0) goto LAB_004f6c9d;
  }
  iVar1 = *(int *)(uVar2 + 0x54);
  if (iVar1 != 0) {
    uVar2 = FUN_00567d30();
    if ((uVar2 == 0) && (uVar2 = *(uint *)(iVar1 + 0x10), (int)uVar2 <= *(int *)(iVar1 + 0xc))) {
