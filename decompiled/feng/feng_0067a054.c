/* spd-match: far pct=3.45 flags=/O1 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.51-arity/va_0067A054 */
...
int unaff_EDI;
void __fastcall __shift(char * obj)

{
  ...
  if (unaff_EDI != 0) {
    sVar1 = _strlen(obj);
    _memmove(obj + unaff_EDI,obj,sVar1 + 1);
  }
  return;
}
