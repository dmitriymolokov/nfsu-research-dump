/* spd-match: far pct=37.68 flags=/Og /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_005007D0 */
...
void __fastcall FUN_005007d0(int obj, int param_2)

{
  ...
  if (obj != 0) {
    ...
    if (*(int *)(param_2 + 0x54) == iVar1) {
      *(int *)(param_2 + 0x54) = obj;
    }
