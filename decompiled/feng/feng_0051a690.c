/* spd-match: far pct=6.25 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_0051A690 */
...
extern int DAT_00735708;

void __fastcall FUN_0051a690(int * obj)
