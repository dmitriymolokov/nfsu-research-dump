/* spd-match: far pct=10.00 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_005043F0 */
...
int __cdecl FUN_0040a880();
void __cdecl FUN_005043f0(int * obj, int param_1)

{
  ...
  if (piVar3 != obj) {
    ...
    while (_Memory = piVar3, _Memory != piVar5) {
      pcVar6 = (char *)_Memory[2];
      piVar3 = (int *)*_Memory;
      iVar7 = param_1 - (int)pcVar6;
      do {
        cVar1 = pcVar6[iVar7];
        cVar2 = *pcVar6;
        pcVar6 = pcVar6 + 1;
