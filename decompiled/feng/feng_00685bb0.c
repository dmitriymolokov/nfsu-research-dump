/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_00685BB0 */
...
void __fastcall FUN_0047dc10(undefined4 *);

void FUN_00685bb0(undefined4 *p)
{
  FUN_0047dc10(p);
}
