/* spd-match: far pct=16.25 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_004C03B0 */
...
void __fastcall FUN_004c03b0(int param_1)

{
  FUN_004f68c0(0x20,"%s%1d",param_1 + 0x21d,*(undefined4 *)(param_1 + 0x1d8));
  FUN_004f67f0("Display Debug Info");
  FUN_004f68c0(0x20,"OptionData_%1d",*(undefined4 *)(param_1 + 0x1d8));
  FUN_004f67f0(&DAT_006ca778,DAT_00734964);
  return;
}
