/* spd-match: far pct=5.53 flags=/O1 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.5/va_004F3A00 */
...
int __cdecl FUN_004f3940();
int __cdecl FUN_004f3c40();
int __cdecl FUN_004fd230();
int __cdecl FUN_00575940();
extern unsigned char *PTR_FUN_006c1eac;
extern void LAB_004f3a89(void);
undefined4 * __fastcall FUN_004f3a00(int * obj, undefined4 *param_1)

{
  ...
  *(undefined2 *)(param_1 + 7) = 0;
  ...
  iVar2 = 0;
LAB_004f3a89:
  FUN_00575940("Load Package[%x]\n",iVar2);
  if (*(int *)param_1[4] == 0x30203) {
    piVar1 = (int *)FUN_004f3c40();
    if (((*piVar1 == -0x1891baba) && (piVar1[2] == 0x64486b50)) && (0x1ffff < (uint)piVar1[4])) {
      FUN_004fd230();
      uVar3 = FUN_004f3940();
