/* spd-match: far pct=38.89 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_c2146 */
...
void __cdecl __initptd(m375_ptiddata _Ptd,pthreadlocinfo _Locale)

{
  _Ptd->_initaddr = &DAT_006eb7b8;
  _Ptd->_holdrand = 1;
  return;
}
