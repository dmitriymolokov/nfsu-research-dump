/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_00685B20 */
...
void __fastcall FUN_00483550(undefined4 *);

void FUN_00685b20(undefined4 *p)
{
  FUN_00483550(p);
}
