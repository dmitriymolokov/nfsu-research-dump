/* spd-match: far pct=9.80 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_004D5DA0 */
...
int __cdecl FUN_0051c720();
extern int DAT_006f1dd8;
extern unsigned char *DAT_007356a8;

void __fastcall FUN_004d5da0(int obj)
