/* spd-match: far pct=17.86 flags=/O2 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.51-arity/va_00680DE2 */
...
size_t __fastcall _strncnt(char * obj, char *_String, size_t _Cnt)

{
  char *pcVar1;

  pcVar1 = _String;
  for (; (pcVar1 != (char *)0x0 && (*obj != '\0')); obj = obj + 1) {
    pcVar1 = pcVar1 + -1;
  }
