/* spd-match: far pct=75.00 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
int __cdecl FUN_00672dd0();
int __cdecl FUN_00679546();
extern int DAT_00717ad4;

void FUN_00672e08(void)

{
  FUN_00672dd0();
  DAT_00717ad4 = __ms_p5_mp_test_fdiv();
  FUN_00679546();
  return;
}
