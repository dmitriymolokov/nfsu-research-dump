/* spd-match: far pct=11.69 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_004C4F00 */
...
extern int DAT_00735dc8;
extern int DAT_00746104;
void __cdecl FUN_004c4f00(int obj)

{
  ...
  iVar1 = DAT_0073578c;
  DAT_00735dc8 = **(undefined4 **)(*(int *)(obj + 0x4c) + 8);
  if (DAT_0073578c != 0) {
    if ((*(int *)(obj + 0xc) == 0) || (iVar2 = FUN_004f3f90(&DAT_00746104), iVar2 == 0)) {
      uVar3 = 0;
    }
    else {
