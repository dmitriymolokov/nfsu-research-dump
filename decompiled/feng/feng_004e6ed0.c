/* spd-match: far pct=27.50 flags=/O2 /c /nologo /TC method=m39 source=m39/4.1.5/va_004E6ED0 */
...
unsigned int __cdecl FUN_004e6ed0(void)

{
  ...
  if (iVar1 != 0) {
    uVar2 = (unsigned int)*(int *)(iVar1 + 0x18);
    return (uVar2 & 0xffffff00U) | (uVar2 != 0);
  }
  return 0;
}
