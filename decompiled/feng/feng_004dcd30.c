/* spd-match: far pct=27.38 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_004DCD30 */
...
void __fastcall FUN_004dcd30(undefined4 * obj, undefined4 param_1, int esi_obj)

{

  
  *(undefined4 *)(esi_obj + 0x4c) = param_1;
  *(undefined4 *)(esi_obj + 0x50) = *obj;
  *(undefined4 *)(esi_obj + 0x54) = obj[1];
  *(undefined4 *)(esi_obj + 0x58) = obj[2];
  *(undefined4 *)(esi_obj + 0x5c) = obj[3];
  if (*(int *)(esi_obj + 0x44) == 0) {
    FUN_00495f00(*(undefined4 *)(esi_obj + 0x50));
  }
  else {
    FUN_004f6850(*(int *)(esi_obj + 0x44));
  }
  FUN_00495f00(*(undefined4 *)(esi_obj + 0x54));
  if (DAT_0073578c != 0) {
