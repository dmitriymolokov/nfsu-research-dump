/* spd-match: far pct=17.62 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
undefined4 FUN_00673e7f(char *param_1,char *param_2)

{
  ...
  if (*param_2 != '\0') {
    ...
    FUN_0067e1d0(param_1 + 0x80,param_2 + 1);
  }
  return 0;
}
