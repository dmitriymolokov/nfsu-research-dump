/* spd-match: close pct=93.02 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m375_inventory/batches/20260724T084420Z_w0_tc0 */
...

{
  ...
  if (_Src != (char *)0x0) {
    ...
    if (pvVar2 != (void *)0x0) {
      pcVar3 = (char *)FUN_0067e1d0(pvVar2,_Src);
      return pcVar3;
    }
  }
  return (char *)0x0;
