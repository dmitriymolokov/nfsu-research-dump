/* spd-match: far pct=21.54 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_004F68C0 */
...
int __cdecl FUN_00565df0();
extern int DAT_007304b8;
extern int DAT_007304bc;
extern unsigned char *DAT_00730508;
extern void LAB_005669d0(void);
extern void LAB_005669f0(void);
extern char stack0x0000000c;

void __fastcall FUN_004f68c0(undefined1 * obj, undefined4 param_1,undefined4 param_2)

{
  ...
  DAT_00730508 = obj;
  iVar1 = FUN_00565df0(0,param_2,&stack0x0000000c);
  if ((obj != (undefined1 *)0x0) && (iVar1 != -1)) {
    *DAT_00730508 = 0;
  }
  return;
}
