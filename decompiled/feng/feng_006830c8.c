...
LONG lineGetID(HLINE hLine,DWORD dwAddressID,HCALL hCall,DWORD dwSelect,LPVARSTRING lpDeviceID,
...

{
  ...
  LVar1 = lineGetID(hLine,dwAddressID,hCall,dwSelect,lpDeviceID,lpszDeviceClass);
  return LVar1;
}
