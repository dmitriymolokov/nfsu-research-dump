/* spd-match: far pct=4.55 flags=/O2 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.5/va_004F6CE0 */
...
uint __fastcall FUN_004f6ce0(uint obj)

{
  int iVar1;

  if ((obj != 0) && (iVar1 = *(int *)(obj + 0x54), iVar1 != 0)) {
    obj = FUN_00567d30();
    if ((obj == 0) && (obj = *(uint *)(iVar1 + 0x10), (int)obj <= *(int *)(iVar1 + 0xc))) {
