/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_006864B0 */
...
void __fastcall FUN_004667a0(undefined4 *);

void FUN_006864b0(undefined4 *p)
{
  FUN_004667a0(p);
}
