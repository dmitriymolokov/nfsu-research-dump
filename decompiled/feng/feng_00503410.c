/* spd-match: far pct=8.92 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
extern unsigned char *PTR_FUN_006c16b4;
extern unsigned char *PTR_LAB_006c2c4c;

undefined4 * FUN_00503410(void)

{
  ...
  if (puVar2 != (undefined4 *)0x0) {
    ...
    puVar2[1] = 0xabadcafe;
    puVar2[2] = 0xabadcafe;
    *puVar2 = &PTR_FUN_006c16b4;
    puVar2[7] = 0;
    puVar2[8] = 0;
    puVar2[6] = 0;
    puVar2[5] = &PTR_LAB_006c2c4c;
    puVar6 = puVar2;
  }
  FUN_004fd180();
  FUN_00503ed0(puVar6);
  ...
  local_38[0xb] = 0;
  local_38[10] = 0;
  local_38[0xd] = 0x3f800000;
  local_38[5] = 0x3f800000;
  local_38[4] = 0x3f800000;
  local_38[3] = 0x3f800000;
  _free(*(void **)(iVar1 + 0x20));
  *(undefined4 *)(iVar1 + 0x20) = 0;
  if (*(size_t *)(iVar1 + 0x18) != 0) {
    puVar3 = _malloc(*(size_t *)(iVar1 + 0x18));
