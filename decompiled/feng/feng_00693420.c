/* spd-match: far pct=35.29 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
extern void LAB_00696d90(void);

void FUN_00693420(void)

{
  FUN_00589260();
  _atexit((_func_4879 *)&LAB_00696d90);
  return;
}
