/* spd-match: far pct=12.80 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_00675450 */
...
/* M4.1.3: FUN_006752e4 → __stdcall (callee_stdcall). */
...
int __stdcall FUN_006752e4(int a, int b);
extern int DAT_00717a9c;
extern int DAT_00717aa0;
extern int DAT_00717b10;
extern int DAT_00717c14;
extern int DAT_0079334c;
extern int _DAT_00717ab8;

undefined4 __fastcall FUN_00675450(int param_1)

{
  ...
  DAT_00717c14 = 0;
  GetModuleFileNameA((HMODULE)0x0,&DAT_00717b10,0x104);
  _DAT_00717ab8 = &DAT_00717b10;
  FUN_006752e4(0,&local_8);
  pvVar1 = _malloc(param_1 + local_8 * 4);
  if (pvVar1 == (void *)0x0) {
    uVar2 = 0xffffffff;
  }
  else {
    FUN_006752e4(pvVar1,&local_8);
    DAT_00717a9c = local_8 + -1;
    uVar2 = 0;
    DAT_00717aa0 = pvVar1;
  }
  return uVar2;
