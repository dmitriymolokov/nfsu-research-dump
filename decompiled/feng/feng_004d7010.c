/* spd-match: far pct=7.29 flags=/Og /c /nologo /TC method=m4_13_callee_stdcall_v2 source=m4_13/4.1.3/va_004D7010 */
...
/* M4.1.3-R3: FUN_004f6e10 → unified __stdcall (callee_stdcall_v2). */
...
int __stdcall FUN_004f6e10(void *a1, undefined4 a2, void *a3);
float10 __fastcall FUN_004d7010(int obj)

{
  ...
  puVar1 = *(undefined4 **)(obj + 0xc);
  local_10 = -250.0;
  for (; puVar1 != (undefined4 *)(obj + 0xc); puVar1 = (undefined4 *)*puVar1) {
    FUN_004f6e10(puVar1[2],local_4,&local_c);
    if (local_10 < local_c) {
      FUN_004f6e10(puVar1[2],local_4,&local_8);
      local_10 = local_8;
    }
  }
