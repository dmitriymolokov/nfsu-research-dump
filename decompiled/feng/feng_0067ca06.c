/* spd-match: far pct=4.02 flags=/O1 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.5/va_0067CA06 */
...
undefined4 __fastcall FUN_0067ca06(undefined4 val, undefined4 param_1, uint param_2, ushort param_3)
