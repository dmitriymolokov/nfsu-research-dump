/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_00685F80 */
...
void __fastcall FUN_00577290(undefined4 *);

void FUN_00685f80(undefined4 *p)
{
  FUN_00577290(p);
}
