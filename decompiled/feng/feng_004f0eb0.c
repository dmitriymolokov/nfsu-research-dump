/* spd-match: far pct=16.84 flags=/O2 /c /nologo /TC method=m4_13_callee_stdcall_v2 source=m4_13/4.1.3/va_004F0EB0 */
...
/* M4.1.3-R3: FUN_004fd880 → unified __stdcall (callee_stdcall_v2). */
...
int __stdcall FUN_004fd880(undefined4 a1);
undefined4 __fastcall FUN_004f0eb0(uint val)
