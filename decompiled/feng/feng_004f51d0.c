/* spd-match: far pct=5.00 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_004F51D0 */
...
void __fastcall FUN_004f51d0(undefined1 * obj, char * esi_obj)

{
  ...
  for (; (iVar6 = iVar4, iVar3 != 0 && (iVar6 = iVar3, esi_obj[iVar3] != '.')); iVar3 = iVar3 + -1
      ) {
  }
  if (iVar6 <= iVar5) {
    *obj = 0;
