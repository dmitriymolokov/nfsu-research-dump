/* spd-match: far pct=27.42 flags=/O2 /c /nologo /TC method=m4_13_callee_stdcall_v2 source=m4_13/4.1.3/va_004EC4D0 */
...
/* M4.1.3-R3: FUN_004f08f0 → unified __stdcall (callee_stdcall_v2). */
...
int __stdcall FUN_004f08f0(undefined4 a1, undefined4 a2, undefined4 a3);
int __cdecl FUN_004f3f90();
extern int DAT_0073578c;
extern int DAT_00746104;
extern int DAT_00777b60;
extern int DAT_00777b64;
extern int DAT_00777b6c;
extern int DAT_00777b70;
...
extern int DAT_00777b70;
extern int DAT_00777b74;
void __fastcall FUN_004ec4d0(undefined4 val, undefined4 param_1, int param_2, undefined4 param_3, undefined4 param_4)

{
  ...
  DAT_00777b64 = param_4;
  DAT_00777b70 = param_3;
  puVar3 = (undefined4 *)&DAT_00777b74;
  DAT_00777b60 = param_1;
  DAT_00777b6c = val;
  for (iVar2 = 0x27; iVar1 = DAT_0073578c, iVar2 != 0; iVar2 = iVar2 + -1) {
    *puVar3 = 0;
    puVar3 = puVar3 + 1;
  }
  if (DAT_0073578c != 0) {
    if (param_2 != 0) {
      ...
      if (iVar2 != 0) {
        FUN_004f08f0(*(undefined4 *)(iVar1 + 8),*(undefined4 *)(iVar2 + 0x18),0xff);
        return;
      }
    }
    FUN_004f08f0(*(undefined4 *)(iVar1 + 8),0,0xff);
  }
  return;
}
