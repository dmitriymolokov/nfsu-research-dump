/* spd-match: far pct=77.19 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m375_p3/buckets/typed_seh_crt_types/batches/20260724T142954Z_w0_tc0 */
...

{
  ...
  if (1 < (int)ptVar2->lc_category[1].refcount) {
    iVar3 = FUN_00675bd0(ptVar2,_C,8);
    return iVar3;
  }
