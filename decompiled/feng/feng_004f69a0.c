/* spd-match: far pct=39.53 flags=/O1 /c /nologo /TC method=m39 source=m39/4.1.G.2-n5/va_004F6970 */
...
void FUN_004f6970(void* p) { unsigned int* obj = (unsigned int*)p; if (!obj) return; obj[7] = (obj[7] & ~1) | 0x400000; if (obj[6] == 5) { void** curr = (void**)obj[0x18]; int count = (int)obj[0x17]; while (count > 0) { FUN_004f6970(*curr); curr = (void**)((char*)*curr + 4); count--; } } }
