/* spd-match: far pct=7.59 flags=/O1 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_004C4BE0 */
...
int __cdecl FUN_004c4c60();
int __cdecl FUN_004f8340();
int __cdecl FUN_004f8910();

void __fastcall FUN_004c4be0(int obj, int ebx)

{
  undefined4 *puVar1;

  puVar1 = *(undefined4 **)(obj + 0x4c);
  if (ebx == -0x6edfbf62) {
    if (puVar1 != *(undefined4 **)(obj + 0x44)) {
      *(undefined4 *)(obj + 0x4c) = puVar1[1];
    }
  }
  else if ((ebx == -0x4a68e40f) && (puVar1 != *(undefined4 **)(obj + 0x48))) {
    *(undefined4 *)(obj + 0x4c) = *puVar1;
  }
  if (*(undefined4 **)(obj + 0x4c) != puVar1) {
    FUN_004f8910();
    FUN_004c4c60(obj);
    if (ebx == -0x6edfbf62) {
