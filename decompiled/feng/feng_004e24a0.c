/* spd-match: far pct=11.39 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_004E24A0 */
...
extern unsigned char *DAT_00746918;

int __fastcall FUN_004e24a0(int obj, undefined4 param_1)

{
  ...
  case 4:
    break;
  default:
    goto switchD_004e24cc_default;
  }
  iVar3 = FUN_00567c70();
switchD_004e24cc_default:
  if ((obj != 0) && (*(byte *)(obj + 0x12) < 0x13)) {
    iVar3 = *(int *)(&DAT_00746918 + (uint)*(byte *)(obj + 0x12) * 4);
  }
  return iVar3;
}
