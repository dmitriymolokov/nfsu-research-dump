/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=m36_pass_b source=m36_pass_b/va_004EC3C0 */
...
void __stdcall FUN_004ebdf0(int, int);
void FUN_004ec3c0(void)

{
  if ((*(int *)0x00735da4) != 0) {
    FUN_004ebdf0((*(int *)0x00735da4),0);
  }
  return;
}
