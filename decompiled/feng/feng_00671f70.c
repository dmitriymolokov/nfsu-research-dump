/* spd-match: far pct=19.15 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m375_p3/buckets/typed_residual_tok_p1/batches/20260724T142438Z_w0_tc0 */
...

{
  ...
  if (hModule != (HMODULE)0x0) {
    ...
    if (pFVar1 != (FARPROC)0x0) {
      ((void (__stdcall *)(int))pFVar1)(param_1);
    }
  }
