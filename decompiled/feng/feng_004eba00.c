/* spd-match: far pct=22.46 flags=/O1 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.5/va_004EBA00 */
...
void __fastcall FUN_004eba00(int val, char *param_1, int param_2, undefined4 param_3)
