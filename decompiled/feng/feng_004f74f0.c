/* spd-match: far pct=1.59 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_c2111 */
...
void FUN_004f74f0(float param_1)

{
  ...
  if (unaff_ESI != 0) {
    ...
    fVar2 = *(float *)(iVar1 + 0x3c);
    switch(*(undefined4 *)(unaff_ESI + 0x18)) {
    case 1:
    case 7:
    case 9:
      iVar3 = FUN_005461c0(*(undefined4 *)(unaff_ESI + 0x24),1,0);
      param_1 = (float)(int)*(short *)(iVar3 + 0x46) * param_1;
      *(float *)(iVar1 + 0x3c) = param_1;
      break;
    case 2:
      *(float *)(iVar1 + 0x3c) = param_1;
    }
