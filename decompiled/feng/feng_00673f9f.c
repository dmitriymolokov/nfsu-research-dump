/* spd-match: far pct=20.00 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m375_p3/buckets/typed_seh_crt_types/batches/20260724T143018Z_w0_tc0 */
...
int __cdecl FUN_00673d99();
int __cdecl FUN_00673fd1();

m375_pthreadlocinfo __cdecl ___updatetlocinfo(void)

{
  m375_pthreadlocinfo ptVar1;
  
  __lock(0xc);
  ptVar1 = (m375_pthreadlocinfo)FUN_00673d99();
  FUN_00673fd1();
  return ptVar1;
}
