/* spd-match: far pct=8.67 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...

{
  ...
  iVar4 = FUN_004acce0();
  pcVar5 = (char *)(iVar4 * 0xc90 + DAT_00734588);
  if (pcVar5 == (char *)0x0) {
    return 0xffffffff;
  }
  cVar2 = *pcVar5;
  ...
  uVar7 = (undefined3)((uint)(param_1 + -2) >> 8);
  switch(param_1 + -2) {
  case 0:
  case 1:
    uVar6 = FUN_0051be00(CONCAT31(uVar7,unaff_ESI == 1));
    return uVar6 & 0xff;
  case 2:
  case 3:
    uVar6 = FUN_0051be40(CONCAT31(uVar7,unaff_ESI == 1));
    return uVar6 & 0xff;
  default:
    return 0xffffffff;
  }
