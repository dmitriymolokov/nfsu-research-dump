/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_00686510 */
...
void __fastcall FUN_0041f620(undefined4 *);

void FUN_00686510(undefined4 *p)
{
  FUN_0041f620(p);
}
