/* spd-match: far pct=7.69 flags=/O2 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.5/va_0067A193 */
...
undefined1 * __fastcall FUN_0067a193(int * obj, undefined1 *param_1, size_t param_2, char param_3)
