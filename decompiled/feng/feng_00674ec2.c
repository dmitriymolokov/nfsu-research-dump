/* spd-match: far pct=42.86 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_c2146 */
...
void __fastcall FUN_00674ec2(uintptr_t _StackCookie)

{
  if (_StackCookie == DAT_006eb720) {
    return;
  }
  report_failure();
  return;
