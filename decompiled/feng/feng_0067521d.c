/* spd-match: far pct=19.10 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
      ...
      do {
        ...
        if (*pcVar4 != '=') {
          ...
          *puVar1 = pvVar3;
          if (pvVar3 == (void *)0x0) {
            _free(DAT_00717aa8);
            DAT_00717aa8 = (undefined4 *)0x0;
            return -1;
          }
          FUN_0067e1d0(pvVar3,pcVar4);
          puVar1 = puVar1 + 1;
        }
