/* spd-match: far pct=33.93 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...

{
  ...
  iVar3 = iVar1;
  sVar2 = _strlen(_String);
  iVar1 = FUN_0067b91c(local_1c,_String,sVar2,iVar1,iVar3);
