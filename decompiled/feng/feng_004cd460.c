/* spd-match: far pct=9.09 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
extern int DAT_00746d90;

uint __fastcall FUN_004cd460(int param_1)

{
  ...
  uVar1 = 0;
  do {
    if (param_1 == (&DAT_00746d90)[uVar1]) {
      return CONCAT31((int3)(uVar1 >> 8),(&DAT_00746d90)[uVar1] != 0);
    }
    uVar1 = uVar1 + 1;
  } while ((int)uVar1 < 9);
