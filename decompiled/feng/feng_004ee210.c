/* spd-match: far pct=12.86 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_004EE210 */
...
int __cdecl FUN_004ed930();
extern unsigned char *DAT_006f8a48;
extern int DAT_006f8ae0;
void __fastcall FUN_004ee210(int obj)

{
  uint uVar1;

  *(byte *)(obj + 0x53) = *(byte *)(obj + 0x53) ^ 1;
  if (*(int *)(obj + 0x20c) != 0) {
    *(undefined1 *)(obj + 0x53) = 0;
  }
  FUN_004ed930(obj);
