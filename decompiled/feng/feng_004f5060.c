/* spd-match: far pct=18.92 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_004F5060 */
...
int __cdecl FUN_004f46b0();

void __fastcall FUN_004f5060(int * obj)
