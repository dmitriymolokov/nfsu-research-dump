/* spd-match: far pct=7.87 flags=/O1 method=thiscall_tp source=m375_sync_decomp:m375_inventory */
...
int __cdecl FUN_004ac060(...);
int __cdecl FUN_004b23b0(...);
int __cdecl FUN_004c69f0(...);
...
extern int _DAT_006faf00;

struct ThisCallBox {
  void FUN_004c6ab0(uint param_2);
};
void ThisCallBox::FUN_004c6ab0(uint param_2) {
  int iVar1;
  
  if (param_2 < 0x9120409f) {
    if (param_2 != 0x9120409e) {
      if (param_2 == 0xc407210) {
        if ((*(int *)(((int)this) + 0x88) != 0) && (*(int *)(((int)this) + 0x88) != 0x7fffffff)) {
          FUN_004b23b0(*(int *)(((int)this) + 0x48) + 0x10,1);
        }
        FUN_004ac060("MU_Garage.fng",0);
        FUN_00504990(2);
        return;
      }
    ...
    if ((float)(DAT_0073ad3c - iVar1) * _DAT_006cca38 < _DAT_006faf00) {
      return;
    }
    FUN_004b23b0(*(int *)(((int)this) + 0x48) + 0x10,1);
