/* spd-match: far pct=15.02 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
extern int DAT_006b1cb0;
extern int DAT_006eb720;
extern code *DAT_00717ee4;
extern char stack0xfffffea3;
extern char stack0xfffffec8;
int unaff_retaddr;

void FUN_0067ff4b(int param_1)

{
  ...
  local_8 = &DAT_006b1cb0;
  uStack_c = 0x67ff5a;
  local_20 = DAT_006eb720 ^ unaff_retaddr;
  if (DAT_00717ee4 == (code *)0x0) {
    if (param_1 == 1) {
      local_24 = 
    ...
    FUN_0067e1e0();
    FUN_0067e1e0();
    FUN_0067e1e0(&stack0xfffffec8);
    FUN_0067e1e0(&stack0xfffffec8,local_24);
