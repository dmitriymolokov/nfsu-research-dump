/* spd-match: far pct=13.04 flags=/O1 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_004CC770 */
...
int __cdecl FUN_004cc7c0();
extern unsigned char *DAT_00758c28;
extern unsigned char *DAT_0075eef8;
int __cdecl FUN_004cc7c0();
extern unsigned char *DAT_00758c28;
extern unsigned char *DAT_0075eef8;
void __fastcall FUN_004cc770(int val, int param_2)

{
  ...
  if ((val < 0) || (1 < val)) {
    ...
    puVar3 = &DAT_00758c28 + val * 0x3e51;
  }
  puVar2 = (undefined4 *)(param_2 + 0x364);
  for (iVar1 = 0x18b4; iVar1 != 0; iVar1 = iVar1 + -1) {
    *puVar3 = *puVar2;
    puVar2 = puVar2 + 1;
    puVar3 = puVar3 + 1;
  }
  FUN_004cc7c0(&DAT_0075eef8 + val * 0x3e51,param_2 + 0x6634);
  return;
}
