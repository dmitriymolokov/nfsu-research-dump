/* spd-match: far pct=37.68 flags=/Og /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_00500820 */
...
void __fastcall FUN_00500820(int obj, int param_2)

{
  ...
  if (obj != 0) {
    ...
    if (*(int *)(param_2 + 0x44) == iVar1) {
      *(int *)(param_2 + 0x44) = obj;
    }
