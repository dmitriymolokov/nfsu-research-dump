/* spd-match: far pct=21.05 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_004EA7A0 */
/* Pass A — minimal Ghidra → MSVC6 typedefs (not from speed.exe) */
/* M4.1.1: unaff_ESI → __fastcall typed arg (promote; sync only on uplift). */
...
int __cdecl FUN_004ea560();
int __cdecl FUN_004ea650();
extern int DAT_007681e0;
extern int DAT_007681e4;
extern int DAT_007681e8;
void __fastcall FUN_004ea7a0(undefined4 esi)

{
  
  FUN_00495f00(0x40ed9413);
  FUN_004ea560(esi);
  FUN_004ea650(DAT_007681e0);
  FUN_004ea650(DAT_007681e4);
  FUN_004ea650(DAT_007681e8);
  return;
}
