/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_006852C0 */
...
void __fastcall FUN_0052e460(undefined4 *);

void FUN_006852c0(undefined4 *p)
{
  FUN_0052e460(p);
}
