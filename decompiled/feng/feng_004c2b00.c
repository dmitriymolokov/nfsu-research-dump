/* spd-match: far pct=19.08 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_004C2B00 */
...
/* M4.1.3: FUN_004f42f0 → __stdcall (callee_stdcall). */
...
int __stdcall FUN_004f42f0(int a1, int a2, int a3);
extern int DAT_006b9172;
extern int DAT_006c5680;
extern int DAT_00734588;
extern int DAT_00734998;

void __fastcall FUN_004c2b00(undefined4 param_1,int param_2)

{
  undefined *puVar1;
  
  puVar1 = (undefined *)(param_2 * 0xc90 + DAT_00734588);
  if (DAT_00734998 != 0) {
    if (param_2 == 0xe) {
      FUN_004f42f0("SECONDARY_LOGO_%s%s",puVar1,"_HONDA");
      return;
    }
    if (param_2 == 0xf) {
      if (DAT_00734998 == 2) {
        FUN_004f42f0("SECONDARY_LOGO_%s%s","TUSCANI",&DAT_006b9172);
        return;
      }
      if (((DAT_00734998 == 1) || (DAT_00734998 == 5)) || (DAT_00734998 == 4)) {
        FUN_004f42f0("SECONDARY_LOGO_%s%s","COUPE",&DAT_006b9172);
        return;
      }
    }
    else if ((param_2 == 2) &&
            ((((DAT_00734998 == 2 || (DAT_00734998 == 1)) || (DAT_00734998 == 5)) ||
             (DAT_00734998 == 4)))) {
      puVar1 = &DAT_006c5680;
    }
  }
  FUN_004f42f0("SECONDARY_LOGO_%s%s",puVar1,&DAT_006b9172);
  return;
}
