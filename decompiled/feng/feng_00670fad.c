/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=pass_b_typed_abs source=reports/m3_needs_data_typed_pass_b */
...
{
  *(int **)0x00793348 = _malloc(0x80);
  if (*(int **)0x00793348 == (undefined4 *)0x0) {
    return 0x18;
  }
  **(int **)0x00793348 = 0;
  *(int **)0x00793344 = (*(int **)0x00793348);
  return 0;
}
