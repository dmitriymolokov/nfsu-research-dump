/* spd-match: matched pct=100.00 flags=/O2 /c /nologo /TC method=m36_pass_b source=m36_pass_b/va_00500B90 */
...
void FUN_00500b90(void)

{
  undefined4 *puVar1;
  
  puVar1 = (undefined4 *)FUN_004febb0();
  puVar1[0x16] = 0;
  *puVar1 = (undefined4 *)0x006c17e0;
  puVar1[6] = 9;
  return;
}
