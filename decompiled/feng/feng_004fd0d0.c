/* spd-match: far pct=72.41 flags=/O1 /c /nologo /TP method=m4_14_small_warm_stdcall source=m4_14/4.1.4/va_004FD0D0 */
...
/* M4.1.4: FUN_004fcff0 → __stdcall (small_warm_stdcall). */
...
int __stdcall FUN_004fcff0(void *a1);

struct ThisCallBox {
  void * FUN_004fd0d0(byte param_2);
};
void * ThisCallBox::FUN_004fd0d0(byte param_2) {
  FUN_004fcff0(((void *)this));
  if ((param_2 & 1) != 0) {
    _free(((void *)this));
  }
  return ((void *)this);
