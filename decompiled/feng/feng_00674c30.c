/* spd-match: far pct=3.70 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
extern void LAB_00674c60(void);
extern void LAB_00674c93(void);
...

{
  ...
  puVar2 = (uint *)_Str;
  do {
    if (((uint)puVar2 & 3) == 0) goto LAB_00674c60;
    uVar1 = *puVar2;
