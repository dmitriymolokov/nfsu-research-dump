/* spd-match: close pct=87.30 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m375_p3/buckets/typed_seh_crt_types/batches/20260724T142954Z_w0_tc0 */
...

{
  ...
  if (1 < (int)ptVar2->lc_category[1].refcount) {
    iVar3 = FUN_00675bd0(ptVar2,_C,0x103);
    return iVar3;
  }
  return *(ushort *)((int)ptVar2->lc_category[3].refcount + _C * 2) & 0x103;
}
