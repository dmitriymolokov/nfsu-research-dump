/* spd-match: far pct=18.75 flags=/O2 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_004C0300 */
...

{
  ...
  if ((DAT_0073619c == (int *)0x0) || (*DAT_0073619c != 4)) {
    FUN_004f68c0(0x20,"%s%1d",param_1 + 0x21d,*(undefined4 *)(param_1 + 0x1d4));
    pcVar1 = "Please Wait for Race Start!";
  }
  else {
    FUN_004f68c0(0x20,"%s%1d",param_1 + 0x21d,*(undefined4 *)(param_1 + 0x1d4));
    pcVar1 = "Force Race Finish";
  }
  FUN_004f67f0(pcVar1);
  FUN_004f68c0(0x20,"OptionData_%1d",*(undefined4 *)(param_1 + 0x1d4));
  FUN_004f67f0(&DAT_006ca778,*(undefined4 *)(param_1 + 0x1ec));
  return;
}
