/* spd-match: far pct=5.75 flags=/O1 /c /nologo /TP method=thiscall_tp source=reports/m375_8/p2/buckets/p2_02/attempt3_malloc_vtable_bridge */
...
extern void *PTR_FUN_006c17d8;
extern void *PTR_FUN_006c17e0;
extern void LAB_00684ceb(...);
void *ExceptionList;

struct ThisCallBox {
  undefined4 * FUN_00500bb0(undefined4 param_2);
};
undefined4 * ThisCallBox::FUN_00500bb0(undefined4 param_2) {
  undefined4 *puVar1;
  undefined4 *puVar2;
  void *local_c;
  ...
  if (puVar1 != (undefined4 *)0x0) {
    ...
    *puVar1 = (unsigned int)&PTR_FUN_006c17d8;
    puVar1[0x16] = *(undefined4 *)(((int)this) + 0x58);
    *puVar1 = (unsigned int)&PTR_FUN_006c17e0;
    puVar2 = puVar1;
  }
  ExceptionList = local_c;
  return puVar2;
