/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=pass_b_abs_dat source=reports/m3_needs_data_close_pass_b */
...
undefined4 FUN_004f6630(void)

{
  if (*(int *)((*(int *)0x0073578c) + 8) == 0) {
    return 0;
  }
  return *(undefined4 *)(*(int *)((*(int *)0x0073578c) + 8) + 0xe4);
}
