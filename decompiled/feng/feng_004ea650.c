/* spd-match: far pct=22.67 flags=/Ob2 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_004EA650 */
...
void __fastcall FUN_004ea650(int param_2, undefined4 param_3)

{
  FUN_004f42f0("STATSTYPE_DATA_%02d",param_2 + 1);
  FUN_00495f00();
  FUN_004f42f0("STATS_DATA_%02d",param_2 + 1,&DAT_006ca778,param_3);
  FUN_004f6850();
  return;
}
