/* spd-match: far pct=22.92 flags=/O2 /c /nologo /TC method=m39 source=m39/4.1.1/va_004F7620 */
...
void __fastcall FUN_004f7620(unsigned int *obj)

{
  char cVar1;
  
  if ((obj != 0) && (*(int *)(obj + 0x18) < 0x100)) {
    cVar1 = FUN_004feb50();
    if (cVar1 == '\0') {
      *(uint *)(obj + 0x1c) = *(uint *)(obj + 0x1c) | 0x400000;
    }
    FUN_004ff2f0(obj,0,0);
  }
  return;
}
