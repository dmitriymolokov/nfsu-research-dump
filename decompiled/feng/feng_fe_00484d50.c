/* spd-match: far pct=9.42 flags=/Og /c /nologo /TC method=m4_13_callee_stdcall_v2 source=m4_13/4.1.3/va_00484D50 */
...
void __fastcall FUN_00484d50(int param_1)

{
  ...
  if (((cVar6 != '\0') || (DAT_007361f0 == (int *)0x0)) ||
     ((*(int *)DAT_007361f0 != 7 && (*(int *)DAT_007361f0 != 0xb)))) {
    iVar9 = *(int *)(param_1 + 0x198);
    if (DAT_0078a2fc == 0) {
      local_17c = *(float *)(iVar9 + 0x810);
    }
    else {
      local_17c = (((int)_DAT_006cc9f8) - *(float *)(iVar9 + 0x810) * ((int)_DAT_006cc9f8)) * ((int)_DAT_006cc79c);
    }
    fVar11 = (local_17c - *(float *)(param_1 + 0x54)) /
             (*(float *)(param_1 + 0x58) - *(float *)(param_1 + 0x54));
    if (fVar11 < DAT_006cc7a4) {
      fVar11 = DAT_006cc7a4;
    }
    if (*(int *)(param_1 + 0x4c) == 0) {
      fVar1 = _DAT_006b6c6c * *(float *)(param_1 + 0x40) * ((int)DAT_0073457c) +
              *(float *)(param_1 + 0x130);
    }
    else {
      fVar1 = (float)(*(int *)(param_1 + 0x7c) + -1) * fVar11;
    }
    *(float *)(param_1 + 0x130) = fVar1;
    fVar1 = (float)(*(int *)(param_1 + 0x7c) + -1);
    if (fVar1 < *(float *)(param_1 + 0x130)) {
      *(float *)(param_1 + 0x130) = fVar1;
    }
    if (*(int *)(param_1 + 0x50) == 0) {
      *(float *)(param_1 + 0x164) =
           _DAT_006b6c6c * *(float *)(param_1 + 0x44) * ((int)DAT_0073457c) + *(float *)(param_1 + 0x164);
    }
    else {
      *(float *)(param_1 + 0x164) = (float)(*(int *)(param_1 + 0x88) + -1) * fVar11;
    }
    local_180 = (float)(*(int *)(param_1 + 0x88) + -1);
    if ((float)(int)local_180 < *(float *)(param_1 + 0x164)) {
      *(float *)(param_1 + 0x164) = (float)(int)local_180;
    }
    ...
    local_114 = 0;
    local_104[0] = 0x3f800000;
    local_110 = -*(float *)(iVar9 + 0x50);
    local_10c = -*(float *)(iVar9 + 0x54);
    local_108 = -*(float *)(iVar9 + 0x58);
    FUN_00484d50(local_90,iVar9 + 0x90);
    FUN_00484d50(auStack_58,auStack_148);
    FUN_005829e0(*(undefined4 *)(param_1 + 0x130));
    fVar1 = *(float *)(*(int *)(param_1 + 0x198) + 0x60);
    fVar2 = *(float *)(*(int *)(param_1 + 0x198) + 100);
    fVar10 = (float10)FUN_00441d80(8);
    fVar11 = (float)(fVar10 * (float10)((int)_DAT_006b6cb4));
    fVar2 = fVar2 - _DAT_006cc7bc;
    fVar10 = (float10)FUN_00441d80(8);
    fStack_168 = (float)(fVar10 * (float10)((int)_DAT_006b6cb4));
    fVar2 = fVar2 + _DAT_006ccc00;
    fVar10 = (float10)FUN_00441d80(8);
    fStack_184 = fStack_184 + fVar11;
    local_180 = local_180 + fStack_168;
    local_17c = (float)(fVar10 * (float10)((int)_DAT_006b6cb4) + (float10)local_17c);
    fVar10 = (float10)FUN_00440a40(param_1 + 0x19c,&fStack_184,0,0,0);
    if ((float10)local_17c < fVar10 + (float10)((int)_DAT_006b6c98)) {
      local_17c = (float)(fVar10 + (float10)((int)_DAT_006b6c98));
    }
    FUN_005829e0(*(undefined4 *)(param_1 + 0x164));
    FUN_005829e0(*(undefined4 *)(param_1 + 0x130));
    FUN_00674898();
    FUN_00483860(local_104);
    FUN_0040b780(local_104);
    FUN_00484d50(auStack_e4,auStack_64,auStack_154);
    fVar11 = ((float)(*(float *)&auStack_98) - *(float *)(param_1 + 0x38)) /
             (*(float *)(param_1 + 0x3c) - *(float *)(param_1 + 0x38));
    fVar3 = DAT_006cc7a4;
    if ((DAT_006cc7a4 <= fVar11) && (fVar3 = fVar11, _DAT_006cc7bc < fVar11)) {
      fVar3 = _DAT_006cc7bc;
    }
    FUN_005829e0(fVar3 * ((int)_DAT_006ccd34));
    iVar9 = DAT_00735f5c;
    if (*(int *)(param_1 + 0x34) == 0) {
      if (DAT_00735f5c == 0) {
        uVar8 = FUN_00674898();
        *(undefined2 *)(*(int *)(param_1 + 0x1c) + 0xc4) = uVar8;
      }
    }
    else {
      iVar9 = *(int *)(param_1 + 0x198);
      fVar11 = unaff_EDI - *(float *)(iVar9 + 0x60);
      fVar4 = fVar1 - *(float *)(iVar9 + 100);
      fVar3 = fVar2 - *(float *)(iVar9 + 0x68);
      fStack_19c = SQRT(fVar11 * fVar11 + fVar4 * fVar4 + fVar3 * fVar3);
      if (fStack_19c < _DAT_006cc7bc) {
        fStack_19c = 1.0;
      }
      sVar7 = FUN_00564db0(fStack_19c,local_120 * ((int)_DAT_006b6c94));
      iVar9 = DAT_00735f5c;
      if (DAT_00735f5c == 0) {
        *(short *)(*(int *)(param_1 + 0x1c) + 0xc4) = sVar7 << 1;
      }
    }
    fVar1 = fVar1 - fStack_16c;
    fVar2 = fVar2 - fStack_168;
    fVar11 = SQRT((unaff_EDI - fStack_170) * (unaff_EDI - fStack_170) +
                  fVar2 * fVar2 + fVar1 * fVar1);
    if (iVar9 == 0) {
      *(float *)(*(int *)(param_1 + 0x1c) + 0xb0) = fVar11;
    }
    uVar5 = DAT_006b6cb8;
    if (fVar11 < _DAT_006ccc00) {
      fVar11 = _DAT_006ccc00;
    }
    if (iVar9 == 0) {
      *(float *)(*(int *)(param_1 + 0x1c) + 0xb4) = fVar11;
      *(undefined4 *)(*(int *)(param_1 + 0x1c) + 0xb8) = uVar5;
    }
    if (*(int *)DAT_0073619c == 4) {
      FUN_00483b90(param_1,auStack_f0,*(undefined4 *)(param_1 + 0x198));
    }
    FUN_0047d070(*(undefined4 *)(param_1 + 0x1c),auStack_f0,DAT_0073ad38);
  }
  return;
}
