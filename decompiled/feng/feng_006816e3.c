/* spd-match: close pct=90.91 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m375_p3/buckets/typed_residual_tok_p1/batches/20260724T142537Z_w0_tc0 */
...

{
  ...
  IVar1 = __ld12cvt(_Ifp,_D,&DAT_006ec200);
  return IVar1;
}
