/* spd-match: far pct=14.63 flags=/O2 /c /nologo /TC method=m4_13_fc_wrapper_thiscall source=m4_13/4.1.3/va_004F6510 */
...
/* M4.1.3: FUN_004ef050 → __stdcall (callee_stdcall). */
...
int __stdcall FUN_004ef050(void);
extern int DAT_0073578c;

uint __fastcall FUN_004f6510(undefined4 head)

{
  int iVar1;
  
  if (DAT_0073578c != 0) {
    iVar1 = FUN_004ef050(head);
    if (iVar1 != 0) {
      return ~(*(uint *)(iVar1 + 0x1c) >> 0x1a) & 1;
    }
  }
  return 0;
}
