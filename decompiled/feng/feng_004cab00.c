/* spd-match: far pct=43.18 flags=/O1 /c /nologo /TC method=m4_13_fc_wrapper_thiscall source=m4_13/4.1.3/va_004CAB00 */
...
/* M4.1.3: FUN_004ca2d0 → __stdcall (callee_stdcall). */
...
int __stdcall FUN_004ca2d0(void);
extern int DAT_00748f75;
extern void LAB_004cab40(void);
extern void LAB_004cab60(void);

void __fastcall FUN_004cab00(int head)

{
  char cVar1;
  
  cVar1 = FUN_004ca2d0(head);
  if ((cVar1 == '\0') && (DAT_00748f75 == '\0')) {
    *(undefined1 **)(head + 0x40) = &LAB_004cab40;
    *(undefined1 *)(head + 0x48) = 1;
    return;
  }
  *(undefined1 **)(head + 0x40) = &LAB_004cab60;
  *(undefined1 *)(head + 0x48) = 1;
  return;
}
