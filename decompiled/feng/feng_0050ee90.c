/* spd-match: far pct=6.94 flags=/O2 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_0050EE90 */
...
uint __fastcall FUN_0050ee90(uint obj, int edi_obj)

{

  uint *puVar1;

  if ((edi_obj != 0) && (obj = 0, DAT_0073766c != 0)) {
    puVar1 = (uint *)(DAT_00737668 + 0x24);
    while ((puVar1[-1] != 1 || (*puVar1 != (uint)*(byte *)(edi_obj + 0x11)))) {
      obj = obj + 1;
      puVar1 = puVar1 + 0xd;
      if (DAT_0073766c <= obj) {
