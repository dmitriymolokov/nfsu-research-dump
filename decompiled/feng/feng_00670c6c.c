/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=m36_pass_b source=m36_pass_b/va_00670C6C */
...

{
  ...
  FUN_00674f09(param_1);
  (*(void(__cdecl **)(int))0x006eb1b4)(0xff);
  return;
}
