/* spd-match: far pct=13.54 flags=/O2 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_004C3390 */
...
/* M4.1.3: FUN_004323f0 → __stdcall (callee_stdcall). */
...
int __stdcall FUN_004323f0(int a, int b);
...
extern void LAB_004c33b7(void);

void __fastcall FUN_004c3390(int param_1)

{
  ...
  if (param_1 == -0x6edfbf62) {
    if (puVar1 == *(undefined4 **)(unaff_EDI + 0x40)) goto LAB_004c33b7;
    uVar3 = puVar1[1];
  }
  else {
...
LAB_004c33b7:
  if (puVar1 != *(undefined4 **)(unaff_EDI + 0x48)) {
    ...
    if (*(char *)(iVar2 + 0xe60) == '\0') {
      FUN_004c2d20(unaff_EDI + 0x90);
      *(undefined1 *)(iVar2 + 0xe60) = 1;
    }
    FUN_004323f0(&DAT_00745000,iVar2 + 0x740);
    iVar2 = FUN_004b2330();
