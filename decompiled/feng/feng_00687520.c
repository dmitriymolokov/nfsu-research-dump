/* spd-match: far pct=37.50 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_00687520 */
...
void FUN_00500560(undefined4 *param_1);

void FUN_00687520(undefined4 *param_1)
{
  FUN_00500560(param_1);
}
