/* spd-match: far pct=70.83 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
int __cdecl FUN_0067593c();
extern unsigned char *PTR_FUN_006eb460;

void FUN_00674999(DWORD param_1)

{
  _ptiddata p_Var1;
  
  if (PTR_FUN_006eb460 != (undefined *)0x0) {
    (*(code *)PTR_FUN_006eb460)();
  }
  p_Var1 = __getptd();
