/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_00689600 */
...
void __fastcall FUN_005944d0(undefined4 *);

void FUN_00689600(undefined4 *p)
{
  FUN_005944d0(p);
}
