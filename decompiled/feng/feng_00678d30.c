/* spd-match: far pct=3.87 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m375_8/p2/buckets/p2_06 */
...
void * __cdecl FUN_00678d30(void *_Dst,void *_Src,size_t _Size)

{
  ...
  if ((_Src < _Dst) && (_Dst < (void *)(_Size + (int)_Src))) {
    ...
    if (((uint)puVar4 & 3) == 0) {
      ...
      if (7 < uVar1) {
        ...
        case 0:
          return _Dst;
        case 2:
          goto switchD_00678eeb_caseD_2;
        case 3:
          goto switchD_00678eeb_caseD_3;
        }
        goto switchD_00678eeb_caseD_1;
      }
    }
    else {
      switch(_Size) {
      case 0:
        goto switchD_00678eeb_caseD_0;
      case 1:
        goto switchD_00678eeb_caseD_1;
      case 2:
        goto switchD_00678eeb_caseD_2;
    ...
    switch(uVar2) {
    case 1:
switchD_00678eeb_caseD_1:
      *(undefined1 *)((int)puVar4 + 3) = *(undefined1 *)((int)puVar3 + 3);
      return _Dst;
    case 2:
switchD_00678eeb_caseD_2:
      *(undefined1 *)((int)puVar4 + 3) = *(undefined1 *)((int)puVar3 + 3);
      *(undefined1 *)((int)puVar4 + 2) = *(undefined1 *)((int)puVar3 + 2);
      return _Dst;
    case 3:
switchD_00678eeb_caseD_3:
      *(undefined1 *)((int)puVar4 + 3) = *(undefined1 *)((int)puVar3 + 3);
      *(undefined1 *)((int)puVar4 + 2) = *(undefined1 *)((int)puVar3 + 2);
      *(undefined1 *)((int)puVar4 + 1) = *(undefined1 *)((int)puVar3 + 1);
      return _Dst;
    }
switchD_00678eeb_caseD_0:
    return _Dst;
  }
  puVar3 = _Dst;
  if (((uint)_Dst & 3) == 0) {
    ...
    if (7 < uVar1) {
      ...
      case 0:
        return _Dst;
      case 2:
        goto switchD_00678d65_caseD_2;
      case 3:
        goto switchD_00678d65_caseD_3;
      }
      goto switchD_00678d65_caseD_1;
    }
  }
  else {
    switch(_Size) {
    case 0:
      goto switchD_00678d65_caseD_0;
    case 1:
      goto switchD_00678d65_caseD_1;
    case 2:
      goto switchD_00678d65_caseD_2;
