/* spd-match: far pct=16.30 flags=/O2 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_0050C590 */
...
extern int DAT_0073578c;
extern int DAT_00746104;
undefined4 __cdecl FUN_0050c590(int obj)

{
  ...
  uVar3 = 0;
  if (*(int *)(*(int *)(obj + 0x40) + 0x10) != 0) {
    DAT_00735738 = *(undefined4 *)(*(int *)(obj + 0x40) + 8);
