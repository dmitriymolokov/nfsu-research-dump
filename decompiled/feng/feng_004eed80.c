/* spd-match: far pct=17.07 flags=/O1 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_004EED80 */
...
int __cdecl FUN_004eefa0();

int __cdecl FUN_004eefa0();

void __fastcall FUN_004eed80(int obj, undefined4 * esi)

{
  char cVar1;

  cVar1 = (**(code **)(**(int **)(obj + 0x10c) + 0x14))();
  if (cVar1 != '\0') {
    FUN_004eefa0();
    if (*(int **)(obj + 0x10c) == (int *)0x0) {
      cVar1 = '\x01';
    }
    else {
      cVar1 = (**(code **)(**(int **)(obj + 0x10c) + 0x10))();
    }
    if (*(int **)(obj + 0x10c) != (int *)0x0) {
      (**(code **)(**(int **)(obj + 0x10c) + 8))();
    }
    if ((cVar1 != '\0') && (esi != (undefined4 *)0x0)) {
      (**(code **)*esi)(1);
    }
  }
  return;
