/* spd-match: far pct=19.72 flags=/Ob2 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_004DE0E0 */
...
void __fastcall FUN_004de0e0(int obj)

{
  ...
  uVar1 = FUN_00567c70();
  *(undefined4 *)(obj + 0x48) = uVar1;
  FUN_004ad7b0(uVar1);
  local_4 = *(undefined4 *)(obj + 0x48);
  FUN_0053e9e0(&DAT_00740420,&local_4,1,FUN_004ddf60,obj,0);
  return;
}
