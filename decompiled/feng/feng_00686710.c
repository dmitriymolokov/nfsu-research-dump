/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_00686710 */
...
void __fastcall FUN_00578e60(undefined4 *);

void FUN_00686710(undefined4 *p)
{
  FUN_00578e60(p);
}
