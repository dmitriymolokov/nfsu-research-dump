/* spd-match: far pct=27.34 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
extern unsigned char *DAT_00793344;
extern int DAT_00793348;
int unaff_EDI;
...

{
  ...
  sVar1 = __msize(DAT_00793348);
  if (sVar1 < (uint)((int)DAT_00793344 + (4 - (int)DAT_00793348))) {
    sVar3 = 0x800;
    if (sVar1 < 0x800) {
      sVar3 = sVar1;
    }
    pvVar2 = _realloc(DAT_00793348,sVar3 + sVar1);
    if (pvVar2 == (void *)0x0) {
      pvVar2 = _realloc(DAT_00793348,sVar1 + 0x10);
      if (pvVar2 == (void *)0x0) {
        return;
      }
    }
    DAT_00793344 = (undefined4 *)((int)pvVar2 + ((int)DAT_00793344 - (int)DAT_00793348 >> 2) * 4);
    DAT_00793348 = pvVar2;
  }
  *DAT_00793344 = unaff_EDI;
