/* spd-match: far pct=11.11 flags=/O1 /c /nologo /TC method=m4_11_r2_edi_stack source=m4_11/4.1.1.r2/va_0051A6D0 */
...
void __fastcall FUN_0051a6d0(int * obj, short *param_1, int edi)

{
  ...
  if (((int)*param_1 == *obj) && ((int)param_1[1] == obj[1])) {
    uVar2 = 0;
  }
  else {
    uVar2 = 1;
  }
  *(undefined1 *)((int)obj + 0x1d) = uVar2;
  *obj = (int)*param_1;
  obj[1] = (int)param_1[1];
  obj[2] = (int)param_1[2];
  *(undefined2 *)(obj + 3) = *(undefined2 *)((int)obj + 0xe);
  *(short *)((int)obj + 0xe) = param_1[3];
  iVar1 = 0;
  piVar4 = obj + 4;
  do {
    uVar3 = 1 << ((byte)iVar1 & 0x1f);
    if ((uVar3 & *(ushort *)((int)obj + 0xe)) != 0) {
      if ((uVar3 & *(ushort *)(obj + 3)) == 0) {
        *piVar4 = 0;
      }
      else {
        *piVar4 = *piVar4 + edi;
