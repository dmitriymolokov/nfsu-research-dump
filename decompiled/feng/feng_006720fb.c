/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m375_inventory/batches/20260724T084420Z_w1_tc0 */
...
int __cdecl FUN_00672017();

void __cdecl __exit(int _Code)

{
  FUN_00672017(_Code,1,0);
  return;
}
