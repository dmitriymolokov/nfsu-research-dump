/* spd-match: far pct=17.09 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_004FAF70 */
...
void __fastcall FUN_004faf70(int obj, float param_1)

{
  bool bVar1;
  float fVar2;

  if (*(code **)(obj + 0xb8) != (code *)0x0) {
    (**(code **)(obj + 0xb8))();
  }
  fVar2 = param_1 * *(float *)(obj + 0xa4) + *(float *)(obj + 0xa0);
  bVar1 = fVar2 < DAT_006cc7a4;
  *(float *)(obj + 0xa0) = fVar2;
  if (bVar1) {
    *(undefined4 *)(obj + 0xa0) = 0;
    *(float *)(obj + 0xa4) = -*(float *)(obj + 0xa4);
    return;
  }
  if (_DAT_006cc7bc < fVar2) {
    *(undefined4 *)(obj + 0xa0) = 0x3f800000;
    *(float *)(obj + 0xa4) = -*(float *)(obj + 0xa4);
  }
  return;
}
