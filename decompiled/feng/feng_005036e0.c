/* spd-match: far pct=10.61 flags=/O2 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.5/va_005036E0 */
...
int __fastcall FUN_005036e0(undefined4 val, undefined4 param_1)

{
  ...
  iVar2 = FUN_00503410(param_1,val);
  FUN_00503ed0(iVar2);
  FUN_00503ed0(iVar2);
  iVar1 = *(int *)(iVar2 + 0x1c);
  local_8[0] = 0;
  local_8[1] = 0;
  while ((iVar1 != 0 && (iVar3 = __stricmp(*(char **)(iVar1 + 0xc),"Upper Left"), iVar3 != 0))) {
    iVar1 = *(int *)(iVar1 + 4);
  }
  _free(*(void **)(iVar1 + 0x20));
  *(undefined4 *)(iVar1 + 0x20) = 0;
  if (*(size_t *)(iVar1 + 0x18) != 0) {
    puVar4 = _malloc(*(size_t *)(iVar1 + 0x18));
