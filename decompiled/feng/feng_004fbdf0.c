/* spd-match: far pct=30.36 flags=/O1 /c /nologo /TC method=m4_11_r2_edi_stack source=m4_11/4.1.1.r2/va_004FBDF0 */
...
void __fastcall FUN_004fbdf0(uint param_1, uint *param_2, int edi)
