/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_00685F40 */
...
void __fastcall FUN_005779c0(undefined4 *);

void FUN_00685f40(undefined4 *p)
{
  FUN_005779c0(p);
}
