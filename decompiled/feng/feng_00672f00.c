/* spd-match: far pct=6.52 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m375_p3/buckets/typed_residual_tok_p1/batches/20260724T142455Z_w0_tc0 */
...
{
  if (((((*(unsigned short *)((unsigned char *)&(_X) + 6)) & 0x7ff8) != 0x7ff0) ||
      ((((ulonglong)_X & 0x7ffff00000000) == 0 && ((*(unsigned int *)&(_X)) == 0)))) &&
     (((*(unsigned short *)((unsigned char *)&(_X) + 6)) & 0x7ff8) != 0x7ff8)) {
    return 0;
  }
  return 1;
}
