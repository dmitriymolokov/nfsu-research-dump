/* spd-match: far pct=13.82 flags=/O1 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_00506EB0 */
...
int __fastcall FUN_00506eb0(int param_2, int param_3)

{
  ...
  while (*piVar4 != param_2) {
    piVar4 = piVar4 + 7;
    iVar2 = iVar2 + 1;
    if (0x70669b < (int)piVar4) {
      return 0;
    }
  }
  if (iVar2 * 0x1c == -0x706530) {
    return 0;
  }
  iVar1 = (&DAT_00706540)[iVar2 * 7];
  if (iVar1 == -1) {
    return 0;
  }
  iVar3 = FUN_0057cf20(&DAT_0073ad40,*(undefined4 *)(param_3 + 0x88),iVar1,0);
  iVar2 = *(int *)(iVar2 * 0x1c + 0x706548);
  if (iVar2 != 0) {
    iVar2 = FUN_0057cf20(&DAT_0073ad40,iVar2,iVar1,0);
    iVar3 = iVar3 + iVar2;
  }
  return iVar3;
}
