/* spd-match: far pct=29.17 flags=/O1 /c /nologo /TC method=m4_11_unaff source=m4_11/4.1.1/va_004C393B */
...
void __fastcall FUN_004c393b(int obj)

{
  
  FUN_00504390();
  FUN_00504390();
  FUN_004f6360(*(undefined4 *)(obj + 0xc));
  return;
}
