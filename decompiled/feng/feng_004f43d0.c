/* spd-match: far pct=18.57 flags=/O1 /c /nologo /TC method=m4_15_cc_flip_to_cdecl source=m4_15/4.1.5/va_004F43D0 */
...
extern int DAT_006f9490;
extern int DAT_007460fc;
int __cdecl FUN_0040a880();
extern int DAT_006f9490;
extern int DAT_007460fc;
undefined4 * __cdecl FUN_004f43d0(int val)

{
  ...
  puVar1 = DAT_007460fc;
  do {
    for (; iVar4 = val, puVar1 != puVar2; puVar1 = (undefined4 *)*puVar1) {
      if (puVar1[5] == iVar4) {
        return puVar1;
      }
      val = iVar4;
