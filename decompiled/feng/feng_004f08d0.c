/* spd-match: far pct=10.34 flags=/Og /c /nologo /TC method=m4_11_unaff source=m4_11/4.1.1/va_004F08D0 */
...
void __fastcall FUN_004f08d0(undefined4 * obj)

{
  
  *obj = &PTR_FUN_006c1828;
  if ((void *)obj[3] != (void *)0x0) {
    _free((void *)obj[3]);
  }
