/* spd-match: matched pct=100.00 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m375_inventory/batches/20260724T084435Z_w1_tc0 */
...

{
  ...
  lVar1 = strtoxl(_Str,_EndPtr,_Radix,0);
  return lVar1;
}
