/* spd-match: far pct=11.70 flags=/O1 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_00511F00 */
...
/* M4.1.3: drop phantom param_1,param_4 (phantom_param; sync only on uplift). */
...
extern unsigned char *DAT_007066a0;
extern int DAT_00734588;
extern int DAT_00745b6c;
extern void LAB_00511f21(void);
extern void LAB_00511f93(void);

void __fastcall FUN_00511f00(int param_2, undefined4 param_3, char param_5)

{
  ...
  do {
    if (*piVar1 == param_2) {
      puVar4 = &DAT_007066a0 + iVar2 * 8;
      goto LAB_00511f21;
    }
    piVar1 = piVar1 + 8;
    iVar2 = iVar2 + 1;
  } while ((int)piVar1 < 0x706780);
  puVar4 = (undefined4 *)0x0;
LAB_00511f21:
  local_8 = 0;
  FUN_00511d70(local_14,local_10,&local_8,local_c);
  iVar2 = FUN_004acce0();
  uVar3 = 0;
  if (iVar2 != 0x23) {
  ...
  iVar2 = FUN_0057ce10(uVar3,puVar4[1],local_8,0,0xffffffff);
LAB_00511f93:
  if (iVar2 != (&DAT_00745b6c)[puVar4[1]]) {
    FUN_005044b0(iVar2,0);
  }
  if (param_5 != '\0') {
    FUN_005044b0(param_3,0);
    return;
  }
  FUN_00504450();
  return;
