/* spd-match: far pct=13.95 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_004E45B0 */
...
/* M4.1.3: FUN_005048e0 → __stdcall (callee_stdcall). */
...
int __stdcall FUN_005048e0(int arg);
extern int DAT_00744ff0;

void __fastcall FUN_004e45b0(int param_1)
