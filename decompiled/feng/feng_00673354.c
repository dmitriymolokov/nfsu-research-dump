/* spd-match: far pct=10.53 flags=/O1 /c /nologo /TC method=pass_a_tc source=reports/m375_p3/buckets/typed_residual_tok_p1/batches/20260724T142506Z_w0_tc0 */
...
{
  RtlUnwind(param_1,(PVOID)0x67336c,(PEXCEPTION_RECORD)0x0,(PVOID)0x0);
  return;
}
