/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_0068698D */
...
void __fastcall FUN_00424ef0(undefined4 *);

void FUN_0068698d(undefined4 *p)
{
  FUN_00424ef0(p);
}
