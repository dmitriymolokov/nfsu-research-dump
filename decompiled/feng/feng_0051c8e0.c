/* spd-match: far pct=45.86 flags=/O1 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_0051C8E0 */
...
extern unsigned char *PTR_FUN_006bf5a4;

undefined4 * __fastcall FUN_0051c8e0(undefined4 *param_2)

{
  undefined4 *puVar1;
  int iVar2;
  
  *param_2 = &PTR_FUN_006bf5a4;
  puVar1 = param_2 + 3;
  iVar2 = 4;
  do {
    *puVar1 = 0;
