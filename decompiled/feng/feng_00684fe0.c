/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_00684FE0 */
...
void __fastcall FUN_0059bc40(undefined4 *);

void FUN_00684fe0(undefined4 *p)
{
  FUN_0059bc40(p);
}
