/* Decompiled from Speed.exe @ 004ce120 */
/* Module: FEng_FE */
/* Ghidra DecompileAll */
...

{
  ...
  *(undefined1 **)(unaff_EBX + 0x4c) = &LAB_004cdca0;
  if (((*(int *)(unaff_EBX + 0xc) == 0) ||
      (iVar1 = FUN_004f65d0(), iVar2 = DAT_0073578c, iVar1 == 0)) ||
     (iVar1 = FUN_004ffb70(), iVar2 = DAT_0073578c, iVar1 == 0)) {
    if (iVar2 == 0) {
      iVar1 = 0;
    }
    else {
      iVar1 = FUN_004ef050(0x1aec7d0c);
    }
  }
  FUN_004f6970(iVar1);
