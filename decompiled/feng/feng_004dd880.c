/* spd-match: far pct=24.24 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall_v2 source=m4_13/4.1.3/va_004DD880 */
...
/* M4.1.3-R3: FUN_004f6910 → unified __stdcall (callee_stdcall_v2). */
...
int __cdecl FUN_004ddbb0();
int __cdecl FUN_004ef050();
int __cdecl FUN_004f65d0();
int __stdcall FUN_004f6910(undefined4 a1);
int __cdecl FUN_004ffb70();
extern int DAT_0073578c;
extern void LAB_004dd8d0(void);
int __cdecl FUN_004ddbb0();
int __cdecl FUN_004ef050();
int __cdecl FUN_004f65d0();
int __stdcall FUN_004f6910(undefined4 a1);
...
extern int DAT_0073578c;
extern void LAB_004dd8d0(void);
void __fastcall FUN_004dd880(int obj)

{
  ...
  if (*(int *)(obj + 0xc) != 0) {
    ...
    if (iVar1 != 0) {
      iVar1 = FUN_004ffb70();
      if (iVar1 != 0) goto LAB_004dd8d0;
    }
  }
  if (DAT_0073578c != 0) {
    uVar2 = FUN_004ef050(0x164e7598);
    FUN_004f6910(uVar2);
    return;
  }
  iVar1 = 0;
