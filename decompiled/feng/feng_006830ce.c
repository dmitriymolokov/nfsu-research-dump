...
LONG lineMakeCall(HLINE hLine,LPHCALL lphCall,LPCSTR lpszDestAddress,DWORD dwCountryCode,
...

{
  ...
  LVar1 = lineMakeCall(hLine,lphCall,lpszDestAddress,dwCountryCode,lpCallParams);
  return LVar1;
}
