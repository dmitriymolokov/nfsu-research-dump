/* spd-match: far pct=10.00 flags=/O1 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_004EB610 */
...
extern int _DAT_00735db4;
extern int _DAT_00735db8;

void __fastcall FUN_004eb610(int param_2, undefined4 param_3, int param_4, undefined4 param_5, undefined4 param_6)

{
  ...
  iVar5 = 0x80;
  do {
    cVar1 = pcVar3[param_2 + -0x72cd50];
    iVar5 = iVar5 + -1;
    *pcVar3 = cVar1;
    if (cVar1 == '\0') break;
    pcVar3 = pcVar3 + 1;
  } while (iVar5 != 0);
  _DAT_00735dac = param_3;
  pcVar3 = &DAT_0072cd10;
  iVar5 = 0x40;
  do {
    cVar1 = pcVar3[param_4 + -0x72cd10];
    iVar5 = iVar5 + -1;
    *pcVar3 = cVar1;
    iVar2 = DAT_0073578c;
    if (cVar1 == '\0') break;
  ...
  _DAT_00735db4 = param_5;
  _DAT_00735db8 = param_6;
  _DAT_00735da8 = 5;
  if (DAT_0073578c != 0) {
