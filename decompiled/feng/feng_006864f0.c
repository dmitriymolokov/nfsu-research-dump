/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_006864F0 */
...
void __fastcall FUN_0041f6c0(undefined4 *);

void FUN_006864f0(undefined4 *p)
{
  FUN_0041f6c0(p);
}
