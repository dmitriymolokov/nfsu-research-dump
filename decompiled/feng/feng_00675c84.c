/* spd-match: far pct=6.30 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...
int __cdecl FUN_00675dec();
extern int DAT_00717d74;
extern int DAT_0079320c;
extern int DAT_0079321c;
extern int DAT_00793220;
    ...
    if (_NewSize == 0) {
        ...
        if (_NewSize < 0xffffffe1) {
          ...
          if (local_24 != 0) {
            ...
            if (local_20 == (void *)0x0) {
              ...
              local_20 = HeapAlloc(DAT_0079321c,0,_NewSize);
          ...
          if (local_24 == 0) {
            ...
            _NewSize = _NewSize + 0xf & 0xfffffff0;
            local_20 = HeapReAlloc(DAT_0079321c,0,_Memory,_NewSize);
          }
        }
        if (local_20 != (void *)0x0) {
          return local_20;
      ...
      do {
        ...
        if (_NewSize < 0xffffffe1) {
          ...
          pvVar4 = HeapReAlloc(DAT_0079321c,0,_Memory,_NewSize);
        }
