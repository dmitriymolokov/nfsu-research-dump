/* spd-match: far pct=8.42 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...

{
  ...
  if ((DAT_00793220 == 3) && (_Size <= DAT_0079320c)) {
    __lock(4);
  ...
  pvVar2 = HeapAlloc(DAT_0079321c,0,_Size);
  return pvVar2;
}
