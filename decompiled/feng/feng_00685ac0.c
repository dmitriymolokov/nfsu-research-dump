/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_00685AC0 */
...
void __fastcall FUN_004fef10(undefined4 *);

void FUN_00685ac0(undefined4 *p)
{
  FUN_004fef10(p);
}
