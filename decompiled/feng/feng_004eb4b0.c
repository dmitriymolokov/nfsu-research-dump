/* spd-match: far pct=10.00 flags=/O1 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_004EB4B0 */
...
void __fastcall FUN_004eb4b0(int param_2, undefined4 param_3, int param_4, undefined4 param_5, undefined4 param_6)
