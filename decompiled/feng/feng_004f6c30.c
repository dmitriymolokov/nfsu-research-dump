/* spd-match: far pct=18.75 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_004F6C30 */
...
void __fastcall FUN_004f6c30(undefined4 val, undefined4 param_1, undefined4 param_2, int esi)

{

  int iVar1;

  if ((((esi == 0) || (iVar1 = FUN_004f65d0(), iVar1 == 0)) ||
      (iVar1 = FUN_004ffb70(), iVar1 == 0)) && (DAT_0073578c != 0)) {
    FUN_004ef050(val);
  }
