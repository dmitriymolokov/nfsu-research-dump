/* spd-match: far pct=11.90 flags=/O1 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_004F3DC0 */
...
void __fastcall FUN_004f3dc0(int param_2, undefined4 param_3)

{
  ...
  while( true ) {
    ...
    if ((*(int *)(iVar1 + 0x18) != 0) && (iVar3 < 0x20)) {
      aiStack_80[iVar3] = iVar1;
      iVar3 = iVar3 + 1;
    }
    iVar1 = *(int *)(iVar1 + 4);
  }
  ...
  if (0 < iVar3) {
    do {
      iVar2 = *(int *)(aiStack_80[iVar1] + 0x18);
      if ((iVar2 != 0) && (*(int *)(aiStack_80[iVar1] + 0x14) != 0)) {
        FUN_004f7c00(param_3,0,0,iVar2);
      }
      iVar1 = iVar1 + 1;
    } while (iVar1 < iVar3);
  }
