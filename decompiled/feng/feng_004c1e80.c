/* spd-match: far pct=60.00 flags=/Og /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_004C1E80 */
...
int __cdecl FUN_004befd0();
int __cdecl FUN_004c13b0();
int __cdecl FUN_004c1470();
extern int DAT_00777cb8;
extern void LAB_004bf0c0(void);
void __fastcall FUN_004c1e80(int obj)

{
  ...
  FUN_004c13b0(1,1);
  FUN_004c1470(obj);
  *(undefined4 *)(obj + 0x19c) = 1;
  *(undefined1 **)(obj + 0x48) = &LAB_004bf0c0;
  FUN_004befd0();
  *(undefined4 *)(obj + 0x160) = 4;
  return;
}
