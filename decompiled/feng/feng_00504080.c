/* spd-match: far pct=4.35 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_00504080 */
...
undefined4 * __fastcall FUN_00504080(undefined4 * obj, short * esi_obj)
