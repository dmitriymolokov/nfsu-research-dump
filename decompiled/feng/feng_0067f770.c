/* spd-match: far pct=21.43 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...

{
  ...
  sVar1 = _strlen(DAT_00717e80);
  DAT_00717e70 = (uint)(sVar1 == 3);
  if (sVar1 == 3) {
    DAT_00717e7c = 2;
  }
  else {
    DAT_00717e7c = _GetPrimaryLen();
  }
  EnumSystemLocalesA(FUN_0067f5e2,1);
  if ((DAT_00717e64 & 4) == 0) {
    DAT_00717e64 = 0;
  }
  return;
