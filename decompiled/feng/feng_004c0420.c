/* spd-match: far pct=16.25 flags=/O1 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_004C0420 */
...
void __fastcall FUN_004c0420(int param_1)

{
  FUN_004f68c0(0x20,"%s%1d",param_1 + 0x21d,*(undefined4 *)(param_1 + 0x1dc));
  FUN_004f67f0("Debug Cameras");
  FUN_004f68c0(0x20,"OptionData_%1d",*(undefined4 *)(param_1 + 0x1dc));
  FUN_004f67f0(&DAT_006ca778,DAT_0073495c);
  return;
}
