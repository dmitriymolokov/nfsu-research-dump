/* spd-match: far pct=30.91 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_inventory */
...

{
  ...
  sVar1 = _strlen(DAT_00717e78);
  DAT_00717e74 = (uint)(sVar1 == 3);
  EnumSystemLocalesA(FUN_0067f2b1,1);
  if ((DAT_00717e64 & 4) == 0) {
    DAT_00717e64 = 0;
  }
  return;
