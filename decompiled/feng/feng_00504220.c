/* spd-match: far pct=48.84 flags=/O1 /c /nologo /TC method=m4_12_mid_void source=m4_12/4.1.2/va_00504220 */
...
void __fastcall FUN_00504220(int obj)

{
  ...
  *(int *)(obj + 4) = obj;
  ...
  FUN_00417600();
  *(undefined4 *)(obj + 8) = 0;
  *(undefined4 *)(obj + 0xe50) = 0;
  *(undefined4 *)(obj + 0xe54) = 0;
  *(undefined4 *)(obj + 0xe5c) = 0;
  return;
}
