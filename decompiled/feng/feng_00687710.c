/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_00687710 */
...
void __fastcall FUN_0055b5b0(undefined4 *);

void FUN_00687710(undefined4 *p)
{
  FUN_0055b5b0(p);
}
