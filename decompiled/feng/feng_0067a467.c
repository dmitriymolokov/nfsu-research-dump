/* spd-match: far pct=2.86 flags=/O1 method=pass_a_tc source=m375_sync_decomp:m375_c2064 */
#include "ghidra_compat.h"

#undef NAN
#define NAN(x) ((x)!=(x))

extern int DAT_006ebcec;
int unaff_EBP;
...

{
  ...
  *(ushort *)(unaff_EBP + -0xa0) =
  ...
  (**(code **)(param_2 + (char)((&DAT_006ebcec)[(byte)(cVar2 << 1 | cVar2 < '\0') & 0xf] |
                               (&DAT_006ebcec)[(byte)((bVar3 & 7) << 1 | (char)bVar3 < '\0')] << 2)
              + 0x10))();
  return;
}
