/* spd-match: far pct=9.78 flags=/O1 /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_004CD060 */
...
extern int DAT_00735e34;
extern int DAT_007469bc;
extern void LAB_004cd092(void);

uint __fastcall FUN_004cd060(int param_2, int param_3)

{
  ...
  piVar2 = &DAT_007469bc;
  do {
    if (0x7469bf < (int)piVar2) {
      if (!bVar1) goto LAB_004cd092;
      break;
    }
    if (*piVar2 == param_2) {
      bVar1 = true;
  ...
  if (param_3 == 5) {
    return (uint)((DAT_00735e34 & 4) != 0);
  }
  if (param_3 == 6) {
    return (uint)((DAT_00735e34 & 8) != 0);
  }
  piVar2 = (int *)(param_3 + -0xc);
  if (piVar2 == (int *)0x0) {
    return (uint)((DAT_00735e34 & 1) != 0);
  }
LAB_004cd092:
