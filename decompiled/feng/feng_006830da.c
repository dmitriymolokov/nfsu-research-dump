...
LONG lineInitialize(LPHLINEAPP lphLineApp,HINSTANCE hInstance,LINECALLBACK lpfnCallback,
...

{
  ...
  LVar1 = lineInitialize(lphLineApp,hInstance,lpfnCallback,lpszAppName,lpdwNumDevs);
  return LVar1;
}
