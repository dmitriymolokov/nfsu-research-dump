/* spd-match: far pct=70.59 flags=/O1 /c /nologo /TC method=m4_11_unaff source=m4_11/4.1.1/va_00671357 */
...
void __fastcall FUN_00671357(int esi)

{
  
  __unlock_file2(esi,*(void **)(DAT_00793350 + esi * 4));
  return;
}
