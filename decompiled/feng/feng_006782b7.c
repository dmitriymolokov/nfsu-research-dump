/* spd-match: close pct=87.50 flags=/O1 /c /nologo /TC method=m4_11_unaff source=m4_11/4.1.1/va_006782B7 */
...
void __fastcall FUN_006782b7(int handle)

{
  
  __unlock_fhandle(handle);
  return;
}
