/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_00685C90 */
...
void __fastcall FUN_004053c0(undefined4 *);

void FUN_00685c90(undefined4 *p)
{
  FUN_004053c0(p);
}
