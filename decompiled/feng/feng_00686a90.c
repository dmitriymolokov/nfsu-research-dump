/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1/va_00686A90 */
...
void __fastcall FUN_004688c0(undefined4 *);

void FUN_00686a90(undefined4 *p)
{
  ((void (__fastcall *)(undefined4 *))FUN_004688c0)(p);
}
