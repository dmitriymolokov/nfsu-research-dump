/* spd-match: far pct=11.11 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_004E23D0 */
...
extern void LAB_004e23ee(void);
extern void LAB_004e23f1(void);
extern void LAB_004e241e(void);
...
void __fastcall FUN_004e23d0(int val, int * obj)

{

  int *piVar1;

  for (piVar1 = (int *)obj[0x11]; piVar1 != obj + 0x11; piVar1 = (int *)*piVar1) {
    if (piVar1[2] == val) {
      piVar1 = (int *)obj[0x11];
      goto joined_r0x004e2411;
    }
  }
  piVar1 = (int *)obj[0x11];
LAB_004e23ee:
...
LAB_004e23f1:
  ...
  return;
joined_r0x004e2411:
  if (piVar1 == obj + 0x11) goto LAB_004e241e;
  if (piVar1[2] == val) goto LAB_004e23ee;
  piVar1 = (int *)*piVar1;
  goto joined_r0x004e2411;
LAB_004e241e:
  obj[0x10] = obj[0x11];
