/* spd-match: far pct=10.81 flags=/O1 method=thiscall_tp source=m375_sync_decomp:m375_inventory */
...
int __cdecl FUN_00414ac0(...);
int __cdecl FUN_00414af0(...);
int __cdecl FUN_004cfdb0(...);
int __cdecl FUN_004f8340(...);
int __cdecl FUN_00674898(...);
extern int DAT_00758951;

struct ThisCallBox {
  void FUN_004cfec0(int param_2);
};
void ThisCallBox::FUN_004cfec0(int param_2) {
  float fVar1;
  ...
  if ((param_2 != 0xc407210) && (param_2 != 0x406415e3)) {
    ...
    DAT_00758951 = FUN_00674898();
    FUN_004cfdb0();
    if (fVar1 != *(float *)(((int)this) + 0x88)) {
      if (param_2 == -0x6edfbf62) {
        FUN_004f8340(*(undefined4 *)(((int)this) + 0xc));
        return;
      }
      FUN_004f8340(*(undefined4 *)(((int)this) + 0xc));
    }
