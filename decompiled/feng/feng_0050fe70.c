/* spd-match: far pct=6.25 flags=/O1 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.5/va_0050FE70 */
/* M3.9.26.5: Ghidra EAX local → __fastcall typed arg (build strip; % may drop). */
#include "ghidra_compat.h"

int __cdecl FUN_004f8730();
int unaff_EDI;
void __fastcall FUN_0050fe70(int obj, int param_1, int param_2, undefined1 param_3, undefined4 param_4)
