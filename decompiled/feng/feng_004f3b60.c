/* spd-match: far pct=11.36 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_004F3B60 */
...
void __fastcall FUN_004f3b60(int obj, int esi_obj)

{
  ...
  *(int *)(obj + 0x18) = esi_obj;
  if ((((**(int **)(obj + 0x10) == 0x30203) &&
       (piVar1 = (int *)FUN_004f3c40(), *piVar1 == -0x1891baba)) && (piVar1[2] == 0x64486b50)) &&
     (0x1ffff < (uint)piVar1[4])) {
    FUN_004fd230();
  }
  uVar2 = FUN_004f37e0();
  *(undefined4 *)(obj + 0x14) = uVar2;
  *(undefined4 *)(obj + 0x24) = *(undefined4 *)(esi_obj + 0x1c);
  FUN_00575940("Activate %s\n",*(undefined4 *)(esi_obj + 0xc));
  return;
}
