/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_006866E0 */
...
void __fastcall FUN_0044a660(undefined4 *);

void FUN_006866e0(undefined4 *p)
{
  FUN_0044a660(p);
}
