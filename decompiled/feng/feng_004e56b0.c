/* spd-match: far pct=9.23 flags=/O1 /c /nologo /TC method=m4_12_multi_dual source=m4_12/4.1.2/va_004E56B0 */
...
void __fastcall FUN_004e56b0(int obj, int esi)

{
  int iVar1;

  if (((obj != 0) && (0x1e < esi)) && (esi < 0x23)) {
    iVar1 = 0x1f;
    do {
      if (((iVar1 != esi) && ((&DAT_00745b6c)[iVar1] != 0)) &&
         (*(int *)((&DAT_00745b6c)[iVar1] + 8) == *(int *)(obj + 8))) {
        FUN_005044b0(0,1);
      }
      iVar1 = iVar1 + 1;
    } while (iVar1 < 0x23);
