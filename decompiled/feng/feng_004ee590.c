/* spd-match: far pct=37.68 flags=/Og /c /nologo /TC method=m4_13_phantom_param source=m4_13/4.1.3/va_004EE590 */
...
void __fastcall FUN_004ee590(int obj, int param_2)
