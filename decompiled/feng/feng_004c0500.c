/* spd-match: far pct=16.96 flags=/O2 /c /nologo /TC method=m4_13_callee_stdcall source=m4_13/4.1.3/va_004C0500 */
...
/* M4.1.3: FUN_004f67f0 → __stdcall (callee_stdcall). */
...
int __stdcall FUN_004f67f0(int arg);
...
void __fastcall FUN_004c0500(int param_1)

{
  uint uVar1;
  int iVar2;
  
  FUN_004f68c0(0x20,"%s%1d",param_1 + 0x21d,*(undefined4 *)(param_1 + 0x1e4));
  FUN_004f67f0("Set Lap");
  if (DAT_007361b4 == 0) {
    iVar2 = -1;
  }
  else {
  ...
  if (*(int *)(DAT_007361f0 + 0x1c) == iVar2) {
    uVar1 = 0;
  }
  else {
    if (DAT_007361b8 == 0) {
      ...
      iVar2 = *(int *)(DAT_007361b8 + 8);
    }
    uVar1 = (uint)(*(int *)(DAT_007361f0 + 0x1c) == iVar2);
  }
  iVar2 = *(int *)(*(int *)((&DAT_007361b4)[uVar1] + 4) + 0x1c);
  if ((DAT_0073619c != (int *)0x0) && (*DAT_0073619c == 4)) {
    if (DAT_0073619c[0x14c] + -1 < *(int *)(param_1 + 0x1e8)) {
      *(int *)(param_1 + 0x1e8) = DAT_0073619c[0x14c] + -1;
    }
    iVar2 = (int)*(char *)(iVar2 + 9);
    if (*(int *)(param_1 + 0x1e8) < iVar2) {
      *(int *)(param_1 + 0x1e8) = iVar2;
    }
  }
  FUN_004f68c0(0x20,"OptionData_%1d",*(undefined4 *)(param_1 + 0x1e4));
  FUN_004f67f0(&DAT_006ca778,*(int *)(param_1 + 0x1e8) + 1);
  return;
}
