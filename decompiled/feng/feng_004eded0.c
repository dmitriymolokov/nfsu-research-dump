/* spd-match: far pct=16.35 flags=/O2 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.5/va_004EDED0 */
...
void __fastcall FUN_004eded0(int obj)

{
  ...
  if (*(int *)(obj + 0x20c) == 0) {
    ...
    if (iVar4 < *(int *)(obj + 0x4c)) {
      ...
      *(undefined1 *)(*(int *)(obj + 0x48) + *(int *)(obj + 0x1fc)) = 0x20;
