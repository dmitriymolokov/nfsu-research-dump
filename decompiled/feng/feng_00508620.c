/* spd-match: far pct=22.00 flags=/O1 /c /nologo /TC method=m4_12_unaff_2nd source=m4_12/4.1.2/va_00508620 */
...
extern int DAT_00745e40;
extern int DAT_0075f344;
undefined4 __fastcall FUN_00508620(int obj, int edi_obj)

{
  ...
  cVar1 = FUN_00507e10(edi_obj);
  if (((cVar1 == '\0') && (DAT_00745e40 == 1)) && (*(char *)(obj + 0x10) != '\x06')) {
    cVar1 = FUN_005a3570(&DAT_0075f344);
    if (cVar1 == '\0') {
      cVar1 = FUN_00508510(edi_obj);
      if (cVar1 != '\0') {
        return 1;
      }
      local_10 = 0x639;
      local_14 = 0x2c0344a3;
      local_c = 0;
      FUN_004dcbe0(&local_14,"GenericOKDialog.fng",*(undefined4 *)(edi_obj + 0xc));
    }
  }
  return 0;
}
