/* spd-match: far pct=10.42 flags=/O2 /c /nologo /TC method=m39 build_strip source=m39/3.9.26.5/va_0050AA90 */
...
uint __fastcall FUN_0050aa90(undefined4 val, uint param_1, undefined4 param_2)

{

  uint uVar1;
  
  uVar1 = CONCAT31((int3)((uint)val >> 8),DAT_00735ec1);
  if ((DAT_00735ec1 == '\0') && (uVar1 = param_1, *(int *)(param_1 + 0x90) == 0)) {
    uVar1 = FUN_00509d70(param_2);
    return uVar1;
  }
