/* Decompiled from Speed.exe @ 00517390 */
/* Module: FEng_FE */
/* Ghidra DecompileAll */


uint FUN_00517390(undefined4 *param_1,undefined4 *param_2,undefined4 *param_3,int param_4,
...

{
  ...
  bVar12 = param_8 <= *(float *)((int)local_d8 + 4 + param_4);
  if (bVar12) {
    ...
    do {
      if (*local_dc < param_8) {
        ...
        *pfVar17 = local_dc[-1];
        ...
        fVar4 = *(float *)((int)local_dc + iVar20);
        fVar5 = local_d8[-1];
        fVar15 = *local_d8;
        *local_bc = local_d8[-3];
        local_bc[1] = fVar4;
