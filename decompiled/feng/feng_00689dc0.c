/* spd-match: far pct=60.87 flags=/Ob2 /c /nologo /TC method=m39 source=m39/4.1.5/va_00689DC0 */
...
extern double _DAT_0077c780;

void FUN_00689dc0(void)
{
  _DAT_0077c780 = _DAT_006b7958 / _DAT_006cce38;
}
