/* spd-match: far pct=50.00 flags=/O1 /c /nologo /TC method=m39 source=m39/3.9.1_uplift/va_00684ED0 */
...
void __fastcall FUN_004fd150(undefined4 *);

void FUN_00684ed0(undefined4 *p)
{
  FUN_004fd150(p);
}
